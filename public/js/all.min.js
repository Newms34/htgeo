...
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e};!function(){n.$inject=["$timeout"];var u=io(),e=angular.module("htgeo-app",["ui.router","ngAnimate","ngSanitize","chart.js"]),t=angular.module("reset-app",[]),s="data:image/png;base64,";Array.prototype.findUser=function(e){for(var t=0;t<this.length;t++)if(this[t].user==e)return t;return-1};e.constant("IsDevelopment","localhost"===window.location.hostname).config(["$stateProvider","$urlRouterProvider","$locationProvider","$httpProvider","$compileProvider","$logProvider",function(e,t,n,a,o,r,i){n.html5Mode(!0),t.otherwise("/404"),o.debugInfoEnabled(i),r.debugEnabled(i),e.state("app",{abstract:!0,templateUrl:"layouts/full.html"}).state("app.blog",{url:"/blog",templateUrl:"components/blog.html"}).state("app.dash",{url:"/",templateUrl:"components/dash.html"}).state("app.chat",{url:"/chat",cache:!1,templateUrl:"components/chat.html"}).state("app.calendar",{url:"/calendar",templateUrl:"components/calendar.html"}).state("app.help",{url:"/help",templateUrl:"components/help/help.html"}).state("app.forum",{url:"/forum",templateUrl:"components/forums/forum.html"}).state("app.forumCat",{url:"/forumCat?c",templateUrl:"components/forums/forumCat.html"}).state("app.forumThr",{url:"/forumThr?c&t",templateUrl:"components/forums/forumThr.html"}).state("app.tools",{url:"/tools",templateUrl:"components/tools.html"}).state("appSimp",{abstract:!0,templateUrl:"components/layout/simp.html"}).state("appSimp.login",{url:"/login",templateUrl:"components/login.html"}).state("appSimp.register",{url:"/register",templateUrl:"components/register.html"}).state("appSimp.unconfirmed",{url:"/unconf",templateUrl:"components/alt/unconfirmed.html"}).state("appSimp.notfound",{url:"/404",templateUrl:"components/alt/404.html"}).state("appSimp.err",{url:"/500",templateUrl:"components/alt/500.html"})}]).directive("fileread",[function(){return{scope:{fileread:"="},link:function(o,e,t){e.bind("change",function(e){var t=new FileReader,n=e.target.files[0],a=n.name;return $log.debug("UPLOADING FILE",n),t.onload=function(e){var t=e.target.result;$log.debug("URI before optional resize",t,t.length),o.$parent.needsResize?r(o,t,o.$parent.needsResize,o.$parent.needsResize,a):($log.debug("APPLYING file to $parent"),o.$apply(function(){o.$parent&&o.$parent.$parent&&o.$parent.$parent.avas?(o.$parent.$parent.loadingFile=!1,o.$parent.$parent.fileName="Loaded:"+a,o.$parent.$parent.fileread=t):(o.$parent.loadingFile=!1,o.$parent.fileName="Loaded:"+a,o.$parent.fileread=t),o.$parent.saveDataURI&&"function"==typeof o.$parent.saveDataURI&&o.$parent.saveDataURI(dataURI)}))},n?25e5<n.size?(bulmabox.alert("File too Large","Your file "+n.name+" is larger than 2.5MB. Please upload a smaller file!"),!1):void t.readAsDataURL(n):(o.$apply(function(){o.fileread="",o.$parent.fileName=!1,o.$parent.loadingFile=!1}),!1)})}}}]).filter("markdown",["$sce",function(n){return function(e){var t=new showdown.Converter;return n.trustAsHtml(t.makeHtml(e))}}]),Array.prototype.rotate=function(e){for(var t=angular.copy(this),n=0;n<e;n++)t.push(t.shift());return t},Date.prototype.dyMo=function(){return this.getMonth()+1+"/"+this.getDate()},String.prototype.titleCase=function(){return this.split(/\s/).map(function(e){return e.slice(0,1).toUpperCase()+e.slice(1).toLowerCase()}).join(" ")};var r=function(a,e,o,r,i){var t=document.createElement("img");t.onload=function(){var e=document.createElement("canvas"),t=e.getContext("2d");e.width=o,e.height=r,t.drawImage(this,0,0,o,r);var n=e.toDataURL();a.$apply(function(){a.$parent.loadingFile=!1,a.$parent.fileName="Loaded:"+i,a.fileread=n,a.$parent.saveDataURI&&"function"==typeof a.$parent.saveDataURI&&a.$parent.saveDataURI(n)})},t.src=e};function n(a){return{restrict:"A",priority:101,link:function(e,t,n){a(function(){e.$evalAsync(n.postrenderAction)},0)}}}e.directive("postrenderAction",n),e.controller("blog-cont",["$scope","$http","$state","$filter","$sce","$log",function(o,n,e,t,a,r){n.get("/user/getUsr").then(function(e){o.doUser(e.data),r.debug("user",o.user)}),o.msgs=[],o.doUser=function(e){if(!e)return!1;o.user=e,o.msgs.push({time:Date.now(),user:"System",msg:"Welcome to Hidden Tyria Geographic Society [GEO] Chat! You're logged in as "+e.user+". Try /wiki or /google to search for stuff!",isSys:!0})},o.newBlog={title:null,contents:null,youtube:null,pic:null,youtubeCand:null},o.blogEntries=[{author:"Healy",pic:"https://static.wixstatic.com/media/4c8c05_d15c19168bda4a3c9a3bef232a00310f~mv2.jpg/v1/fit/w_1175,h_661,al_c,q_80/file.png",height:400,title:"A Test Post",contents:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc et mi ut mauris rutrum malesuada. Ut tincidunt in ex ac ultrices. Integer nec aliquam massa. Fusce aliquam fermentum augue. Suspendisse sollicitudin lectus libero. Praesent varius nisl eu neque cursus lobortis. Nullam convallis turpis sit amet tortor cursus fermentum. In facilisis pharetra urna, sed feugiat est lobortis a. Vestibulum vehicula malesuada purus, id convallis massa suscipit nec. Nunc a ante nunc. Nullam faucibus porttitor erat, vitae convallis augue tincidunt a.\n\n        Nunc egestas hendrerit orci, ut rutrum ex porta ac. Pellentesque porttitor erat neque, eu pulvinar ex sodales quis. Morbi gravida suscipit nulla nec laoreet. Vivamus eleifend magna leo. Morbi tincidunt iaculis euismod. Aliquam malesuada nunc lacinia, convallis augue quis, consectetur elit. Maecenas mattis purus sollicitudin semper feugiat. Ut at gravida augue, sit amet venenatis arcu. Maecenas et justo ut elit ultrices maximus et ac enim. Sed nec rutrum nibh. Etiam malesuada lacus nisl, eget pretium odio consectetur ut.",youtube:"https://www.youtube.com/watch?v=cGZ4X7cER8k",likeNum:0,usrLiked:!1,when:"A long time ago",id:null}],o.refBlogs=function(){n.get("/blog/allEntries").then(function(e){if(!e.data)throw new Error("no blogs");o.blogEntries=o.parseBlogs(e.data)}).catch(function(e){o.blogEntries=[{author:"System",pic:"https://static.wixstatic.com/media/4c8c05_d15c19168bda4a3c9a3bef232a00310f~mv2.jpg/v1/fit/w_1175,h_661,al_c,q_80/file.png",height:400,title:"Couldn't Load Blog",contents:"Your site is probably broken, or your internet connection sucks. We couldn't load any blog info!",youtube:null,likeNum:0,usrLiked:!1,when:"A long time ago",_id:null}]})},o.refBlogs(),o.parseBlogs=function(e){return e.map(function(e){return e.height=e.height||400,e.likeNum=e.likes.length,e.usrLiked=!!e.likes.includes(o.user._id),e.when=new Date(e.date).toLocaleString(),e.editContents=e.contents,e})},o.toggleLike=function(e){n.get("/blog/toggleLike?v="+e).then(function(t){var e=o.blogEntries.find(function(e){return e._id==t.data._id});e.likes=t.data.likes,e.usrLiked=t.data.likes.includes(o.user._id),e.likeNum=t.data.likes.length})},o.timers={pic:null,vid:null},o.doPic=function(e){r.debug("EVENT INTO CHANGE",e);var t=new FileReader,n=document.querySelector("#upl-canv"),a=n.getContext("2d");t.onload=function(e){var t=new Image;t.onload=function(){r.debug(t,t.width),n.width=t.width,n.height=t.height,a.drawImage(t,0,0),o.pic=n.toDataURL()},t.src=e.target.result},t.readAsDataURL(e.target.files[0])},o.vidTimer=function(){o.timers.vid&&clearTimeout(o.timers.vid),o.timers.vid=setTimeout(function(){o.newBlog.youtubeCand&&o.newBlog.youtubeCand.length?o.newBlog.youtubeCand.includes("youtu.be")?o.newBlog.youtube=o.newBlog.youtubeCand.replace("https://youtu.be/","https://www.youtube.com/watch?v=").replace("youtu.be/","https://www.youtube.com/watch?v="):o.newBlog.youtube=o.newBlog.youtubeCand:o.newBlog.youtube=null},500)},o.newPost=function(e){if(!o.newBlog.title||!o.newBlog.contents)return bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Missing Information',"Your blog post needs a title and at least some text content!");var t=angular.copy(o.newBlog);delete t.picCand,delete t.youtubeCand,n.post("/blog/post",t).then(function(e){o.newBlog={title:null,contents:null,youtube:null,pic:null,picCand:null,youtubeCand:null},o.refBlogs()})},o.editBlog=function(t){bulmabox.confirm("Update Blog Text","Are you sure you wanna update your blog post?",function(e){e&&n.put("/blog/post",t).then(function(e){o.refBlogs()})})},o.deleteBlog=function(t){r.debug("Attempting to delete blog",t),bulmabox.confirm("Delete Blog Post","Are you sure you wanna delete this blog entry?",function(e){e&&(Object.keys(t)||r.debug("somehow b got emptied!",t),n.delete("/blog/post?id="+t._id).then(function(e){o.refBlogs()}))})}}]).directive("customOnChange",function(){return{restrict:"A",link:function(e,t,n){var a=e.$eval(n.customOnChange);t.on("change",a),t.on("$destroy",function(){t.off()})}}}).filter("trusted",["$sce",function(n){return function(e){var t=e.split("v=")[1].split("&")[0];return n.trustAsResourceUrl("https://www.youtube.com/embed/"+t)}}]),Date.prototype.stdTimezoneOffset=function(){var e=new Date(this.getFullYear(),0,1),t=new Date(this.getFullYear(),6,1);return Math.max(e.getTimezoneOffset(),t.getTimezoneOffset())},Date.prototype.isDstObserved=function(){return this.getTimezoneOffset()<this.stdTimezoneOffset()},e.controller("cal-cont",["$scope","$http","$state","$log",function(i,r,e,s){i.cal=[],i.days=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],i.calLoaded=!1,i.wkOpts=[{lbl:"Every week",n:1},{lbl:"Every two weeks",n:2},{lbl:"Every three weeks",n:3},{lbl:"Every four weeks",n:4},{lbl:"Every five weeks",n:5}],r.get("/user/usrData").then(function(e){i.user=e.data}),i.refCal=function(){r.get("/cal/all").then(function(e){s.debug("calendar events response:",e),i.makeCalendar(e.data)})},u.on("refCal",function(e){i.refCal()}),i.refCal(),i.makeCalendar=function(e){i.offsetDays=i.days.rotate((new Date).getDay());var t=0,a=0,o=new Date;for(o.setHours(0,0,0,0),o=o.getTime(),i.cal=[];t<6;t++){var r={wk:t,wkSt:new Date(o+7*t*1e3*3600*24),wkEn:new Date(o+1e3*(7*(t+1)-1)*3600*24),days:[]},n=function(){var n=new Date(o+1e3*(7*t+a)*3600*24);r.days.push({d:a,evts:e.filter(function(e){var t=new Date(e.eventDate).getTime();return s.debug("THIS DATE DTNUM",t,n.getTime()),t>n.getTime()&&t<n.getTime()+864e5}),date:n})};for(a=0;a<7;a++)n();i.cal.push(r)}s.debug("CAL STUFF",i.cal,i.offsetDays)},i.viewEvent=function(t){s.debug("View event",t);var e=null;t.paid&&t.paid.length&&(e="<ul class='ul'>\n                "+t.paid.map(function(e){return"<li> - "+e+"</li>"}).join("")+"\n            </ul>"),bulmabox.alert("Event: "+t.title,"Time:"+new Date(t.eventDate).toLocaleString()+"<br>Type:"+i.kindOpts.find(function(e){return e.kind==t.kind}).kindLong+"<br>"+(e?"Paid Users<br>"+e:"")+"<hr> Description: "+t.text)},i.editEventObj={title:"",desc:"",day:0,time:2*((new Date).getHours()+((new Date).getMinutes()<30?.5:0)),kind:"lotto",id:null},i.clearEdit=function(){i.editEventAct=!1},i.editEventAct=!1,i.editEvent=function(t){i.editEventAct=!0,s.debug("Edit event",t,"hour options",i.hourOpts);var e=new Date(t.eventDate).setHours(0,0,0,0),n=Date.now();i.editEventObj={title:t.title,desc:t.text,kind:i.kindOpts.find(function(e){return e.kind==t.kind}),time:Math.floor((t.eventDate-e)/18e5),day:Math.round((t.eventDate-n)/864e5),id:t._id,user:t.user}},i.doEdit=function(){s.debug("Input edit event",i.editEventObj);var e=new Date,t=i.editEventObj.day,n=i.editEventObj.time;(new Date).isDstObserved()||47<(n+=2)&&(n%=47,t++),e.setHours(0,0,0,0);var a=e.getTime()+1800*n*1e3+3600*t*1e3*24;if(s.debug("Sending event",i.editEventObj,a),a<Date.now()+3e5)return bulmabox.alert("Time Expiring","Your selected time, "+new Date(a).toLocaleString()+", occurs too soon! Please select a later time."),!1;r.post("/cal/edit",{title:i.editEventObj.title,text:i.editEventObj.desc,eventDate:a,kind:i.editEventObj.kind.kind,id:i.editEventObj.id,user:i.editEventObj.user}).then(function(e){s.debug("edit event response",e),"wrongUser"==e.data&&bulmabox.alert('<i class="fa fa-exclamation-triangle"></i> Wrong User',"You cannot edit this event, as you are not its creator and are not a moderator."),i.refCal(),i.clearEdit()})},i.delEvent=function(t){s.debug("Delete event",t),bulmabox.confirm("Delete Event","Are you sure you wish to delete the following event?<br> Title: "+t.title+"<br>Description: "+t.text,function(e){if(!e||null==e)return!1;r.get("/cal/del?id="+t._id).then(function(e){s.debug("delete response",e),i.refCal()})})},i.addEvent=!1,i.newEventObj={title:"",desc:"",day:0,time:2*((new Date).getHours()+((new Date).getMinutes()<30?.5:0)),kind:"lotto",repeatNum:1,repeatOn:!1,repeatFreq:1},r.get("/user/allUsrs").then(function(e){i.allUsrs=e.data.map(function(e){return e.user})}),i.addPaid=function(t){var e=i.allUsrs.filter(function(e){return!t.paid||!t.paid.length||t.paid.indexOf(e)<0}).map(function(e){return"<option value='"+e+"'>"+e+"</option>"}).join("");bulmabox.custom("Add Paid User","Select a user from the list below to add them to this lotto's candidates:<br><p class='select'><select id='payusr'>"+e+"</select></p>",function(){var e=document.querySelector("#payusr").value;s.debug("User wishes to add",e),r.post("/cal/lottoPay",{lottoId:t._id,pusr:e})})},i.hourOpts=new Array(48).fill(100).map(function(e,t){var n=t<24?"AM":"PM",a=Math.floor(t/2)<13?Math.floor(t/2):Math.floor(t/2)-12;return a<1&&(a=12),{num:t,hr:a+(t%2?":30":":00")+n}}),i.dayOpts=new Array(42).fill(100).map(function(e,t){var n=new Date(Date.now()+3600*t*1e3*24);return{num:t,day:n.getMonth()+1+"/"+n.getDate()}}),i.kindOpts=[{kind:"lotto",desc:"An item or items will be given away by a [GEO] member to one lucky guild member!",kindLong:"Lottery/Giveaway"},{kind:"payLotto",desc:"Try your luck! One lucky winner will win the pool of donations!",kindLong:"Paid Lottery/Giveaway"},{kind:"announce",desc:"Someone needs to make an important announcement!",kindLong:"Announcement"},{kind:"contest",desc:"Some sort of contest! See who's the best!",kindLong:"Contest"},{kind:"other",desc:"Any other event type",kindLong:"Other"}],i.doAdd=function(){var e=new Date,t=i.newEventObj.time,n=i.newEventObj.day;e.setHours(0,0,0,0),(new Date).isDstObserved()||47<(t+=2)&&(t%=47,n++);var a=e.getTime()+1800*t*1e3+3600*n*1e3*24,o=i.newEventObj.repeatOn?"/cal/newRep":"/cal/new";if(a<Date.now()+3e5)return bulmabox.alert("Time Expiring","Your selected time, "+new Date(a).toLocaleString()+", occurs too soon! Please select a later time."),!1;s.debug("Sending event",i.newEventObj,a),r.post(o,{title:i.newEventObj.title,text:i.newEventObj.desc,eventDate:a,kind:i.newEventObj.kind.kind,repeatNum:i.newEventObj.repeatNum,repeatFreq:i.newEventObj.repeatFreq,repeatOn:i.newEventObj.repeatOn}).then(function(e){s.debug("new event response",e),i.refCal(),i.clearAdd()})},i.clearAdd=function(){i.addEvent=!1,i.newEventObj={title:"",desc:"",day:0,time:2*((new Date).getHours()+((new Date).getMinutes()<30?.5:0)),kind:"lotto",repeatNum:1,repeatFreq:1,repeatOn:!1}}}]),e.controller("chat-cont",["$scope","$http","$state","$filter","$sce","$log",function(t,e,n,a,o,r){e.get("/user/getUsr").then(function(e){t.doUser(e.data),r.debug("user",t.user)}),t.msgs=[],t.doUser=function(e){if(!e)return!1;t.user=e,t.msgs.push({time:Date.now(),user:"System",msg:"Welcome to Hidden Tyria Geographic Society [GEO] Chat! You're logged in as "+e.user+". Try /wiki or /google to search for stuff!<br>You can also poke anyone online by doing @<user>, where <user> is their username.<br>Finally, type /list to see a list of who's currently online.",isSys:!0})},t.parseMsg=function(e){return r.debug("in parseMsg",e),0===e.indexOf("/wiki ")?'Wiki: <a href="https://wiki.guildwars2.com/wiki/'+e.slice(6)+'" target="_blank">'+e.slice(6)+"</a>":0===e.indexOf("/google ")?'Google: <a href="https://www.google.com/search?q='+e.slice(8)+'" target="_blank">'+e.slice(8)+"</a>":e},e.get("/user/allUsrs").then(function(e){r.debug("all users is",e),t.allUsers=e.data}),u.on("chatMsgOut",function(e){if(r.debug("before dealing with commands, full message object is",e),"string"!=typeof e.msg)return!1;e.msg=o.trustAsHtml(t.parseMsg(e.msg)),t.msgs.push(e),100<t.msgs.length&&t.msgs.shift(),t.$apply(),document.querySelector("#chat-container").scrollTop=document.querySelector("#chat-container").scrollHeight}),u.on("disconnect",function(){t.msgs.push({time:Date.now(),user:"System",msg:"Warning: The connection to the server was lost. Until you refresh, chat's probably gonna be pretty quiet!",isSys:!0}),100<t.msgs.length&&t.msgs.shift(),t.$apply(),document.querySelector("#chat-container").scrollTop=document.querySelector("#chat-container").scrollHeight}),t.sendChat=function(){if(!t.newMsg)return!1;if("/list"!=t.newMsg.toLowerCase())return"/coloron"==t.newMsg.toLowerCase()?(r.debug("toggling disco mode!",t.$parent),u.emit("discoMode",{on:!0}),t.newMsg="",!1):"/coloroff"==t.newMsg.toLowerCase()?(r.debug("toggling disco mode!",t.$parent),u.emit("discoMode",{on:!1}),t.newMsg="",!1):(r.debug("Sending chat message",{user:t.user.user,msg:t.newMsg}),u.emit("chatMsg",{user:t.user.user,msg:t.newMsg}),void(t.newMsg=""));var e={time:Date.now(),user:"System",msg:"No other users currently online!",isSys:!0};return t.$parent.alsoOnline&&t.$parent.alsoOnline.length&&(e.msg="Users currently online:<ul>"+t.$parent.alsoOnline.map(function(e){return"<li> - "+e+"</li>"})+"</ul>"),t.msgs.push(e),100<t.msgs.length&&t.msgs.shift(),t.newMsg="",!1},r.debug("CHAT SCOPE",t)}]),e.controller("dash-cont",["$scope","$http","$state","$filter","$log",function(o,r,e,t,i){o.showDups=localStorage.brethDups,r.get("/user/usrData").then(function(e){o.doUser(e.data),i.debug("user",o.user)}),r.get("/cal/latestFive").then(function(e){o.latestEvents=e.data}),o.doUser=function(n){if(!n)return!1;o.user=n,i.debug(n),o.possibleInterests.forEach(function(e,t){n.ints&&n.ints[t]&&1==n.ints[t]&&(e.active=!0)}),o.numUnreadMsgs=n.msgs.filter(function(e){return!e.read}).length},u.on("sentMsg",function(e){i.debug("SOCKET USER",e,"this user",o.user),e.user!=o.user.user&&e.from!=o.user.user||(i.debug("re-getting user"),r.get("/user/usrData").then(function(e){o.doUser(e.data)}))}),o.tabs=[{name:"Profile/Characters",icon:"user"},{name:"Members",icon:"users"},{name:"Mail",icon:"envelope"},{name:"Upcoming Events",icon:"calendar"}],o.defaultPic=s,o.loadingFile=!1,o.fileName=null,o.needsResize=65,o.loadFile=function(){o.loadingFile=!0;new FileReader},o.saveDataURI=function(e){r.post("/user/changeAva",{img:e}).then(function(e){o.doUser(e.data)})},o.possibleInterests=[{name:"General PvE",warn:!1,active:!1,icon:"pve.png"},{name:"sPvP",warn:!1,active:!1,icon:"pvp.png"},{name:"WvW",warn:!1,active:!1,icon:"wvw.png"},{name:"Fractals",warn:!1,active:!1,icon:"fracs.png"},{name:"Raids",warn:!0,active:!1,icon:"raids.png"},{name:"Role-Playing",warn:!0,active:!1,icon:"rp.png"}],o.tzs=angular.copy(a),o.changeInterest=function(e,t){i.debug(e),e.warn&&e.active&&bulmabox.alert("Game Mode Warning","Hey! Just so you know, [GEO] generally doesn't do "+e.name+".<br>However, that doesn't mean we don't have people that might be interested!"),r.get("/user/changeInterest?int="+t+"&act="+e.active).then(function(e){o.doUser(e.data)})},o.changeTz=function(){r.get("/user/changeTz?tz="+o.user.tz).then(function(e){o.doUser(e.data)})},o.otherInfTimer=null,o.setOtherInfTimer=function(){o.otherInfTimer&&clearTimeout(o.otherInfTimer),o.otherInfTimer=setTimeout(function(){r.post("/user/changeOther",{other:o.user.otherInfo}).then(function(e){o.doUser(e.data)})},500)},o.memNameSort=!1,o.charSearch="",o.pickedInts=[!1,!1,!1,!1,!1,!1],o.intSearchToggle=!1,o.charSearchToggle=!1,o.memFilter=function(n){var e=!!n.chars.filter(function(e){return-1<e.name.toLowerCase().indexOf(o.charSearch.toLowerCase())}).length;if(o.charSearch&&!e)return!1;if(o.pickedInts.filter(function(e){return!!e}).length){var a=!0;return o.pickedInts.forEach(function(e,t){e&&!n.ints[t]&&(a=!1)}),a}return!0},o.getAll=function(){console.log("getting all yuzrs"),r.get("/user/allUsrs").then(function(e){i.debug("all users is",e),o.allUsers=e.data,setTimeout(function(){u.emit("getOnline",{})},100)})},u.on("allNames",function(t){t=t.map(function(e){return e.name}),o.allUsers&&o.allUsers.forEach(function(e){e.online=-1<t.indexOf(e.user)||e.user==o.user.user}),o.$digest()}),o.showTab=function(e){o.currTab=e},o.currTab="Profile/Characters",o.makeMod=function(t){i.debug("wanna mod",t),bulmabox.confirm("Assign Moderator Rights","Warning: This will give user "+t.user+" full moderator rights, and prevents them from being banned. This process is <i>not</i> reversable!",function(e){if(!e||null==e)return!1;r.get("/user/makeMod?user="+t.user).then(function(e){o.allUsers=e.data})})},o.toggleBan=function(e){r.get("/user/toggleBan?user="+e.user).then(function(e){o.allUsers=e.data})},o.confirmUsr=function(t){bulmabox.confirm("Confirm User","Are you sure you wish to confirm user "+t.user+"?",function(e){e&&null!=e&&r.get("/user/confirm?u="+t.user).then(function(e){o.allUsers=e.data})})},o.races=["Asura","Charr","Human","Norn","Sylvari"],o.profs=["Guardian","Warrior","Revenant","Thief","Ranger","Engineer","Elementalist","Mesmer","Necromancer"],o.crafts=["Armorsmith","Chef","Artificer","Huntsman","Jeweler","Leatherworker","Tailor","Weaponsmith","Scribe","None"],o.addEditCharModal={active:!1,name:null,race:"Asura",prof:"Guardian",craftOne:{cName:"None",isMax:!1},craftTwo:{cName:"None",isMax:!1},lvl:80,other:null,isEdit:!1},o.clearAddEditChar=function(){o.addEditCharModal={active:!1,name:null,race:"Asura",prof:"Guardian",craftOne:{cName:"None",isMax:!1},craftTwo:{cName:"None",isMax:!1},lvl:80,other:null,isEdit:!1}},o.addChar=function(){return!(o.addEditCharModal.active=!0)},o.autoChars=function(){bulmabox.prompt("Auto-Fill Characters from API","Auto-filling characters from the Guild Wars 2 Official API will replace any existing characters you've entered with API-found characters. <br><br> - You'll need an API key to do this (click <a href='https://account.arena.net/' target='_blank'>here</a> if you dont have one). <br><br>Are you sure you wish to do this?",function(e){e&&null!=e&&r.get("/user/charsFromAPI?api="+e).then(function(e){i.debug("Auto-char response is",e),e&&e.data&&"err"!=e.data?o.doUser(e.data):bulmabox.alert("Error Auto-Filling","There was an error auto-filling your characters.<br>While it <i>may</i> be Dave's fault, you may also wanna check that your API key is valid. You can also always just manually add your characters!")})})},o.delChr=function(t){i.debug("user wishes to remove character",t),bulmabox.confirm("Remove Character","Are you sure you wish to remove the character "+t.name+"?",function(e){e&&null!=e&&r.get("/user/remChar?id="+t._id).then(function(e){o.doUser(e.data)}).catch(function(e){bulmabox.alert("Error","There was a problem removing this character!")})})},o.addOrEditChar=function(){if(i.debug("Sending char",o.addEditCharModal),!o.addEditCharModal.name)return bulmabox.alert("No Character Name","You need to tell us what your character's name is!");o.addEditCharModal.isEdit?r.post("/user/editChar",o.addEditCharModal).then(function(e){o.clearAddEditChar(),o.$digest(),o.doUser(e.data)}):r.post("/user/addChar",o.addEditCharModal).then(function(e){o.clearAddEditChar(),o.doUser(e.data)})},o.editChar=function(e){return!(o.addEditCharModal={active:!0,name:e.name,race:e.race,prof:e.prof,craftOne:{cName:e.crafts[0]?e.crafts[0].cName:"None",isMax:!!e.crafts[0]&&e.crafts[0].isMax},craftTwo:{cName:e.crafts[1]?e.crafts[1].cName:"None",isMax:!!e.crafts[1]&&e.crafts[1].isMax},lvl:e.lvl,other:e.other,isEdit:!0})},o.mail=function(n,a){var e=a?"<div class='notification'>"+a+"</div>":"";bulmabox.custom("Send Message",'<div class="field">\n                '+e+"\n    <label class='label'>\n        Message\n    </label>\n    <p class=\"control\">\n        <textarea class='textarea' id='newMsg' placeholder='What do you wanna say?'></textarea>\n    </p>\n</div>",function(e){var t=document.querySelector("#newMsg").value;if(!t)return bulmabox.alert("Huh?","Sorry, but we don't support uncomfortable silences currently."),!1;a&&(t="<div class='notification'>"+a+"</div><br>"+t),i.debug("old",a,"new",t),r.post("/user/sendMsg",{msg:t,to:n._id}).then(function(e){})},"<button class='button is-info' onclick='bulmabox.runCb(bulmabox.params.cb)'>Send</button><button class='button is-danger' onclick='bulmabox.kill(\"bulmabox-diag\")'>Cancel</button>")},o.msgView={active:!1,msg:null,mine:!1},o.clearMsg=function(){o.msgView={active:!1,msg:null,mine:!1}},o.viewMsg=function(e){i.debug("msg object",e);(new showdown.Converter).makeHtml(e.msg);if(o.msgView.active=!0,o.msgView.mine=!0,(o.msgView.msg=e).to)return!1;r.get("/user/setOneRead?id="+e._id).then(function(e){o.doUser(e.data)})},u.on("reqHeartBeat",function(e){o.alsoOnline=e.filter(function(e){return!o.user||!o.user.user||o.user.user!=e.name}).map(function(e){return e.name}),o.allUsers&&o.allUsers.forEach(function(e){e.online=o.alsoOnline.includes(e.user)})}),o.delMsg=function(t,n){"object"!=(void 0===t?"undefined":_typeof(t))&&(t={_id:t}),bulmabox.confirm("Delete Message","Are you sure you wish to delete this message?",function(e){i.debug("resp",e),e&&null!=e&&r.get("/user/delMsg?id="+t._id).then(function(e){o.doUser(e.data),n&&o.clearMsg()})})},o.delMyMsg=function(t,n){"object"!=(void 0===t?"undefined":_typeof(t))&&(t={_id:t}),bulmabox.confirm("Delete Message","Are you sure you wish to delete this message?",function(e){i.debug("resp",e),e&&null!=e&&r.get("/user/delMyMsg?id="+t._id).then(function(e){o.doUser(e.data),n&&o.clearMsg()})})},o.replyMsg=function(t){i.debug("User wants to reply to message",t);var e=(new showdown.Converter).makeHtml(t.msg),n=o.allUsers.find(function(e){return e.user==t.from});o.mail(n,e),o.clearMsg()},o.repMsg=function(t,n){"object"!=(void 0===t?"undefined":_typeof(t))&&(t={_id:t}),i.debug("user wishes to report msg",t),bulmabox.confirm("Report Message","Reporting a message sends a notification to the moderators, including the details of the message.<br>It will then be up to the moderators to determine if you're being uncool to each other.<br>Are you sure you wish to report this message?",function(e){r.post("/user/repMsg",t).then(function(e){"dupRep"==e.data&&bootbox.alert("Already Reported","You've already reported this message. Please wait while the moderator team reviews your report."),n&&o.clearMsg()})})},o.newPwd={pwd:null,pwdDup:null,old:null,changin:!1},o.clearPwd=function(){o.newPwd={pwd:null,pwdDup:null,old:null,changin:!1}},o.editPwd=function(){o.newPwd.pwd&&o.newPwd.pwdDup&&o.newPwd.pwd==o.newPwd.pwdDup?r.post("/user/editPwd",o.newPwd).then(function(e){e.data&&"err"!=e.data?(o.clearPwd(),bulmbox.alert("Password Changed!","Your password was successfully changed!"),o.doUser(e.data)):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Error Changing Password',"There was a problem changing your password. Your old one probably still works, but if you're still having an issue, contact a moderator!")}):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Password Mismatch',"Your passwords don't match, or are missing!")},o.viewEvent=function(e){bulmabox.alert("Event: "+e.title,"Date:"+t("numToDate")(e.eventDate)+"<br>Description:"+e.text)},o.emailTimer=function(){o.updEmail&&clearTimeout(o.updEmail),o.updEmail=setTimeout(function(){i.debug(o.user.email),r.get("/user/setEmail?email="+o.user.email).then(function(e){i.debug(e),e.data&&"err"!=e.data&&o.doUser(e.data)})},500)}}]).filter("numToDate",function(){return function(e){if(isNaN(e))return"Invalid date!";var t=new Date(e);return t.toLocaleDateString()+" "+t.getHours()%12+":"+(t.getMinutes().toString().length<2?"0"+t.getMinutes():t.getMinutes())+" "+(t.getHours()<13?"AM":"PM")}}),e.controller("forum-cat-cont",["$scope","$http","$state","$location","$log",function(n,a,o,e,r){localStorage.geoUsr||o.go("app.login"),a.get("/user/getUsr").then(function(e){n.user=e.data,r.debug("user",n.user)}),n.newThr={},n.fileName=null,n.currCat=e.search().c,n.refCat=function(){a.get("/forum/byCat?grp="+n.currCat).then(function(e){r.debug("thrds in this cat",e),n.threads=e.data.sort(function(e,t){return e.stickied===t.stickied?e.lastUpd-t.lastUpd:e.stickied?-1:1}).map(function(e){return e.time=new Date(e.lastUpd),e})})},n.refCat(),n.newThrDial=function(){n.makingThread=!0},n.clearThread=function(){n.newThr={},n.makingThread=!1,n.loadingFile=!1},n.loadFile=function(){n.loadingFile=!0;new FileReader},n.deleteThread=function(e,t){e.stopPropagation(),e.preventDefault(),bulmabox.confirm("Delete Thread","Are you absolutely sure you wish to delete the thread '"+t.title+"'? <br>Please note that this process is <em>not</em> reversable!",function(e){if(!e||null==e)return!1;r.debug("Deleting thread",t),a.delete("/forum/deleteThread?id="+t._id).then(function(e){o.go(o.current,{},{reload:!0})})})},n.makeThread=function(){n.newThr.md=n.newThr.txt,n.newThr.text=(new showdown.Converter).makeHtml(n.newThr.txt),n.newThr.grp=n.currCat,a.post("/forum/newThread",n.newThr).then(function(e){r.debug("new thred response",e),o.go(o.current,{},{reload:!0})})},n.toggleSticky=function(e,t){e.stopPropagation(),e.preventDefault(),a.get("/forum/toggleSticky?id="+t).then(function(e){r.debug("response from thread sticky toggle is",e),n.refCat()})},n.toggleLock=function(e,t){e.stopPropagation(),e.preventDefault(),a.get("/forum/toggleLock?id="+t).then(function(e){r.debug("response from thread lock toggle is",e),n.refCat()})}}]),e.controller("forum-cont",["$scope","$http","$state","$sce","$log",function(n,e,t,a,o){n.currMsg=0,n.forObj={},localStorage.geoUsr||t.go("app.login"),e.get("/forum/cats").then(function(t){var e=Object.keys(t.data);o.debug("CATS",t),n.forObj=e.map(function(e){return{name:e,count:t.data[e].n,time:0<t.data[e].t?new Date(t.data[e].t):null}})}),n.searchin=!1,n.search="",n.searchTimer=null,n.doSearch=function(){n.searchTimer&&clearTimeout(n.searchTimer),n.searchTimer=setTimeout(function(){n.search&&n.search.length&&e.post("/forum/searchThr",{term:n.search}).then(function(e){o.debug("search response",e),n.searchResults=e.data})},500)},n.goCat=function(e){t.go("app.forumCat",{c:e})}}]),e.controller("forum-thr-cont",["$scope","$http","$state","$location","$sce","$log",function(a,n,e,t,o,r){a.currMsg=0,a.defaultPic=s,a.forObj={},a.fileName=null,localStorage.geoUsr||e.go("app.login"),a.loadingFile=!1,a.loadFile=function(){a.loadingFile=!0;new FileReader},a.currCat=t.search().c,a.id=t.search().t,a.refThred=function(){r.debug("info to back:",a.id),n.get("/forum/thread?id="+a.id).then(function(n){r.debug("response",n),a.thr=n.data.thrd,n.data.psts.map(function(e){return e.rawText=e.text,e.text=o.trustAsHtml(e.text),e.date=new Date(e.lastUpd).toLocaleString(),e.wasEdited=e.lastUpd!=e.createDate,e}),a.avas=n.data.ava,a.thr.posts=a.thr.posts.map(function(t){r.debug("PSTH",t,n.data.psts.filter(function(e){return e._id==t.id})[0]);var e=n.data.psts.filter(function(e){return e._id==t.id})[0];return e.votesUp=t.votesUp,e.votesDown=t.votesDown,e.byMod=-1<n.data.mods.indexOf(e.user),e.order=t.order,n.data.psts.filter(function(e){return e._id==t.id})[0]}).sort(function(e,t){return e.order-t.order}),r.debug("thred response",a.thr,n)})},a.refThred(),n.get("/user/getUsr").then(function(e){a.user=e.data,r.debug("user",a.user)}),a.newPost=function(){if(!a.newPostTxt&&!a.fileread)return bulmabox.alert("Say Something!","You can't just post nothing!"),!1;n.post("/forum/newPost",{thread:a.thr._id,text:(new showdown.Converter).makeHtml(a.newPostTxt),md:a.newPostTxt,file:a.fileread||null}).then(function(e){window.location.reload()})},a.vote=function(e,t){n.put("/forum/vote",{thread:e.thread,post:e._id,voteUp:!!t}).then(function(e){r.debug("vote response is:",e),a.refThred()})},a.repPost=function(t){bulmabox.confirm("Report Post","Are you sure you wish to report this post to the mod team? <br>Please note that abuse of the report feature will result in the mod team being very angery.",function(e){e&&n.get("/forums/reportPost?id="+t._id).then(function(e){bulmabox.alert("Post Reported!","This post has been reported. Thanks!")}).catch(function(e){bulmabox.alert("Can't Report","There was some issue reporting this post. Sorry!")})})},a.quoteMe=function(e){document.querySelector("#postTxt").value=">"+e.md}}]),e.controller("inbox-cont",["$scope","$http","userFact","$log",function(t,n,e,a){t.currMsg=0,a.debug("PARENT USER IS:",t.$parent.user),t.chMsg=function(e){e&&t.currMsg<t.$parent.user.msgs.length-1?(a.debug("goin up 1 msg"),t.currMsg++):!e&&0<t.currMsg&&t.currMsg--,t.$digest()},t.interpDate=function(e){return new Date(e).toUTCString()},t.reply=function(){e.writeMsg(t.$parent.user.msgs[t.currMsg].from,t.$parent.user.name,!0)},t.deleteMsg=function(){bootbox.confirm("Are you sure you wish to delete this message? Deleted messages are <i>not</i> recoverable!",function(e){e&&null!=e&&n.post("/user/delMsg",{user:t.$parent.user.name,id:t.$parent.user.msgs[t.currMsg].id}).then(function(e){e.data&&e.data.name?(t.$parent.user=e.data,a.debug("affected user",t.$parent.user),angular.element("body").scope().$digest(),t.currMsgs=Math.min(t.$parent.user.msgs.length-1,t.currMsgs)):"err"==e.data&&bootbox.alert("Error deleting message!")})})}}]),e.controller("log-cont",["$scope","$http","$state","$q","userFact","$log",function(t,n,a,e,o,r){t.noWarn=!1,t.nameOkay=!0,delete localStorage.geoUsr,t.checkTimer=!1,t.goReg=function(){a.go("appSimp.register")},t.goLog=function(){a.go("appSimp.login")},t.googLog=function(){window.location.href="./user/google"},t.forgot=function(){t.user?n.post("/user/forgot",{user:t.user}).then(function(e){r.debug("forgot route response",e),"err"==e.data?bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Forgot Password Error',"It looks like that account either doesn't exist, or doesn't have an email registered with it! Contact a mod for further help."):bulmabox.alert("Forgot Password","Check your email! If your username is registered, you should recieve an email from us with a password reset link.")}):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Forgot Password',"To recieve a password reset email, please enter your username!")},t.signin=function(){r.debug("trying to login with",t.user,t.pwd),n.post("/user/login",{user:t.user,pass:t.pwd}).then(function(e){r.debug(e),"authErr"!=e.data&&e.data?"banned"==e.data?bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Banned',"You've been banned! We're a pretty laid-back guild, so you must have <i>really</i> done something to piss us off!"):(r.debug("LOGIN RESPONSE",e.data),u.emit("chatMsg",{msg:t.user+" logged in!"}),localStorage.geoUsr=JSON.stringify(e.data.usr),e.data.news&&bulmabox.alert("Updates/News","Since you last logged in, the following updates have been implemented:<br><ul style='list-style:disc;'><li>"+e.data.news.join("</li><li>")+"</li></ul>"),a.go("app.dash")):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Incorrect Login',"Either your username or password (or both!) are incorrect.")}).catch(function(e){"unconfirmed"==e.data?bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Unconfirmed',"Your account is currently unconfirmed. For anti-spam purposes, we need a [GEO] person to confirm your account. Thanks!"):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Error',"There's been some sort of error logging in. This is <i>probably</i> not an issue necessarily with your credentials. Blame Dave!")})},t.checkUser=function(){t.checkTimer&&clearTimeout(t.checkTimer),t.checkTimer=setTimeout(function(){n.get("/user/nameOkay?name="+t.user).then(function(e){t.nameOkay=e.data})},500)},t.emailBad=!1,t.checkEmail=function(){t.emailBad=t.email.length&&!t.email.match(/(\w+\.*)+@(\w+\.)+\w+/g)},t.register=function(){t.pwd&&t.pwdDup&&t.user?t.pwd!=t.pwdDup?(r.debug("derp"),bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Password Mismatch',"Your passwords don't match, or are missing!")):!t.email||t.emailBad?bulmabox.confirm('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Send Without Email?',"You've either not included an email, or the format you're using doesn't seem to match any we know. <br>While you can register without a valid email, it'll be much more difficult to recover your account.<br>Register anyway?",function(e){if(!e||null==e)return!1;n.post("/user/new",{user:t.user,pass:t.pwd,email:t.email}).then(function(e){n.post("/user/login",{user:t.user,pass:t.pwd}).then(function(){a.go("app.dash")}).catch(function(e){"duplicate"==e.data&&bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;User Already Exists',"That account already exists. Are you sure you didn't mean to log in?"),"unconfirmed"==e.data&&a.go("appSimp.unconfirmed")})}).catch(function(e){"duplicate"==e.data&&bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;User Already Exists',"That account already exists. Are you sure you didn't mean to log in?"),"unconfirmed"==e.data&&a.go("appSimp.unconfirmed")})}):(r.debug("running register with user",t.user,"and pwd",t.pwd),n.post("/user/new",{user:t.user,pass:t.pwd,email:t.email}).then(function(e){n.post("/user/login",{user:t.user,pass:t.pwd}).then(function(){a.go("app.dash")})}).catch(function(e){"duplicate"==e.data&&bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;User Already Exists',"That account already exists. Are you sure you didn't mean to log in?")})):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Missing Information',"Please enter a username, and a password (twice).")}}]),String.prototype.capMe=function(){return this.slice(0,1).toUpperCase()+this.slice(1)},e.controller("main-cont",["$scope","$http","$state","userFact","$log",function(n,e,t,a,o){o.debug("main controller registered!"),n.user=null,a.getUser().then(function(e){n.user=e.data,u.emit("hiIm",{name:n.user.user})}),n.isActive=!0,n.pokeTimer=null,n.faceOpen=!1;var r="Hidden Tyria Geographic Society [GEO] Guild Site";window.addEventListener("focus",function(e){n.isActive=!0,n.pokeTimer&&clearInterval(n.pokeTimer),document.title=r}),window.addEventListener("blur",function(e){n.isActive=!1});var i=["😐","😮"];u.on("chatMsgOut",function(e){e.msg.includes("@"+n.user.user)&&e.user!=n.user.user&&!n.isActive&&(n.pokeTimer=setInterval(function(){n.faceOpen=!n.faceOpen;var e=n.faceOpen?0:1;document.title=i[e]+" "+r},250))}),u.on("reqHeartBeat",function(e){n.alsoOnline=e.filter(function(e){return!n.user||!n.user.user||n.user.user!=e.name}).map(function(e){return e.name}),n.user&&n.user.user&&t.current.name.includes("app.")&&u.emit("hbResp",{name:n.user.user})}),u.on("disco",function(e){n.col=e?"div:nth-child(even){animation:huehue 4s linear 2s infinite;}div:nth-child(odd){animation:huehue 4s linear 0s infinite;}":"div:nth-child(even){animation:none;}div:nth-child(odd){animation:none}"}),n.explMd=function(){bulmabox.alert("Markdown",'<div class=\'is-size-2\'>Markdown</div>\n        <hr>\n        <div class=\'is-size-5\'>What It Is</div>\n        <p>Markdown is a specialized way of formatting text, used by sites like Reddit, Stack Overflow, and apps like Discord.</p>\n        <hr>\n        <div class=\'is-size-5\'>What It Does</div>\n        <p>It allows you to format text with stuff like <strong>bold</strong> or <em>italics</em> without the use of fancy, complex word processors.</p>\n        <hr>\n        <div class=\'is-size-4\'>Commands:</div>\n        <table class="table table-striped table-bordered">\n        <thead>\n        <tr>\n        <th style="text-align:left"><strong>Markdown</strong></th>\n        <th style="text-align:left"><strong>Result</strong></th>\n        </tr>\n        </thead>\n        <tbody>\n        <tr>\n        <td style="text-align:left">#text, ##text,…</td>\n        <td style="text-align:left">header (big text). More \'#\'s means smaller headers</td>\n        </tr>\n        <tr>\n        <td style="text-align:left">*text*, _text_</td>\n        <td style="text-align:left"><em>italic text</em></td>\n        </tr>\n        <tr>\n        <td style="text-align:left">**text**,__text,__</td>\n        <td style="text-align:left"><strong>bold text</strong></td>\n        </tr>\n        <tr>\n        <td style="text-align:left">~~text~~</td>\n        <td style="text-align:left"><s>strikethrough text</s> woops!</td>\n        </tr>\n        <tr>\n        <td style="text-align:left">[link text](link url)</td>\n        <td style="text-align:left"><a href="https://www.google.com">links</a></td>\n        </tr>\n        <tr>\n        <td style="text-align:left">- item</td>\n        <td style="text-align:left">- item in a bullet list</td>\n        </tr>\n        <tr>\n        <td style="text-align:left">1. item</td>\n        <td style="text-align:left">1. Item in a numbered list</td>\n        </tr>\n        <tr>\n        <td style="text-align:left">![alt text](url “hover text”)</td>\n        <td style="text-align:left"><img src="https://github.com/adam-p/markdown-here/raw/master/src/common/images/icon48.png" alt="alt text" title="hover text"> (The alt text is displayed if the browser can’t load the image)</td>\n        </tr>\n        <tr>\n        <td style="text-align:left">`text`</td>\n        <td style="text-align:left"><code>look ma, ima programmer!</code></td>\n        </tr>\n        </tbody>\n        </table>')},n.sc="",n.seekrit={code:["arrowup","arrowup","arrowdown","arrowdown","arrowleft","arrowright","arrowleft","arrowright","b","a","Space"],on:!1,asking:!1,hist:[],corrNum:0,whichFont:0},n.fontOpts=["aurebesh","tengwar quenya-1","klingon font","hieroglyphic","dovahkiin","Skyrim_Daedra"],document.querySelector("body").addEventListener("keyup",function(e){if(e.preventDefault(),n.seekrit.asking)return!1;var t=n.seekrit.code[n.seekrit.corrNum];if(e.key.toLowerCase()!=t&&e.code!=t)return!1;n.seekrit.corrNum+1===n.seekrit.code.length?(n.seekrit.asking=!0,bulmabox.confirm("Toggle Secret Mode","Are you sure you wanna toggle the Secret Mode?",function(e){if(e&&null!==e){if(n.seekrit.on=!n.seekrit.on,n.seekrit.on){var t=n.fontOpts[n.seekrit.whichFont];n.seekrit.whichFont++,n.seekrit.whichFont>=n.fontOpts.length&&(n.seekrit.whichFont=0),n.sc="*:not(.fa){font-family:"+t+",arial!important;}"}else n.sc="";n.$digest()}else n.sc="",n.$digest();n.seekrit.asking=!1,n.seekrit.corrNum=0})):n.seekrit.corrNum++})}]),e.controller("nav-cont",["$scope","$http","$state","$log",function(t,n,a,o){t.logout=function(){bulmabox.confirm("Logout","Are you sure you wish to logout?",function(e){if(!e||null==e)return!0;n.get("/user/logout").then(function(e){o.debug("b4 logout usr removl, parent scope is",t.$parent.user),t.$parent.user=null,o.debug("and now its",t.$parent.user),a.go("appSimp.login")})})},t.mobActive=!1}]),t.controller("reset-contr",["$scope","$http","$location","$log",function(t,e,n,a){t.key=window.location.search.slice(5),e.get("/user/resetUsr?key="+t.key).then(function(e){a.debug("getting reset user status?",e),t.user=e.data}),t.doReset=function(){t.user&&t.pwd&&t.pwdDup&&t.pwdDup==t.pwd&&t.key?e.post("/user/resetPwd",{acct:t.user.user,pwd:t.pwd,pwdDup:t.pwdDup,key:t.key}).then(function(e){"err"==e.data?bulmabox.alert("Error resetting password","There was an error resetting your password. Please contact a mod"):bulmabox.alert("Password Reset","Your password was successfully reset! We're redirecting you to login now.",function(){t.goLogin()})}):bulmabox.alert("Error: Missing data","Make sure you&rsquo;ve reached this page from a password reset link, and that you have entered the same password in both fields!")},t.goLogin=function(){window.location.href="../../login"}}]);var a=[{value:-12,text:"(GMT -12:00) Eniwetok, Kwajalein"},{value:-11,text:"(GMT -11:00) Midway Island, Samoa"},{value:-10,text:"(GMT -10:00) Hawaii"},{value:-9,text:"(GMT -9:00) Alaska"},{value:-8,text:"(GMT -8:00) Pacific Time (US & Canada)"},{value:-7,text:"(GMT -7:00) Mountain Time (US & Canada)"},{value:-6,text:"(GMT -6:00) Central Time (US & Canada), Mexico City"},{value:-5,text:"(GMT -5:00) Eastern Time (US & Canada), Bogota, Lima"},{value:-4,text:"(GMT -4:00) Atlantic Time (Canada), Caracas, La Paz"},{value:-3.5,text:"(GMT -3:30) Newfoundland"},{value:-3,text:"(GMT -3:00) Brazil, Buenos Aires, Georgetown"},{value:-2,text:"(GMT -2:00) Mid-Atlantic"},{value:-1,text:"(GMT -1:00) Azores, Cape Verde Islands"},{value:0,text:"(GMT) Western Europe Time, London, Lisbon, Casablanca"},{value:1,text:"(GMT +1:00) Brussels, Copenhagen, Madrid, Paris"},{value:2,text:"(GMT +2:00) Kaliningrad, South Africa"},{value:3,text:"(GMT +3:00) Baghdad, Riyadh, Moscow, St. Petersburg"},{value:3.5,text:"(GMT +3:30) Tehran"},{value:4,text:"(GMT +4:00) Abu Dhabi, Muscat, Baku, Tbilisi"},{value:4.5,text:"(GMT +4:30) Kabul"},{value:5,text:"(GMT +5:00) Ekaterinburg, Islamabad, Karachi, Tashkent"},{value:5.5,text:"(GMT +5:30) Bombay, Calcutta, Madras, New Delhi"},{value:5.75,text:"(GMT +5:45) Kathmandu"},{value:6,text:"(GMT +6:00) Almaty, Dhaka, Colombo"},{value:7,text:"(GMT +7:00) Bangkok, Hanoi, Jakarta"},{value:8,text:"(GMT +8:00) Beijing, Perth, Singapore, Hong Kong"},{value:9,text:"(GMT +9:00) Tokyo, Seoul, Osaka, Sapporo, Yakutsk"},{value:9.5,text:"(GMT +9:30) Adelaide, Darwin"},{value:10,text:"(GMT +10:00) Eastern Australia, Guam, Vladivostok"},{value:11,text:"(GMT +11:00) Magadan, Solomon Islands, New Caledonia"},{value:12,text:"(GMT +12:00) Auckland, Wellington, Fiji, Kamchatka"}],l=[{id:1001,name:"Anvil Rock",population:"High"},{id:1002,name:"Borlis Pass",population:"Medium"},{id:1003,name:"Yak's Bend",population:"High"},{id:1004,name:"Henge of Denravi",population:"Medium"},{id:1005,name:"Maguuma",population:"High"},{id:1006,name:"Sorrow's Furnace",population:"Medium"},{id:1007,name:"Gate of Madness",population:"Medium"},{id:1008,name:"Jade Quarry",population:"Medium"},{id:1009,name:"Fort Aspenwood",population:"Full"},{id:1010,name:"Ehmry Bay",population:"Medium"},{id:1011,name:"Stormbluff Isle",population:"Medium"},{id:1012,name:"Darkhaven",population:"Medium"},{id:1013,name:"Sanctum of Rall",population:"VeryHigh"},{id:1014,name:"Crystal Desert",population:"Medium"},{id:1015,name:"Isle of Janthir",population:"Medium"},{id:1016,name:"Sea of Sorrows",population:"VeryHigh"},{id:1017,name:"Tarnished Coast",population:"High"},{id:1018,name:"Northern Shiverpeaks",population:"High"},{id:1019,name:"Blackgate",population:"Full"},{id:1020,name:"Ferguson's Crossing",population:"Medium"},{id:1021,name:"Dragonbrand",population:"Medium"},{id:1022,name:"Kaineng",population:"High"},{id:1023,name:"Devona's Rest",population:"Medium"},{id:1024,name:"Eredon Terrace",population:"Medium"},{id:2001,name:"Fissure of Woe",population:"Medium"},{id:2002,name:"Desolation",population:"VeryHigh"},{id:2003,name:"Gandara",population:"High"},{id:2004,name:"Blacktide",population:"Medium"},{id:2005,name:"Ring of Fire",population:"Medium"},{id:2006,name:"Underworld",population:"Medium"},{id:2007,name:"Far Shiverpeaks",population:"Medium"},{id:2008,name:"Whiteside Ridge",population:"High"},{id:2009,name:"Ruins of Surmia",population:"Medium"},{id:2010,name:"Seafarer's Rest",population:"VeryHigh"},{id:2011,name:"Vabbi",population:"High"},{id:2012,name:"Piken Square",population:"VeryHigh"},{id:2013,name:"Aurora Glade",population:"High"},{id:2014,name:"Gunnar's Hold",population:"Medium"},{id:2101,name:"Jade Sea",population:"High"},{id:2102,name:"Fort Ranik",population:"Medium"},{id:2103,name:"Augury Rock",population:"High"},{id:2104,name:"Vizunah Square",population:"Medium"},{id:2105,name:"Arborstone",population:"Medium"},{id:2201,name:"Kodash",population:"High"},{id:2202,name:"Riverside",population:"Full"},{id:2203,name:"Elona Reach",population:"VeryHigh"},{id:2204,name:"Abaddon's Mouth",population:"Medium"},{id:2205,name:"Drakkar Lake",population:"High"},{id:2206,name:"Miller's Sound",population:"Medium"},{id:2207,name:"Dzagonur",population:"Medium"},{id:2301,name:"Baruch Bay",population:"VeryHigh"}];Object.freeze(l),e.controller("tool-cont",["$scope","$http","$state","$filter","$sce","$window","$log",function(r,t,e,n,a,o,i){r.showTab=function(e){r.currTab=e,"WvW Current Match History"==r.currTab&&r.refWvw()},r.currTab="Dailies",r.tabs=[{name:"Dailies",icon:"calendar-check-o"},{name:"WvW Current Match History",icon:"fort-awesome"},{name:"Core/Lodestone Upgrade",icon:"diamond"},{name:"Tier Six Material Conversion",icon:"money"}],r.dailyRestrict={},r.tmrw=!1,r.regetDaily=function(){var e=Object.keys(r.dailyRestrict).filter(function(e){return r.dailyRestrict[e]});t.get("/tool/daily"+(r.tmrw?"/tomorrow":"")+(e.length?"?modes="+e.join(","):"")).then(function(e){i.debug("dailyObj",e.data),r.dailies=e.data})},o.addEventListener("keyup",function(e){39!=e.which||e.shiftKey?39==e.which&&e.shiftKey?(r.lastSkirm(),r.$digest()):37!=e.which||e.shiftKey?37==e.which&&e.shiftKey&&(r.firstSkirm(),r.$digest()):(r.prevSkirm(),r.$digest()):(r.nextSkirm(),r.$digest())}),r.regetDaily(),r.refPrices=function(){t.get("/tool/allPrices").then(function(e){r.prices=r.calcPrices(e.data.p)})},r.wvwWorld=!1,r.wvwColors=["red","green","blue"],r.wvwPie={cutoutPercentage:0,backgroundColor:["#aa0000","#00aa00","#0000aa"],config:{plugins:{vert:!1}}},r.wvwDisabled=!1,r.makeMarkers=function(){r.mapMarkers=["camp-blue.png","camp-green.png","camp-netural.png","camp-red.png","castle-blue.png","castle-green.png","castle-neutral.png","castle-red.png","keep-blue.png","keep-green.png","keep-netural.png","keep-red.png","ruins-blue.png","ruins-green.png","ruins-neutral.png","ruins-red.png","tower-blue.png","tower-green.png","tower-neutral.png","tower-red.png"].map(function(e){return L.icon({iconUrl:"./img/wvw/"+e,iconName:e.replace(".png",""),iconSize:[32,32],iconAnchor:[15,15],popupAnchor:[-3,-76]})}),i.debug("Map Markers",r.mapMarkers)},r.refWvw=function(){t.get("/tool/wvw"+(r.wvwWorld?"?world="+r.wvwWorld:"")).then(function(t){if(i.debug("WVW STUFF",t,t.data),"newMatch"==t.data)return r.wvwDisabled=!0,r.wvw=null,!1;r.wvwDisabled=!1,r.wvw=t.data.wvw,r.currentMatch=r.wvw.skirmishes.length-1,r.wvw.labels=r.wvwColors.map(function(e){return t.data.wvw.all_worlds[e].map(function(t){return l.find(function(e){return e.id==t}).name}).join(", ")}),r.wvw.skirmishes.forEach(function(t){t.scoreArr=r.wvwColors.map(function(e){return t.scores[e]})}),r.wvw.history=r.wvwColors.map(function(t){return r.wvw.skirmishes.map(function(e){return e.scores[t]})}),r.wvw.histLabels=new Array(r.wvw.history[0].length).fill(100).map(function(e,t){return t+1}),r.wvw.histColors=[{backgroundColor:"transparent",borderColor:"#f00",pointBackgroundColor:"#f00"},{backgroundColor:"transparent",borderColor:"#0f0",pointBackgroundColor:"#0f0"},{backgroundColor:"transparent",borderColor:"#00f",pointBackgroundColor:"#00f"}],i.debug("WVW",r.wvw),r.mapMarkers=[],r.wvwOwned=t.data.owned||null,r.makeMarkers();var e=document.querySelector("#wvw-map");i.debug("mapDiv",e,e.offsetWidth),r.doMap(r.wvw.maps)})},r.nextSkirm=function(){if(!r.wvw)return!1;r.wvw.skirmishes.length>r.currentMatch+1?r.currentMatch++:r.currentMatch=0,r.positionVert()},r.prevSkirm=function(){if(!r.wvw)return!1;r.currentMatch&&0<r.currentMatch?r.currentMatch--:r.currentMatch=r.wvw.skirmishes.length-1,r.positionVert()},r.lastSkirm=function(){r.currentMatch=r.wvw.skirmishes.length-1,r.positionVert()},r.firstSkirm=function(){r.currentMatch=0,r.positionVert()},r.mats=["blood","bone","claw","fang","scale","totem","venom"],r.cores=["glacial","onyx","destroyer","molten","corrupted","essence","crystal","charged"],r.calcPrices=function(a){i.debug("DATA before prices",a),a.push({hi:2504,lo:2504,lName:"Bottle of Elonian Wine",id:19663,sName:"wine"});var o=a.find(function(e){return"t6dust"==e.sName});return r.mats.forEach(function(t){var e=a.find(function(e){return e.sName=="t5"+t}),n=a.find(function(e){return e.sName=="t6"+t});n.hiProf=12*n.hi-(50*e.lo+1*n.lo+5*o.lo),n.loProf=5*n.lo-(50*e.hi+1*n.hi+5*o.hi),n.t5=e,(n.profGood=0)<n.hiProf&&0<n.loProf?n.profGood=1:n.hiProf<0&&n.loProf<0&&(n.profGood=-1)}),r.cores.forEach(function(t){var e=a.find(function(e){return e.sName=="c"+t}),n=a.find(function(e){return e.sName=="l"+t});n.c=e,n.hiProf=n.hi-(2*e.lo+o.lo+2504),n.loProf=n.lo-(2*e.hi+o.hi+2504),(n.profGood=0)<n.hiProf&&0<n.loProf?n.profGood=1:n.hiProf<0&&n.loProf<0&&(n.profGood=-1)}),i.debug("PRICES!",a),a},r.isMat=function(e){return-1<e.sName.indexOf("t6")&&"t6dust"!=e.sName},r.isGem=function(e){return e.sName.indexOf("t6")<0&&"wine"!=e.sName&&e.sName.indexOf("t5")<0&&"l"==e.sName[0]},r.histClick=function(e){if(i.debug("CLICKED:",e,Chart),!e||!e[0])return!1;r.currentMatch=e[0]._index,r.positionVert()},r.positionVert=function(){r.lineOpts.title.text="("+(r.currentMatch+1)+")"},Chart.plugins.register({id:"vert",afterDraw:function(e,t){if("doughnut"!=e.config.type){r.lineXWid=e.chartArea.right-e.chartArea.left,r.lineYWid=e.chartArea.left,r.lineHeight=e.chartArea.bottom-e.chartArea.top,r.lineStepWid=r.lineXWid/(r.wvw.skirmishes.length-1);var n=e.canvas.getContext("2d");n.moveTo(r.lineYWid+r.currentMatch*r.lineStepWid,5),n.lineTo(r.lineYWid+r.currentMatch*r.lineStepWid,r.lineHeight+5),n.strokeStyle="#fff",n.stroke()}}}),r.lineOpts={title:{text:"("+(r.currentMatch+1)+")"},scales:{yAxes:[{ticks:{beginAtZero:!0,fontColor:"#fff"}}],xAxes:[{ticks:{fontColor:"#fff"}}]},hover:{animationDuration:0}},r.refPrices(),r.getMapState=function(){i.debug("ZOOM",r.map.getZoom(),"BOUNDS",r.map.getBounds())},r.unproject=function(e,t){return e.unproject(t,e.getMaxZoom())},r.doMap=function(e){var t,n;r.map=L.map("wvw-map",{minZoom:0,maxZoom:6}),n=r.unproject(r.map,[15700,8900]),t=r.unproject(r.map,[5100,15900]);var a=new L.LatLngBounds(r.unproject(r.map,[16384,0]),r.unproject(r.map,[0,16384]));L.tileLayer("https://tiles.guildwars2.com/2/3/{z}/{x}/{y}.jpg",{subdomains:["tiles1","tiles2","tiles3","tiles4"],bounds:a,minNativeZoom:4,noWrap:!0}).addTo(r.map),r.map.setMaxBounds(new L.LatLngBounds(t,n)),r.map.setView(new L.LatLng((n.lat-t.lat)/2,(n.lng-t.lng)/2),0),e.forEach(function(e){e.objectives.filter(function(e){return!!e.marker}).forEach(function(t){var e=r.mapMarkers.find(function(e){return e.options.iconName==t.type.toLowerCase()+"-"+t.owner.toLowerCase()});i.debug("THIS OBJECTIVE",t,"MARKER (probly)",e,"FROM",t.type.toLowerCase()+"-"+t.owner.toLowerCase()),L.marker(r.unproject(r.map,t.coord),{title:t.name+" (owned by: "+t.owner+")",icon:e}).addTo(r.map)})}),setTimeout(function(){r.map.invalidateSize(),r.map.setZoom(3)},500)}}]),e.controller("unconf-cont",["$scope","$http","$state","$log",function(e,t,n,a){e.logout=function(){t.get("/user/logout").then(function(e){a.debug(e),n.go("appSimp.login")})}}]),e.factory("socketFac",["$rootScope",function(a){var o=io.connect();return{on:function(e,t){o.on(e,function(){var e=arguments;a.$apply(function(){t.apply(o,e)})})},emit:function(e,t,n){o.emit(e,t,function(){var e=arguments;a.$apply(function(){n&&n.apply(o,e)})})}}}]),e.run(["$rootScope","$state","$stateParams","$transitions","$q","userFact","$log",function(e,n,t,a,o,r,i){a.onBefore({to:"app.**"},function(e){var t=o.defer();return i.debug("TRANS",e),e.injector().get("userFact").getUser().then(function(e){i.debug("response from login chck",e),e.data&&e.data.confirmed?t.resolve(!0):e.data?t.resolve(n.target("appSimp.unconfirmed",void 0,{location:!0})):t.resolve(n.target("appSimp.login",void 0,{location:!0}))}).catch(function(e){t.resolve(n.target("appSimp.login",void 0,{location:!0}))}),t.promise})}]),e.factory("userFact",["$http","$log",function(e,t){return{getUser:function(){return e.get("/user/getUsr").then(function(e){return t.debug("getUser in fac says:",e),e})}}}])}();