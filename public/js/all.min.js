...
!function(){"use strict";o.$inject=["$timeout"];const e=io(),t=angular.module("htgeo-app",["ui.router","ngAnimate","ngSanitize","chart.js"]),a=angular.module("reset-app",[]),r="data:image/png;base64,";Array.prototype.findUser=function(e){for(var t=0;t<this.length;t++)if(this[t].user==e)return t;return-1};t.constant("IsDevelopment","localhost"===window.location.hostname).config(["$stateProvider","$urlRouterProvider","$locationProvider","$httpProvider","$compileProvider","$logProvider",function(e,t,a,r,n,o,i){a.html5Mode(!0),t.otherwise("/404"),n.debugInfoEnabled(i),o.debugEnabled(i),e.state("app",{abstract:!0,templateUrl:"layouts/full.html"}).state("app.blog",{url:"/blog",templateUrl:"components/blog.html"}).state("app.dash",{url:"/",templateUrl:"components/dash.html"}).state("app.chat",{url:"/chat",cache:!1,templateUrl:"components/chat.html"}).state("app.calendar",{url:"/calendar",templateUrl:"components/calendar.html"}).state("app.help",{url:"/help",templateUrl:"components/help/help.html"}).state("app.forum",{url:"/forum",templateUrl:"components/forums/forum.html"}).state("app.forumCat",{url:"/forumCat?c",templateUrl:"components/forums/forumCat.html"}).state("app.forumThr",{url:"/forumThr?c&t",templateUrl:"components/forums/forumThr.html"}).state("app.tools",{url:"/tools",templateUrl:"components/tools.html"}).state("appSimp",{abstract:!0,templateUrl:"components/layout/simp.html"}).state("appSimp.login",{url:"/login",templateUrl:"components/login.html"}).state("appSimp.register",{url:"/register",templateUrl:"components/register.html"}).state("appSimp.unconfirmed",{url:"/unconf",templateUrl:"components/alt/unconfirmed.html"}).state("appSimp.notfound",{url:"/404",templateUrl:"components/alt/404.html"}).state("appSimp.err",{url:"/500",templateUrl:"components/alt/500.html"})}]).directive("fileread",[function(){return{scope:{fileread:"="},link:function(e,t,a){t.bind("change",function(t){const a=new FileReader,r=t.target.files[0],o=r.name;return $log.debug("UPLOADING FILE",r),a.onload=function(t){let a=t.target.result;$log.debug("URI before optional resize",a,a.length),e.$parent.needsResize?n(e,a,e.$parent.needsResize,e.$parent.needsResize,o):($log.debug("APPLYING file to $parent"),e.$apply(function(){e.$parent&&e.$parent.$parent&&e.$parent.$parent.avas?(e.$parent.$parent.loadingFile=!1,e.$parent.$parent.fileName="Loaded:"+o,e.$parent.$parent.fileread=a):(e.$parent.loadingFile=!1,e.$parent.fileName="Loaded:"+o,e.$parent.fileread=a),e.$parent.saveDataURI&&"function"==typeof e.$parent.saveDataURI&&e.$parent.saveDataURI(dataURI)}))},r?r.size>25e5?(bulmabox.alert("File too Large",`Your file ${r.name} is larger than 2.5MB. Please upload a smaller file!`),!1):void a.readAsDataURL(r):(e.$apply(function(){e.fileread="",e.$parent.fileName=!1,e.$parent.loadingFile=!1}),!1)})}}}]).filter("markdown",["$sce",function(e){return function(t){const a=new showdown.Converter;return e.trustAsHtml(a.makeHtml(t))}}]),Array.prototype.rotate=function(e){let t=angular.copy(this);for(var a=0;a<e;a++)t.push(t.shift());return t},Date.prototype.dyMo=function(){return this.getMonth()+1+"/"+this.getDate()},String.prototype.titleCase=function(){return this.split(/\s/).map(e=>e.slice(0,1).toUpperCase()+e.slice(1).toLowerCase()).join(" ")};const n=(e,t,a,r,n)=>{const o=document.createElement("img");o.onload=function(){const t=document.createElement("canvas"),o=t.getContext("2d");t.width=a,t.height=r,o.drawImage(this,0,0,a,r);const i=t.toDataURL();e.$apply(function(){e.$parent.loadingFile=!1,e.$parent.fileName="Loaded:"+n,e.fileread=i,e.$parent.saveDataURI&&"function"==typeof e.$parent.saveDataURI&&e.$parent.saveDataURI(i)})},o.src=t};function o(e){return{restrict:"A",priority:101,link:function(t,a,r){e(function(){t.$evalAsync(r.postrenderAction)},0)}}}t.directive("postrenderAction",o),t.factory("socketFac",["$rootScope",function(e){var t=io.connect();return{on:function(a,r){t.on(a,function(){var a=arguments;e.$apply(function(){r.apply(t,a)})})},emit:function(a,r,n){t.emit(a,r,function(){var a=arguments;e.$apply(function(){n&&n.apply(t,a)})})}}}]),t.run(["$rootScope","$state","$stateParams","$transitions","$q","userFact","$log",function(e,t,a,r,n,o,i){r.onBefore({to:"app.**"},function(e){let a=n.defer();return i.debug("TRANS",e),e.injector().get("userFact").getUser().then(function(e){i.debug("response from login chck",e),e.data&&e.data.confirmed?a.resolve(!0):e.data?a.resolve(t.target("appSimp.unconfirmed",void 0,{location:!0})):a.resolve(t.target("appSimp.login",void 0,{location:!0}))}).catch(e=>{a.resolve(t.target("appSimp.login",void 0,{location:!0}))}),a.promise})}]),t.factory("userFact",["$http","$log",function(e,t){return{getUser:function(){return e.get("/user/getUsr").then(function(e){return t.debug("getUser in fac says:",e),e})}}}]),t.controller("blog-cont",["$scope","$http","$state","$filter","$sce","$log",function(e,t,a,r,n,o){t.get("/user/getUsr").then(t=>{e.doUser(t.data),o.debug("user",e.user)}),e.msgs=[],e.doUser=t=>{if(!t)return!1;e.user=t,e.msgs.push({time:Date.now(),user:"System",msg:"Welcome to Hidden Tyria Geographic Society [GEO] Chat! You're logged in as "+t.user+". Try /wiki or /google to search for stuff!",isSys:!0})},e.newBlog={title:null,contents:null,youtube:null,pic:null,youtubeCand:null},e.blogEntries=[{author:"Healy",pic:"https://static.wixstatic.com/media/4c8c05_d15c19168bda4a3c9a3bef232a00310f~mv2.jpg/v1/fit/w_1175,h_661,al_c,q_80/file.png",height:400,title:"A Test Post",contents:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc et mi ut mauris rutrum malesuada. Ut tincidunt in ex ac ultrices. Integer nec aliquam massa. Fusce aliquam fermentum augue. Suspendisse sollicitudin lectus libero. Praesent varius nisl eu neque cursus lobortis. Nullam convallis turpis sit amet tortor cursus fermentum. In facilisis pharetra urna, sed feugiat est lobortis a. Vestibulum vehicula malesuada purus, id convallis massa suscipit nec. Nunc a ante nunc. Nullam faucibus porttitor erat, vitae convallis augue tincidunt a.\n\n        Nunc egestas hendrerit orci, ut rutrum ex porta ac. Pellentesque porttitor erat neque, eu pulvinar ex sodales quis. Morbi gravida suscipit nulla nec laoreet. Vivamus eleifend magna leo. Morbi tincidunt iaculis euismod. Aliquam malesuada nunc lacinia, convallis augue quis, consectetur elit. Maecenas mattis purus sollicitudin semper feugiat. Ut at gravida augue, sit amet venenatis arcu. Maecenas et justo ut elit ultrices maximus et ac enim. Sed nec rutrum nibh. Etiam malesuada lacus nisl, eget pretium odio consectetur ut.",youtube:"https://www.youtube.com/watch?v=cGZ4X7cER8k",likeNum:0,usrLiked:!1,when:"A long time ago",id:null}],e.refBlogs=()=>{t.get("/blog/allEntries").then(t=>{if(!t.data)throw new Error("no blogs");e.blogEntries=e.parseBlogs(t.data)}).catch(t=>{e.blogEntries=[{author:"System",pic:"https://static.wixstatic.com/media/4c8c05_d15c19168bda4a3c9a3bef232a00310f~mv2.jpg/v1/fit/w_1175,h_661,al_c,q_80/file.png",height:400,title:"Couldn't Load Blog",contents:"Your site is probably broken, or your internet connection sucks. We couldn't load any blog info!",youtube:null,likeNum:0,usrLiked:!1,when:"A long time ago",_id:null}]})},e.refBlogs(),e.parseBlogs=t=>t.map(t=>(t.height=t.height||400,t.likeNum=t.likes.length,t.usrLiked=!!t.likes.includes(e.user._id),t.when=new Date(t.date).toLocaleString(),t.editContents=t.contents,t)),e.toggleLike=a=>{t.get(`/blog/toggleLike?v=${a}`).then(t=>{let a=e.blogEntries.find(e=>e._id==t.data._id);a.likes=t.data.likes,a.usrLiked=t.data.likes.includes(e.user._id),a.likeNum=t.data.likes.length})},e.timers={pic:null,vid:null},e.doPic=t=>{o.debug("EVENT INTO CHANGE",t);const a=new FileReader,r=document.querySelector("#upl-canv"),n=r.getContext("2d");a.onload=function(t){const a=new Image;a.onload=function(){o.debug(a,a.width),r.width=a.width,r.height=a.height,n.drawImage(a,0,0),e.pic=r.toDataURL()},a.src=t.target.result},a.readAsDataURL(t.target.files[0])},e.vidTimer=()=>{e.timers.vid&&clearTimeout(e.timers.vid),e.timers.vid=setTimeout(function(){e.newBlog.youtubeCand&&e.newBlog.youtubeCand.length?e.newBlog.youtubeCand.includes("youtu.be")?e.newBlog.youtube=e.newBlog.youtubeCand.replace("https://youtu.be/","https://www.youtube.com/watch?v=").replace("youtu.be/","https://www.youtube.com/watch?v="):e.newBlog.youtube=e.newBlog.youtubeCand:e.newBlog.youtube=null},500)},e.newPost=a=>{if(!e.newBlog.title||!e.newBlog.contents)return bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Missing Information',"Your blog post needs a title and at least some text content!");let r=angular.copy(e.newBlog);delete r.picCand,delete r.youtubeCand,t.post("/blog/post",r).then(t=>{e.newBlog={title:null,contents:null,youtube:null,pic:null,picCand:null,youtubeCand:null},e.refBlogs()})},e.editBlog=a=>{bulmabox.confirm("Update Blog Text","Are you sure you wanna update your blog post?",r=>{r&&t.put("/blog/post",a).then(t=>{e.refBlogs()})})},e.deleteBlog=a=>{o.debug("Attempting to delete blog",a),bulmabox.confirm("Delete Blog Post","Are you sure you wanna delete this blog entry?",r=>{r&&(Object.keys(a)||o.debug("somehow b got emptied!",a),t.delete("/blog/post?id="+a._id).then(t=>{e.refBlogs()}))})}}]).directive("customOnChange",function(){return{restrict:"A",link:function(e,t,a){var r=e.$eval(a.customOnChange);t.on("change",r),t.on("$destroy",function(){t.off()})}}}).filter("trusted",["$sce",function(e){return function(t){const a=t.split("v=")[1].split("&")[0];return e.trustAsResourceUrl("https://www.youtube.com/embed/"+a)}}]),Date.prototype.stdTimezoneOffset=function(){var e=new Date(this.getFullYear(),0,1),t=new Date(this.getFullYear(),6,1);return Math.max(e.getTimezoneOffset(),t.getTimezoneOffset())},Date.prototype.isDstObserved=function(){return this.getTimezoneOffset()<this.stdTimezoneOffset()},t.controller("cal-cont",["$scope","$http","$state","$log",function(t,a,r,n){t.cal=[],t.days=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],t.calLoaded=!1,t.wkOpts=[{lbl:"Every week",n:1},{lbl:"Every two weeks",n:2},{lbl:"Every three weeks",n:3},{lbl:"Every four weeks",n:4},{lbl:"Every five weeks",n:5}],a.get("/user/usrData").then(e=>{t.user=e.data}),t.refCal=()=>{a.get("/cal/all").then(e=>{n.debug("calendar events response:",e),t.makeCalendar(e.data)})},e.on("refCal",e=>{t.refCal()}),t.refCal(),t.makeCalendar=e=>{t.offsetDays=t.days.rotate((new Date).getDay());let a=0,r=0,o=new Date;for(o.setHours(0,0,0,0),o=o.getTime(),t.cal=[];a<6;a++){let i={wk:a,wkSt:new Date(o+7*a*1e3*3600*24),wkEn:new Date(o+1e3*(7*(a+1)-1)*3600*24),days:[]};for(r=0;r<7;r++){let t=new Date(o+1e3*(7*a+r)*3600*24);i.days.push({d:r,evts:e.filter(e=>{let a=new Date(e.eventDate).getTime();return n.debug("THIS DATE DTNUM",a,t.getTime()),a>t.getTime()&&a<t.getTime()+864e5}),date:t})}t.cal.push(i)}n.debug("CAL STUFF",t.cal,t.offsetDays)},t.viewEvent=e=>{n.debug("View event",e);let a=null;e.paid&&e.paid.length&&(a=`<ul class='ul'>\n                ${e.paid.map(e=>"<li> - "+e+"</li>").join("")}\n            </ul>`),bulmabox.alert(`Event: ${e.title}`,`Time:${new Date(e.eventDate).toLocaleString()}<br>Type:${t.kindOpts.find(t=>t.kind==e.kind).kindLong}<br>${a?"Paid Users<br>"+a:""}<hr> Description: ${e.text}`)},t.editEventObj={title:"",desc:"",day:0,time:2*((new Date).getHours()+((new Date).getMinutes()<30?.5:0)),kind:"lotto",id:null},t.clearEdit=()=>{t.editEventAct=!1},t.editEventAct=!1,t.editEvent=e=>{t.editEventAct=!0,n.debug("Edit event",e,"hour options",t.hourOpts);const a=new Date(e.eventDate).setHours(0,0,0,0),r=Date.now();t.editEventObj={title:e.title,desc:e.text,kind:t.kindOpts.find(t=>t.kind==e.kind),time:Math.floor((e.eventDate-a)/18e5),day:Math.round((e.eventDate-r)/864e5),id:e._id,user:e.user}},t.doEdit=()=>{n.debug("Input edit event",t.editEventObj);const e=new Date;let r=t.editEventObj.day,o=t.editEventObj.time;(new Date).isDstObserved()||(o+=2)>47&&(o%=47,r++),e.setHours(0,0,0,0);let i=e.getTime()+1800*o*1e3+3600*r*1e3*24;if(n.debug("Sending event",t.editEventObj,i),i<Date.now()+3e5)return bulmabox.alert("Time Expiring",`Your selected time, ${new Date(i).toLocaleString()}, occurs too soon! Please select a later time.`),!1;a.post("/cal/edit",{title:t.editEventObj.title,text:t.editEventObj.desc,eventDate:i,kind:t.editEventObj.kind.kind,id:t.editEventObj.id,user:t.editEventObj.user}).then(function(e){n.debug("edit event response",e),"wrongUser"==e.data&&bulmabox.alert('<i class="fa fa-exclamation-triangle"></i> Wrong User',"You cannot edit this event, as you are not its creator and are not a moderator."),t.refCal(),t.clearEdit()})},t.delEvent=e=>{n.debug("Delete event",e),bulmabox.confirm("Delete Event",`Are you sure you wish to delete the following event?<br> Title: ${e.title}<br>Description: ${e.text}`,function(r){if(!r||null==r)return!1;a.get("/cal/del?id="+e._id).then(function(e){n.debug("delete response",e),t.refCal()})})},t.addEvent=!1,t.newEventObj={title:"",desc:"",day:0,time:2*((new Date).getHours()+((new Date).getMinutes()<30?.5:0)),kind:"lotto",repeatNum:1,repeatOn:!1,repeatFreq:1},a.get("/user/allUsrs").then(e=>{t.allUsrs=e.data.map(e=>e.user)}),t.addPaid=e=>{const r=t.allUsrs.filter(t=>!e.paid||!e.paid.length||e.paid.indexOf(t)<0).map(e=>`<option value='${e}'>${e}</option>`).join("");bulmabox.custom("Add Paid User",`Select a user from the list below to add them to this lotto's candidates:<br><p class='select'><select id='payusr'>${r}</select></p>`,function(){let t=document.querySelector("#payusr").value;n.debug("User wishes to add",t),a.post("/cal/lottoPay",{lottoId:e._id,pusr:t})})},t.hourOpts=new Array(48).fill(100).map((e,t)=>{let a=t<24?"AM":"PM",r=Math.floor(t/2)<13?Math.floor(t/2):Math.floor(t/2)-12;return r<1&&(r=12),{num:t,hr:r+(t%2?":30":":00")+a}}),t.dayOpts=new Array(42).fill(100).map((e,t)=>{let a=new Date(Date.now()+3600*t*1e3*24);return{num:t,day:a.getMonth()+1+"/"+a.getDate()}}),t.kindOpts=[{kind:"lotto",desc:"An item or items will be given away by a [GEO] member to one lucky guild member!",kindLong:"Lottery/Giveaway"},{kind:"payLotto",desc:"Try your luck! One lucky winner will win the pool of donations!",kindLong:"Paid Lottery/Giveaway"},{kind:"announce",desc:"Someone needs to make an important announcement!",kindLong:"Announcement"},{kind:"contest",desc:"Some sort of contest! See who's the best!",kindLong:"Contest"},{kind:"other",desc:"Any other event type",kindLong:"Other"}],t.doAdd=()=>{const e=new Date;let r=t.newEventObj.time,o=t.newEventObj.day;e.setHours(0,0,0,0),(new Date).isDstObserved()||(r+=2)>47&&(r%=47,o++);let i=e.getTime()+1800*r*1e3+3600*o*1e3*24,s=t.newEventObj.repeatOn?"/cal/newRep":"/cal/new";if(i<Date.now()+3e5)return bulmabox.alert("Time Expiring",`Your selected time, ${new Date(i).toLocaleString()}, occurs too soon! Please select a later time.`),!1;n.debug("Sending event",t.newEventObj,i),a.post(s,{title:t.newEventObj.title,text:t.newEventObj.desc,eventDate:i,kind:t.newEventObj.kind.kind,repeatNum:t.newEventObj.repeatNum,repeatFreq:t.newEventObj.repeatFreq,repeatOn:t.newEventObj.repeatOn}).then(function(e){n.debug("new event response",e),t.refCal(),t.clearAdd()})},t.clearAdd=()=>{t.addEvent=!1,t.newEventObj={title:"",desc:"",day:0,time:2*((new Date).getHours()+((new Date).getMinutes()<30?.5:0)),kind:"lotto",repeatNum:1,repeatFreq:1,repeatOn:!1}}}]),t.controller("chat-cont",["$scope","$http","$state","$filter","$sce","$log",function(t,a,r,n,o,i){a.get("/user/getUsr").then(e=>{t.doUser(e.data),i.debug("user",t.user)}),t.msgs=[],t.doUser=e=>{if(!e)return!1;t.user=e,t.msgs.push({time:Date.now(),user:"System",msg:"Welcome to Hidden Tyria Geographic Society [GEO] Chat! You're logged in as "+e.user+". Try /wiki or /google to search for stuff!<br>You can also poke anyone online by doing @<user>, where <user> is their username.<br>Finally, type /list to see a list of who's currently online.",isSys:!0})},t.parseMsg=e=>(i.debug("in parseMsg",e),0===e.indexOf("/wiki ")?`Wiki: <a href="https://wiki.guildwars2.com/wiki/${e.slice(6)}" target="_blank">${e.slice(6)}</a>`:0===e.indexOf("/google ")?`Google: <a href="https://www.google.com/search?q=${e.slice(8)}" target="_blank">${e.slice(8)}</a>`:e),a.get("/user/allUsrs").then(e=>{i.debug("all users is",e),t.allUsers=e.data}),e.on("chatMsgOut",e=>{if(i.debug("before dealing with commands, full message object is",e),"string"!=typeof e.msg)return!1;e.msg=o.trustAsHtml(t.parseMsg(e.msg)),t.msgs.push(e),t.msgs.length>100&&t.msgs.shift(),t.$apply(),document.querySelector("#chat-container").scrollTop=document.querySelector("#chat-container").scrollHeight}),e.on("disconnect",function(){t.msgs.push({time:Date.now(),user:"System",msg:"Warning: The connection to the server was lost. Until you refresh, chat's probably gonna be pretty quiet!",isSys:!0}),t.msgs.length>100&&t.msgs.shift(),t.$apply(),document.querySelector("#chat-container").scrollTop=document.querySelector("#chat-container").scrollHeight}),t.sendChat=()=>{if(!t.newMsg)return!1;if("/list"==t.newMsg.toLowerCase()){let e={time:Date.now(),user:"System",msg:"No other users currently online!",isSys:!0};return t.$parent.alsoOnline&&t.$parent.alsoOnline.length&&(e.msg=`Users currently online:<ul>${t.$parent.alsoOnline.map(e=>"<li> - "+e+"</li>")}</ul>`),t.msgs.push(e),t.msgs.length>100&&t.msgs.shift(),t.newMsg="",!1}return"/coloron"==t.newMsg.toLowerCase()?(i.debug("toggling disco mode!",t.$parent),e.emit("discoMode",{on:!0}),t.newMsg="",!1):"/coloroff"==t.newMsg.toLowerCase()?(i.debug("toggling disco mode!",t.$parent),e.emit("discoMode",{on:!1}),t.newMsg="",!1):(i.debug("Sending chat message",{user:t.user.user,msg:t.newMsg}),e.emit("chatMsg",{user:t.user.user,msg:t.newMsg}),void(t.newMsg=""))},i.debug("CHAT SCOPE",t)}]),t.controller("dash-cont",["$scope","$http","$state","$filter","$log",function(t,a,n,o,s){t.showDups=localStorage.brethDups,a.get("/user/usrData").then(e=>{t.doUser(e.data),s.debug("user",t.user)}),a.get("/cal/latestFive").then(e=>{t.latestEvents=e.data}),t.doUser=e=>{if(!e)return!1;t.user=e,s.debug(e),t.possibleInterests.forEach((t,a)=>{e.ints&&e.ints[a]&&1==e.ints[a]&&(t.active=!0)}),t.numUnreadMsgs=e.msgs.filter(e=>!e.read).length},e.on("sentMsg",function(e){s.debug("SOCKET USER",e,"this user",t.user),e.user!=t.user.user&&e.from!=t.user.user||(s.debug("re-getting user"),a.get("/user/usrData").then(e=>{t.doUser(e.data)}))}),t.tabs=[{name:"Profile/Characters",icon:"user"},{name:"Members",icon:"users"},{name:"Mail",icon:"envelope"},{name:"Upcoming Events",icon:"calendar"}],t.defaultPic=r,t.loadingFile=!1,t.fileName=null,t.needsResize=65,t.loadFile=()=>{t.loadingFile=!0;new FileReader},t.saveDataURI=e=>{a.post("/user/changeAva",{img:e}).then(e=>{t.doUser(e.data)})},t.possibleInterests=[{name:"General PvE",warn:!1,active:!1,icon:"pve.png"},{name:"sPvP",warn:!1,active:!1,icon:"pvp.png"},{name:"WvW",warn:!1,active:!1,icon:"wvw.png"},{name:"Fractals",warn:!1,active:!1,icon:"fracs.png"},{name:"Raids",warn:!0,active:!1,icon:"raids.png"},{name:"Role-Playing",warn:!0,active:!1,icon:"rp.png"}],t.tzs=angular.copy(i),t.changeInterest=(e,r)=>{s.debug(e),e.warn&&e.active&&bulmabox.alert("Game Mode Warning",`Hey! Just so you know, [GEO] generally doesn't do ${e.name}.<br>However, that doesn't mean we don't have people that might be interested!`),a.get(`/user/changeInterest?int=${r}&act=${e.active}`).then(function(e){t.doUser(e.data)})},t.changeTz=()=>{a.get("/user/changeTz?tz="+t.user.tz).then(e=>{t.doUser(e.data)})},t.otherInfTimer=null,t.setOtherInfTimer=()=>{t.otherInfTimer&&clearTimeout(t.otherInfTimer),t.otherInfTimer=setTimeout(function(){a.post("/user/changeOther",{other:t.user.otherInfo}).then(e=>{t.doUser(e.data)})},500)},t.memNameSort=!1,t.charSearch="",t.pickedInts=[!1,!1,!1,!1,!1,!1],t.intSearchToggle=!1,t.charSearchToggle=!1,t.memFilter=e=>{let a=!!e.chars.filter(e=>e.name.toLowerCase().indexOf(t.charSearch.toLowerCase())>-1).length;if(t.charSearch&&!a)return!1;if(t.pickedInts.filter(e=>!!e).length){let a=!0;return t.pickedInts.forEach((t,r)=>{t&&!e.ints[r]&&(a=!1)}),a}return!0},t.getAll=()=>{console.log("getting all yuzrs"),a.get("/user/allUsrs").then(a=>{s.debug("all users is",a),t.allUsers=a.data,setTimeout(function(){e.emit("getOnline",{})},100)})},e.on("allNames",function(e){e=e.map(e=>e.name),t.allUsers&&t.allUsers.forEach(a=>{a.online=e.indexOf(a.user)>-1||a.user==t.user.user}),t.$digest()}),t.showTab=e=>{t.currTab=e},t.currTab="Profile/Characters",t.makeMod=e=>{s.debug("wanna mod",e),bulmabox.confirm("Assign Moderator Rights",`Warning: This will give user ${e.user} full moderator rights, and prevents them from being banned. This process is <i>not</i> reversable!`,function(r){if(!r||null==r)return!1;a.get("/user/makeMod?user="+e.user).then(e=>{t.allUsers=e.data})})},t.toggleBan=e=>{a.get("/user/toggleBan?user="+e.user).then(e=>{t.allUsers=e.data})},t.confirmUsr=e=>{bulmabox.confirm("Confirm User",`Are you sure you wish to confirm user ${e.user}?`,r=>{r&&null!=r&&a.get("/user/confirm?u="+e.user).then(e=>{t.allUsers=e.data})})},t.races=["Asura","Charr","Human","Norn","Sylvari"],t.profs=["Guardian","Warrior","Revenant","Thief","Ranger","Engineer","Elementalist","Mesmer","Necromancer"],t.crafts=["Armorsmith","Chef","Artificer","Huntsman","Jeweler","Leatherworker","Tailor","Weaponsmith","Scribe","None"],t.addEditCharModal={active:!1,name:null,race:"Asura",prof:"Guardian",craftOne:{cName:"None",isMax:!1},craftTwo:{cName:"None",isMax:!1},lvl:80,other:null,isEdit:!1},t.clearAddEditChar=()=>{t.addEditCharModal={active:!1,name:null,race:"Asura",prof:"Guardian",craftOne:{cName:"None",isMax:!1},craftTwo:{cName:"None",isMax:!1},lvl:80,other:null,isEdit:!1}},t.addChar=()=>(t.addEditCharModal.active=!0,!1),t.autoChars=()=>{bulmabox.prompt("Auto-Fill Characters from API","Auto-filling characters from the Guild Wars 2 Official API will replace any existing characters you've entered with API-found characters. <br><br> - You'll need an API key to do this (click <a href='https://account.arena.net/' target='_blank'>here</a> if you dont have one). <br><br>Are you sure you wish to do this?",function(e){e&&null!=e&&a.get("/user/charsFromAPI?api="+e).then(e=>{s.debug("Auto-char response is",e),e&&e.data&&"err"!=e.data?t.doUser(e.data):bulmabox.alert("Error Auto-Filling","There was an error auto-filling your characters.<br>While it <i>may</i> be Dave's fault, you may also wanna check that your API key is valid. You can also always just manually add your characters!")})})},t.delChr=e=>{s.debug("user wishes to remove character",e),bulmabox.confirm("Remove Character",`Are you sure you wish to remove the character ${e.name}?`,function(r){r&&null!=r&&a.get("/user/remChar?id="+e._id).then(e=>{t.doUser(e.data)}).catch(e=>{bulmabox.alert("Error","There was a problem removing this character!")})})},t.addOrEditChar=()=>{if(s.debug("Sending char",t.addEditCharModal),!t.addEditCharModal.name)return bulmabox.alert("No Character Name","You need to tell us what your character's name is!");t.addEditCharModal.isEdit?a.post("/user/editChar",t.addEditCharModal).then(e=>{t.clearAddEditChar(),t.$digest(),t.doUser(e.data)}):a.post("/user/addChar",t.addEditCharModal).then(e=>{t.clearAddEditChar(),t.doUser(e.data)})},t.editChar=e=>(t.addEditCharModal={active:!0,name:e.name,race:e.race,prof:e.prof,craftOne:{cName:e.crafts[0]?e.crafts[0].cName:"None",isMax:!!e.crafts[0]&&e.crafts[0].isMax},craftTwo:{cName:e.crafts[1]?e.crafts[1].cName:"None",isMax:!!e.crafts[1]&&e.crafts[1].isMax},lvl:e.lvl,other:e.other,isEdit:!0},!1),t.mail=(e,t)=>{let r=t?`<div class='notification'>${t}</div>`:"";bulmabox.custom("Send Message",`<div class="field">\n                ${r}\n    <label class='label'>\n        Message\n    </label>\n    <p class="control">\n        <textarea class='textarea' id='newMsg' placeholder='What do you wanna say?'></textarea>\n    </p>\n</div>`,function(r){let n=document.querySelector("#newMsg").value;if(!n)return bulmabox.alert("Huh?","Sorry, but we don't support uncomfortable silences currently."),!1;t&&(n=`<div class='notification'>${t}</div><br>${n}`),s.debug("old",t,"new",n),a.post("/user/sendMsg",{msg:n,to:e._id}).then(e=>{})},"<button class='button is-info' onclick='bulmabox.runCb(bulmabox.params.cb)'>Send</button><button class='button is-danger' onclick='bulmabox.kill(\"bulmabox-diag\")'>Cancel</button>")},t.msgView={active:!1,msg:null,mine:!1},t.clearMsg=()=>{t.msgView={active:!1,msg:null,mine:!1}},t.viewMsg=e=>{s.debug("msg object",e);(new showdown.Converter).makeHtml(e.msg);if(t.msgView.active=!0,t.msgView.mine=!0,t.msgView.msg=e,e.to)return!1;a.get("/user/setOneRead?id="+e._id).then(e=>{t.doUser(e.data)})},e.on("reqHeartBeat",e=>{t.alsoOnline=e.filter(e=>!t.user||!t.user.user||t.user.user!=e.name).map(e=>e.name),t.allUsers&&t.allUsers.forEach(e=>{e.online=t.alsoOnline.includes(e.user)})}),t.delMsg=(e,r)=>{"object"!=typeof e&&(e={_id:e}),bulmabox.confirm("Delete Message","Are you sure you wish to delete this message?",n=>{s.debug("resp",n),n&&null!=n&&a.get("/user/delMsg?id="+e._id).then(e=>{t.doUser(e.data),r&&t.clearMsg()})})},t.delMyMsg=(e,r)=>{"object"!=typeof e&&(e={_id:e}),bulmabox.confirm("Delete Message","Are you sure you wish to delete this message?",n=>{s.debug("resp",n),n&&null!=n&&a.get("/user/delMyMsg?id="+e._id).then(e=>{t.doUser(e.data),r&&t.clearMsg()})})},t.replyMsg=e=>{s.debug("User wants to reply to message",e);const a=(new showdown.Converter).makeHtml(e.msg),r=t.allUsers.find(t=>t.user==e.from);t.mail(r,a),t.clearMsg()},t.repMsg=(e,r)=>{"object"!=typeof e&&(e={_id:e}),s.debug("user wishes to report msg",e),bulmabox.confirm("Report Message","Reporting a message sends a notification to the moderators, including the details of the message.<br>It will then be up to the moderators to determine if you're being uncool to each other.<br>Are you sure you wish to report this message?",n=>{a.post("/user/repMsg",e).then(e=>{"dupRep"==e.data&&bootbox.alert("Already Reported","You've already reported this message. Please wait while the moderator team reviews your report."),r&&t.clearMsg()})})},t.newPwd={pwd:null,pwdDup:null,old:null,changin:!1},t.clearPwd=()=>{t.newPwd={pwd:null,pwdDup:null,old:null,changin:!1}},t.editPwd=()=>{t.newPwd.pwd&&t.newPwd.pwdDup&&t.newPwd.pwd==t.newPwd.pwdDup?a.post("/user/editPwd",t.newPwd).then(e=>{e.data&&"err"!=e.data?(t.clearPwd(),bulmbox.alert("Password Changed!","Your password was successfully changed!"),t.doUser(e.data)):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Error Changing Password',"There was a problem changing your password. Your old one probably still works, but if you're still having an issue, contact a moderator!")}):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Password Mismatch',"Your passwords don't match, or are missing!")},t.viewEvent=e=>{bulmabox.alert(`Event: ${e.title}`,`Date:${o("numToDate")(e.eventDate)}<br>Description:${e.text}`)},t.emailTimer=()=>{t.updEmail&&clearTimeout(t.updEmail),t.updEmail=setTimeout(function(){s.debug(t.user.email),a.get("/user/setEmail?email="+t.user.email).then(e=>{s.debug(e),e.data&&"err"!=e.data&&t.doUser(e.data)})},500)}}]).filter("numToDate",function(){return function(e){if(isNaN(e))return"Invalid date!";const t=new Date(e);return`${t.toLocaleDateString()} ${t.getHours()%12}:${t.getMinutes().toString().length<2?"0"+t.getMinutes():t.getMinutes()} ${t.getHours()<13?"AM":"PM"}`}}),t.controller("forum-cat-cont",["$scope","$http","$state","$location","$log",function(e,t,a,r,n){localStorage.geoUsr||a.go("app.login"),t.get("/user/getUsr").then(t=>{e.user=t.data,n.debug("user",e.user)}),e.newThr={},e.fileName=null,e.currCat=r.search().c,e.refCat=()=>{t.get("/forum/byCat?grp="+e.currCat).then(function(t){n.debug("thrds in this cat",t),e.threads=t.data.sort((e,t)=>e.stickied===t.stickied?e.lastUpd-t.lastUpd:e.stickied?-1:1).map(e=>(e.time=new Date(e.lastUpd),e))})},e.refCat(),e.newThrDial=()=>{e.makingThread=!0},e.clearThread=()=>{e.newThr={},e.makingThread=!1,e.loadingFile=!1},e.loadFile=()=>{e.loadingFile=!0;new FileReader},e.deleteThread=(e,r)=>{e.stopPropagation(),e.preventDefault(),bulmabox.confirm("Delete Thread",`Are you absolutely sure you wish to delete the thread '${r.title}'? <br>Please note that this process is <em>not</em> reversable!`,e=>{if(!e||null==e)return!1;n.debug("Deleting thread",r),t.delete("/forum/deleteThread?id="+r._id).then(e=>{a.go(a.current,{},{reload:!0})})})},e.makeThread=()=>{e.newThr.md=e.newThr.txt,e.newThr.text=(new showdown.Converter).makeHtml(e.newThr.txt),e.newThr.grp=e.currCat,t.post("/forum/newThread",e.newThr).then(function(e){n.debug("new thred response",e),a.go(a.current,{},{reload:!0})})},e.toggleSticky=(a,r)=>{a.stopPropagation(),a.preventDefault(),t.get("/forum/toggleSticky?id="+r).then(t=>{n.debug("response from thread sticky toggle is",t),e.refCat()})},e.toggleLock=(a,r)=>{a.stopPropagation(),a.preventDefault(),t.get("/forum/toggleLock?id="+r).then(t=>{n.debug("response from thread lock toggle is",t),e.refCat()})}}]),t.controller("forum-cont",["$scope","$http","$state","$sce","$log",function(e,t,a,r,n){e.currMsg=0,e.forObj={},localStorage.geoUsr||a.go("app.login"),t.get("/forum/cats").then(t=>{const a=Object.keys(t.data);n.debug("CATS",t),e.forObj=a.map(e=>({name:e,count:t.data[e].n,time:t.data[e].t>0?new Date(t.data[e].t):null}))}),e.searchin=!1,e.search="",e.searchTimer=null,e.doSearch=()=>{e.searchTimer&&clearTimeout(e.searchTimer),e.searchTimer=setTimeout(function(){e.search&&e.search.length&&t.post("/forum/searchThr",{term:e.search}).then(t=>{n.debug("search response",t),e.searchResults=t.data})},500)},e.goCat=function(e){a.go("app.forumCat",{c:e})}}]),t.controller("forum-thr-cont",["$scope","$http","$state","$location","$sce","$log",function(e,t,a,n,o,i){e.currMsg=0,e.defaultPic=r,e.forObj={},e.fileName=null,localStorage.geoUsr||a.go("app.login"),e.loadingFile=!1,e.loadFile=()=>{e.loadingFile=!0;new FileReader},e.currCat=n.search().c,e.id=n.search().t,e.refThred=()=>{i.debug("info to back:",e.id),t.get("/forum/thread?id="+e.id).then(t=>{i.debug("response",t),e.thr=t.data.thrd,t.data.psts.map(e=>(e.rawText=e.text,e.text=o.trustAsHtml(e.text),e.date=new Date(e.lastUpd).toLocaleString(),e.wasEdited=e.lastUpd!=e.createDate,e)),e.avas=t.data.ava,e.thr.posts=e.thr.posts.map(e=>{i.debug("PSTH",e,t.data.psts.filter(t=>t._id==e.id)[0]);const a=t.data.psts.filter(t=>t._id==e.id)[0];return a.votesUp=e.votesUp,a.votesDown=e.votesDown,a.byMod=t.data.mods.indexOf(a.user)>-1,a.order=e.order,t.data.psts.filter(t=>t._id==e.id)[0]}).sort((e,t)=>e.order-t.order),i.debug("thred response",e.thr,t)})},e.refThred(),t.get("/user/getUsr").then(t=>{e.user=t.data,i.debug("user",e.user)}),e.newPost=()=>{if(!e.newPostTxt&&!e.fileread)return bulmabox.alert("Say Something!","You can't just post nothing!"),!1;t.post("/forum/newPost",{thread:e.thr._id,text:(new showdown.Converter).makeHtml(e.newPostTxt),md:e.newPostTxt,file:e.fileread||null}).then(e=>{window.location.reload()})},e.vote=(a,r)=>{t.put("/forum/vote",{thread:a.thread,post:a._id,voteUp:!!r}).then(t=>{i.debug("vote response is:",t),e.refThred()})},e.repPost=e=>{bulmabox.confirm("Report Post","Are you sure you wish to report this post to the mod team? <br>Please note that abuse of the report feature will result in the mod team being very angery.",a=>{a&&t.get("/forums/reportPost?id="+e._id).then(e=>{bulmabox.alert("Post Reported!","This post has been reported. Thanks!")}).catch(e=>{bulmabox.alert("Can't Report","There was some issue reporting this post. Sorry!")})})},e.quoteMe=e=>{document.querySelector("#postTxt").value=">"+e.md}}]),t.controller("inbox-cont",["$scope","$http","userFact","$log",function(e,t,a,r){e.currMsg=0,r.debug("PARENT USER IS:",e.$parent.user),e.chMsg=function(t){t&&e.currMsg<e.$parent.user.msgs.length-1?(r.debug("goin up 1 msg"),e.currMsg++):!t&&e.currMsg>0&&e.currMsg--,e.$digest()},e.interpDate=function(e){return new Date(e).toUTCString()},e.reply=function(){a.writeMsg(e.$parent.user.msgs[e.currMsg].from,e.$parent.user.name,!0)},e.deleteMsg=function(){bootbox.confirm("Are you sure you wish to delete this message? Deleted messages are <i>not</i> recoverable!",function(a){a&&null!=a&&t.post("/user/delMsg",{user:e.$parent.user.name,id:e.$parent.user.msgs[e.currMsg].id}).then(function(t){t.data&&t.data.name?(e.$parent.user=t.data,r.debug("affected user",e.$parent.user),angular.element("body").scope().$digest(),e.currMsgs=Math.min(e.$parent.user.msgs.length-1,e.currMsgs)):"err"==t.data&&bootbox.alert("Error deleting message!")})})}}]),t.controller("log-cont",["$scope","$http","$state","$q","userFact","$log",function(t,a,r,n,o,i){t.noWarn=!1,t.nameOkay=!0,delete localStorage.geoUsr,t.checkTimer=!1,t.goReg=()=>{r.go("appSimp.register")},t.goLog=()=>{r.go("appSimp.login")},t.googLog=()=>{window.location.href="./user/google"},t.forgot=()=>{t.user?a.post("/user/forgot",{user:t.user}).then(function(e){i.debug("forgot route response",e),"err"==e.data?bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Forgot Password Error',"It looks like that account either doesn't exist, or doesn't have an email registered with it! Contact a mod for further help."):bulmabox.alert("Forgot Password","Check your email! If your username is registered, you should recieve an email from us with a password reset link.")}):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Forgot Password',"To recieve a password reset email, please enter your username!")},t.signin=()=>{i.debug("trying to login with",t.user,t.pwd),a.post("/user/login",{user:t.user,pass:t.pwd}).then(a=>{i.debug(a),"authErr"!=a.data&&a.data?"banned"==a.data?bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Banned',"You've been banned! We're a pretty laid-back guild, so you must have <i>really</i> done something to piss us off!"):(i.debug("LOGIN RESPONSE",a.data),e.emit("chatMsg",{msg:`${t.user} logged in!`}),localStorage.geoUsr=JSON.stringify(a.data.usr),a.data.news&&bulmabox.alert("Updates/News",`Since you last logged in, the following updates have been implemented:<br><ul style='list-style:disc;'><li>${a.data.news.join("</li><li>")}</li></ul>`),r.go("app.dash")):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Incorrect Login',"Either your username or password (or both!) are incorrect.")}).catch(e=>{"unconfirmed"==e.data?bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Unconfirmed',"Your account is currently unconfirmed. For anti-spam purposes, we need a [GEO] person to confirm your account. Thanks!"):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Error',"There's been some sort of error logging in. This is <i>probably</i> not an issue necessarily with your credentials. Blame Dave!")})},t.checkUser=()=>{t.checkTimer&&clearTimeout(t.checkTimer),t.checkTimer=setTimeout(function(){a.get("/user/nameOkay?name="+t.user).then(e=>{t.nameOkay=e.data})},500)},t.emailBad=!1,t.checkEmail=()=>{t.emailBad=t.email.length&&!t.email.match(/(\w+\.*)+@(\w+\.)+\w+/g)},t.register=()=>{t.pwd&&t.pwdDup&&t.user?t.pwd!=t.pwdDup?(i.debug("derp"),bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Password Mismatch',"Your passwords don't match, or are missing!")):!t.email||t.emailBad?bulmabox.confirm('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Send Without Email?',"You've either not included an email, or the format you're using doesn't seem to match any we know. <br>While you can register without a valid email, it'll be much more difficult to recover your account.<br>Register anyway?",function(e){if(!e||null==e)return!1;a.post("/user/new",{user:t.user,pass:t.pwd,email:t.email}).then(e=>{a.post("/user/login",{user:t.user,pass:t.pwd}).then(()=>{r.go("app.dash")}).catch(e=>{"duplicate"==e.data&&bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;User Already Exists',"That account already exists. Are you sure you didn't mean to log in?"),"unconfirmed"==e.data&&r.go("appSimp.unconfirmed")})}).catch(e=>{"duplicate"==e.data&&bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;User Already Exists',"That account already exists. Are you sure you didn't mean to log in?"),"unconfirmed"==e.data&&r.go("appSimp.unconfirmed")})}):(i.debug("running register with user",t.user,"and pwd",t.pwd),a.post("/user/new",{user:t.user,pass:t.pwd,email:t.email}).then(e=>{a.post("/user/login",{user:t.user,pass:t.pwd}).then(()=>{r.go("app.dash")})}).catch(e=>{"duplicate"==e.data&&bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;User Already Exists',"That account already exists. Are you sure you didn't mean to log in?")})):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Missing Information',"Please enter a username, and a password (twice).")}}]),String.prototype.capMe=function(){return this.slice(0,1).toUpperCase()+this.slice(1)},t.controller("main-cont",["$scope","$http","$state","userFact","$log",function(t,a,r,n,o){o.debug("main controller registered!"),t.user=null,n.getUser().then(a=>{t.user=a.data,e.emit("hiIm",{name:t.user.user})}),t.isActive=!0,t.pokeTimer=null,t.faceOpen=!1;const i="Hidden Tyria Geographic Society [GEO] Guild Site";window.addEventListener("focus",function(e){t.isActive=!0,t.pokeTimer&&clearInterval(t.pokeTimer),document.title=i}),window.addEventListener("blur",function(e){t.isActive=!1});const s=["😐","😮"];e.on("chatMsgOut",e=>{e.msg.includes("@"+t.user.user)&&e.user!=t.user.user&&!t.isActive&&(t.pokeTimer=setInterval(function(){t.faceOpen=!t.faceOpen;let e=t.faceOpen?0:1;document.title=s[e]+" "+i},250))}),e.on("reqHeartBeat",function(a){t.alsoOnline=a.filter(e=>!t.user||!t.user.user||t.user.user!=e.name).map(e=>e.name),t.user&&t.user.user&&r.current.name.includes("app.")&&e.emit("hbResp",{name:t.user.user})}),e.on("disco",e=>{t.col=e?"div:nth-child(even){animation:huehue 4s linear 2s infinite;}div:nth-child(odd){animation:huehue 4s linear 0s infinite;}":"div:nth-child(even){animation:none;}div:nth-child(odd){animation:none}"}),t.explMd=()=>{bulmabox.alert("Markdown",'<div class=\'is-size-2\'>Markdown</div>\n        <hr>\n        <div class=\'is-size-5\'>What It Is</div>\n        <p>Markdown is a specialized way of formatting text, used by sites like Reddit, Stack Overflow, and apps like Discord.</p>\n        <hr>\n        <div class=\'is-size-5\'>What It Does</div>\n        <p>It allows you to format text with stuff like <strong>bold</strong> or <em>italics</em> without the use of fancy, complex word processors.</p>\n        <hr>\n        <div class=\'is-size-4\'>Commands:</div>\n        <table class="table table-striped table-bordered">\n        <thead>\n        <tr>\n        <th style="text-align:left"><strong>Markdown</strong></th>\n        <th style="text-align:left"><strong>Result</strong></th>\n        </tr>\n        </thead>\n        <tbody>\n        <tr>\n        <td style="text-align:left">#text, ##text,…</td>\n        <td style="text-align:left">header (big text). More \'#\'s means smaller headers</td>\n        </tr>\n        <tr>\n        <td style="text-align:left">*text*, _text_</td>\n        <td style="text-align:left"><em>italic text</em></td>\n        </tr>\n        <tr>\n        <td style="text-align:left">**text**,__text,__</td>\n        <td style="text-align:left"><strong>bold text</strong></td>\n        </tr>\n        <tr>\n        <td style="text-align:left">~~text~~</td>\n        <td style="text-align:left"><s>strikethrough text</s> woops!</td>\n        </tr>\n        <tr>\n        <td style="text-align:left">[link text](link url)</td>\n        <td style="text-align:left"><a href="https://www.google.com">links</a></td>\n        </tr>\n        <tr>\n        <td style="text-align:left">- item</td>\n        <td style="text-align:left">- item in a bullet list</td>\n        </tr>\n        <tr>\n        <td style="text-align:left">1. item</td>\n        <td style="text-align:left">1. Item in a numbered list</td>\n        </tr>\n        <tr>\n        <td style="text-align:left">![alt text](url “hover text”)</td>\n        <td style="text-align:left"><img src="https://github.com/adam-p/markdown-here/raw/master/src/common/images/icon48.png" alt="alt text" title="hover text"> (The alt text is displayed if the browser can’t load the image)</td>\n        </tr>\n        <tr>\n        <td style="text-align:left">`text`</td>\n        <td style="text-align:left"><code>look ma, ima programmer!</code></td>\n        </tr>\n        </tbody>\n        </table>')},t.sc="",t.seekrit={code:["arrowup","arrowup","arrowdown","arrowdown","arrowleft","arrowright","arrowleft","arrowright","b","a","Space"],on:!1,asking:!1,hist:[],corrNum:0,whichFont:0},t.fontOpts=["aurebesh","tengwar quenya-1","klingon font","hieroglyphic","dovahkiin","Skyrim_Daedra"],document.querySelector("body").addEventListener("keyup",function(e){if(e.preventDefault(),t.seekrit.asking)return!1;const a=t.seekrit.code[t.seekrit.corrNum];if(e.key.toLowerCase()!=a&&e.code!=a)return!1;t.seekrit.corrNum+1===t.seekrit.code.length?(t.seekrit.asking=!0,bulmabox.confirm("Toggle Secret Mode","Are you sure you wanna toggle the Secret Mode?",function(e){if(e&&null!==e){if(t.seekrit.on=!t.seekrit.on,t.seekrit.on){let e=t.fontOpts[t.seekrit.whichFont];t.seekrit.whichFont++,t.seekrit.whichFont>=t.fontOpts.length&&(t.seekrit.whichFont=0),t.sc=`*:not(.fa){font-family:${e},arial!important;}`}else t.sc="";t.$digest()}else t.sc="",t.$digest();t.seekrit.asking=!1,t.seekrit.corrNum=0})):t.seekrit.corrNum++})}]),t.controller("nav-cont",["$scope","$http","$state","$log",function(e,t,a,r){e.logout=function(){bulmabox.confirm("Logout","Are you sure you wish to logout?",function(n){if(!n||null==n)return!0;t.get("/user/logout").then(function(t){r.debug("b4 logout usr removl, parent scope is",e.$parent.user),e.$parent.user=null,r.debug("and now its",e.$parent.user),a.go("appSimp.login")})})},e.mobActive=!1}]),a.controller("reset-contr",["$scope","$http","$location","$log",function(e,t,a,r){e.key=window.location.search.slice(5),t.get("/user/resetUsr?key="+e.key).then(function(t){r.debug("getting reset user status?",t),e.user=t.data}),e.doReset=function(){e.user&&e.pwd&&e.pwdDup&&e.pwdDup==e.pwd&&e.key?t.post("/user/resetPwd",{acct:e.user.user,pwd:e.pwd,pwdDup:e.pwdDup,key:e.key}).then(function(t){"err"==t.data?bulmabox.alert("Error resetting password","There was an error resetting your password. Please contact a mod"):bulmabox.alert("Password Reset","Your password was successfully reset! We're redirecting you to login now.",function(){e.goLogin()})}):bulmabox.alert("Error: Missing data","Make sure you&rsquo;ve reached this page from a password reset link, and that you have entered the same password in both fields!")},e.goLogin=()=>{window.location.href="../../login"}}]);const i=[{value:-12,text:"(GMT -12:00) Eniwetok, Kwajalein"},{value:-11,text:"(GMT -11:00) Midway Island, Samoa"},{value:-10,text:"(GMT -10:00) Hawaii"},{value:-9,text:"(GMT -9:00) Alaska"},{value:-8,text:"(GMT -8:00) Pacific Time (US & Canada)"},{value:-7,text:"(GMT -7:00) Mountain Time (US & Canada)"},{value:-6,text:"(GMT -6:00) Central Time (US & Canada), Mexico City"},{value:-5,text:"(GMT -5:00) Eastern Time (US & Canada), Bogota, Lima"},{value:-4,text:"(GMT -4:00) Atlantic Time (Canada), Caracas, La Paz"},{value:-3.5,text:"(GMT -3:30) Newfoundland"},{value:-3,text:"(GMT -3:00) Brazil, Buenos Aires, Georgetown"},{value:-2,text:"(GMT -2:00) Mid-Atlantic"},{value:-1,text:"(GMT -1:00) Azores, Cape Verde Islands"},{value:0,text:"(GMT) Western Europe Time, London, Lisbon, Casablanca"},{value:1,text:"(GMT +1:00) Brussels, Copenhagen, Madrid, Paris"},{value:2,text:"(GMT +2:00) Kaliningrad, South Africa"},{value:3,text:"(GMT +3:00) Baghdad, Riyadh, Moscow, St. Petersburg"},{value:3.5,text:"(GMT +3:30) Tehran"},{value:4,text:"(GMT +4:00) Abu Dhabi, Muscat, Baku, Tbilisi"},{value:4.5,text:"(GMT +4:30) Kabul"},{value:5,text:"(GMT +5:00) Ekaterinburg, Islamabad, Karachi, Tashkent"},{value:5.5,text:"(GMT +5:30) Bombay, Calcutta, Madras, New Delhi"},{value:5.75,text:"(GMT +5:45) Kathmandu"},{value:6,text:"(GMT +6:00) Almaty, Dhaka, Colombo"},{value:7,text:"(GMT +7:00) Bangkok, Hanoi, Jakarta"},{value:8,text:"(GMT +8:00) Beijing, Perth, Singapore, Hong Kong"},{value:9,text:"(GMT +9:00) Tokyo, Seoul, Osaka, Sapporo, Yakutsk"},{value:9.5,text:"(GMT +9:30) Adelaide, Darwin"},{value:10,text:"(GMT +10:00) Eastern Australia, Guam, Vladivostok"},{value:11,text:"(GMT +11:00) Magadan, Solomon Islands, New Caledonia"},{value:12,text:"(GMT +12:00) Auckland, Wellington, Fiji, Kamchatka"}],s=[{id:1001,name:"Anvil Rock",population:"High"},{id:1002,name:"Borlis Pass",population:"Medium"},{id:1003,name:"Yak's Bend",population:"High"},{id:1004,name:"Henge of Denravi",population:"Medium"},{id:1005,name:"Maguuma",population:"High"},{id:1006,name:"Sorrow's Furnace",population:"Medium"},{id:1007,name:"Gate of Madness",population:"Medium"},{id:1008,name:"Jade Quarry",population:"Medium"},{id:1009,name:"Fort Aspenwood",population:"Full"},{id:1010,name:"Ehmry Bay",population:"Medium"},{id:1011,name:"Stormbluff Isle",population:"Medium"},{id:1012,name:"Darkhaven",population:"Medium"},{id:1013,name:"Sanctum of Rall",population:"VeryHigh"},{id:1014,name:"Crystal Desert",population:"Medium"},{id:1015,name:"Isle of Janthir",population:"Medium"},{id:1016,name:"Sea of Sorrows",population:"VeryHigh"},{id:1017,name:"Tarnished Coast",population:"High"},{id:1018,name:"Northern Shiverpeaks",population:"High"},{id:1019,name:"Blackgate",population:"Full"},{id:1020,name:"Ferguson's Crossing",population:"Medium"},{id:1021,name:"Dragonbrand",population:"Medium"},{id:1022,name:"Kaineng",population:"High"},{id:1023,name:"Devona's Rest",population:"Medium"},{id:1024,name:"Eredon Terrace",population:"Medium"},{id:2001,name:"Fissure of Woe",population:"Medium"},{id:2002,name:"Desolation",population:"VeryHigh"},{id:2003,name:"Gandara",population:"High"},{id:2004,name:"Blacktide",population:"Medium"},{id:2005,name:"Ring of Fire",population:"Medium"},{id:2006,name:"Underworld",population:"Medium"},{id:2007,name:"Far Shiverpeaks",population:"Medium"},{id:2008,name:"Whiteside Ridge",population:"High"},{id:2009,name:"Ruins of Surmia",population:"Medium"},{id:2010,name:"Seafarer's Rest",population:"VeryHigh"},{id:2011,name:"Vabbi",population:"High"},{id:2012,name:"Piken Square",population:"VeryHigh"},{id:2013,name:"Aurora Glade",population:"High"},{id:2014,name:"Gunnar's Hold",population:"Medium"},{id:2101,name:"Jade Sea",population:"High"},{id:2102,name:"Fort Ranik",population:"Medium"},{id:2103,name:"Augury Rock",population:"High"},{id:2104,name:"Vizunah Square",population:"Medium"},{id:2105,name:"Arborstone",population:"Medium"},{id:2201,name:"Kodash",population:"High"},{id:2202,name:"Riverside",population:"Full"},{id:2203,name:"Elona Reach",population:"VeryHigh"},{id:2204,name:"Abaddon's Mouth",population:"Medium"},{id:2205,name:"Drakkar Lake",population:"High"},{id:2206,name:"Miller's Sound",population:"Medium"},{id:2207,name:"Dzagonur",population:"Medium"},{id:2301,name:"Baruch Bay",population:"VeryHigh"}];Object.freeze(s),t.controller("tool-cont",["$scope","$http","$state","$filter","$sce","$window","$log",function(e,t,a,r,n,o,i){e.showTab=t=>{e.currTab=t,"WvW Current Match History"==e.currTab&&e.refWvw()},e.currTab="Dailies",e.tabs=[{name:"Dailies",icon:"calendar-check-o"},{name:"WvW Current Match History",icon:"fort-awesome"},{name:"Core/Lodestone Upgrade",icon:"diamond"},{name:"Tier Six Material Conversion",icon:"money"}],e.dailyRestrict={},e.tmrw=!1,e.regetDaily=()=>{const a=Object.keys(e.dailyRestrict).filter(t=>e.dailyRestrict[t]);t.get("/tool/daily"+(e.tmrw?"/tomorrow":"")+(a.length?"?modes="+a.join(","):"")).then(t=>{i.debug("dailyObj",t.data),e.dailies=t.data})},o.addEventListener("keyup",t=>{39!=t.which||t.shiftKey?39==t.which&&t.shiftKey?(e.lastSkirm(),e.$digest()):37!=t.which||t.shiftKey?37==t.which&&t.shiftKey&&(e.firstSkirm(),e.$digest()):(e.prevSkirm(),e.$digest()):(e.nextSkirm(),e.$digest())}),e.regetDaily(),e.refPrices=()=>{t.get("/tool/allPrices").then(t=>{e.prices=e.calcPrices(t.data.p)})},e.wvwWorld=!1,e.wvwColors=["red","green","blue"],e.wvwPie={cutoutPercentage:0,backgroundColor:["#aa0000","#00aa00","#0000aa"],config:{plugins:{vert:!1}}},e.wvwDisabled=!1,e.makeMarkers=()=>{e.mapMarkers=["camp-blue.png","camp-green.png","camp-netural.png","camp-red.png","castle-blue.png","castle-green.png","castle-neutral.png","castle-red.png","keep-blue.png","keep-green.png","keep-netural.png","keep-red.png","ruins-blue.png","ruins-green.png","ruins-neutral.png","ruins-red.png","tower-blue.png","tower-green.png","tower-neutral.png","tower-red.png"].map(e=>L.icon({iconUrl:"./img/wvw/"+e,iconName:e.replace(".png",""),iconSize:[32,32],iconAnchor:[15,15],popupAnchor:[-3,-76]})),i.debug("Map Markers",e.mapMarkers)},e.refWvw=()=>{t.get("/tool/wvw"+(e.wvwWorld?"?world="+e.wvwWorld:"")).then(t=>{if(i.debug("WVW STUFF",t,t.data),"newMatch"==t.data)return e.wvwDisabled=!0,e.wvw=null,!1;e.wvwDisabled=!1,e.wvw=t.data.wvw,e.currentMatch=e.wvw.skirmishes.length-1,e.wvw.labels=e.wvwColors.map(e=>t.data.wvw.all_worlds[e].map(e=>s.find(t=>t.id==e).name).join(", ")),e.wvw.skirmishes.forEach(t=>{t.scoreArr=e.wvwColors.map(e=>t.scores[e])}),e.wvw.history=e.wvwColors.map(t=>e.wvw.skirmishes.map(e=>e.scores[t])),e.wvw.histLabels=new Array(e.wvw.history[0].length).fill(100).map((e,t)=>t+1),e.wvw.histColors=[{backgroundColor:"transparent",borderColor:"#f00",pointBackgroundColor:"#f00"},{backgroundColor:"transparent",borderColor:"#0f0",pointBackgroundColor:"#0f0"},{backgroundColor:"transparent",borderColor:"#00f",pointBackgroundColor:"#00f"}],i.debug("WVW",e.wvw),e.mapMarkers=[],e.wvwOwned=t.data.owned||null,e.makeMarkers();let a=document.querySelector("#wvw-map");i.debug("mapDiv",a,a.offsetWidth),e.doMap(e.wvw.maps)})},e.nextSkirm=()=>{if(!e.wvw)return!1;e.wvw.skirmishes.length>e.currentMatch+1?e.currentMatch++:e.currentMatch=0,e.positionVert()},e.prevSkirm=()=>{if(!e.wvw)return!1;e.currentMatch&&e.currentMatch>0?e.currentMatch--:e.currentMatch=e.wvw.skirmishes.length-1,e.positionVert()},e.lastSkirm=()=>{e.currentMatch=e.wvw.skirmishes.length-1,e.positionVert()},e.firstSkirm=()=>{e.currentMatch=0,e.positionVert()},e.mats=["blood","bone","claw","fang","scale","totem","venom"],e.cores=["glacial","onyx","destroyer","molten","corrupted","essence","crystal","charged"],e.calcPrices=t=>{i.debug("DATA before prices",t),t.push({hi:2504,lo:2504,lName:"Bottle of Elonian Wine",id:19663,sName:"wine"});let a=t.find(e=>"t6dust"==e.sName);return e.mats.forEach(e=>{let r=t.find(t=>t.sName=="t5"+e),n=t.find(t=>t.sName=="t6"+e);n.hiProf=12*n.hi-(50*r.lo+1*n.lo+5*a.lo),n.loProf=5*n.lo-(50*r.hi+1*n.hi+5*a.hi),n.t5=r,n.profGood=0,n.hiProf>0&&n.loProf>0?n.profGood=1:n.hiProf<0&&n.loProf<0&&(n.profGood=-1)}),e.cores.forEach(e=>{let r=t.find(t=>t.sName=="c"+e),n=t.find(t=>t.sName=="l"+e);n.c=r,n.hiProf=n.hi-(2*r.lo+a.lo+2504),n.loProf=n.lo-(2*r.hi+a.hi+2504),n.profGood=0,n.hiProf>0&&n.loProf>0?n.profGood=1:n.hiProf<0&&n.loProf<0&&(n.profGood=-1)}),i.debug("PRICES!",t),t},e.isMat=e=>e.sName.indexOf("t6")>-1&&"t6dust"!=e.sName,e.isGem=e=>e.sName.indexOf("t6")<0&&"wine"!=e.sName&&e.sName.indexOf("t5")<0&&"l"==e.sName[0],e.histClick=t=>{if(i.debug("CLICKED:",t,Chart),!t||!t[0])return!1;e.currentMatch=t[0]._index,e.positionVert()},e.positionVert=()=>{e.lineOpts.title.text=`(${e.currentMatch+1})`},Chart.plugins.register({id:"vert",afterDraw:function(t,a){if("doughnut"!=t.config.type){e.lineXWid=t.chartArea.right-t.chartArea.left,e.lineYWid=t.chartArea.left,e.lineHeight=t.chartArea.bottom-t.chartArea.top,e.lineStepWid=e.lineXWid/(e.wvw.skirmishes.length-1);const a=t.canvas.getContext("2d");a.moveTo(e.lineYWid+e.currentMatch*e.lineStepWid,5),a.lineTo(e.lineYWid+e.currentMatch*e.lineStepWid,e.lineHeight+5),a.strokeStyle="#fff",a.stroke()}}}),e.lineOpts={title:{text:`(${e.currentMatch+1})`},scales:{yAxes:[{ticks:{beginAtZero:!0,fontColor:"#fff"}}],xAxes:[{ticks:{fontColor:"#fff"}}]},hover:{animationDuration:0}},e.refPrices(),e.getMapState=()=>{i.debug("ZOOM",e.map.getZoom(),"BOUNDS",e.map.getBounds())},e.unproject=function(e,t){return e.unproject(t,e.getMaxZoom())},e.doMap=function(t){let a,r;e.map=L.map("wvw-map",{minZoom:0,maxZoom:6}),r=e.unproject(e.map,[15700,8900]),a=e.unproject(e.map,[5100,15900]);const n=new L.LatLngBounds(e.unproject(e.map,[16384,0]),e.unproject(e.map,[0,16384]));L.tileLayer("https://tiles.guildwars2.com/2/3/{z}/{x}/{y}.jpg",{subdomains:["tiles1","tiles2","tiles3","tiles4"],bounds:n,minNativeZoom:4,noWrap:!0}).addTo(e.map),e.map.setMaxBounds(new L.LatLngBounds(a,r)),e.map.setView(new L.LatLng((r.lat-a.lat)/2,(r.lng-a.lng)/2),0),t.forEach(t=>{t.objectives.filter(e=>!!e.marker).forEach(t=>{let a=e.mapMarkers.find(e=>e.options.iconName==t.type.toLowerCase()+"-"+t.owner.toLowerCase());i.debug("THIS OBJECTIVE",t,"MARKER (probly)",a,"FROM",t.type.toLowerCase()+"-"+t.owner.toLowerCase()),L.marker(e.unproject(e.map,t.coord),{title:`${t.name} (owned by: ${t.owner})`,icon:a}).addTo(e.map)})}),setTimeout(function(){e.map.invalidateSize(),e.map.setZoom(3)},500)}}]),t.controller("unconf-cont",["$scope","$http","$state","$log",function(e,t,a,r){e.logout=function(){t.get("/user/logout").then(function(e){r.debug(e),a.go("appSimp.login")})}}])}();