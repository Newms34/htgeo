...
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e};!function(){var s=io(),e=angular.module("htgeo-app",["ui.router","ngAnimate","ngSanitize","chart.js"]),t=angular.module("reset-app",[]),l="data:image/png;base64,";Array.prototype.findUser=function(e){for(var t=0;t<this.length;t++)if(this[t].user==e)return t;return-1};e.config(["$stateProvider","$urlRouterProvider","$locationProvider","$httpProvider",function(e,t,n,a){n.html5Mode(!0),t.otherwise("/404"),e.state("app",{abstract:!0,templateUrl:"layouts/full.html"}).state("app.blog",{url:"/blog",templateUrl:"components/blog.html"}).state("app.dash",{url:"/",templateUrl:"components/dash.html"}).state("app.chat",{url:"/chat",templateUrl:"components/chat.html"}).state("app.calendar",{url:"/calendar",templateUrl:"components/calendar.html"}).state("app.help",{url:"/help",templateUrl:"components/help/help.html"}).state("app.forum",{url:"/forum",templateUrl:"components/forums/forum.html"}).state("app.forumCat",{url:"/forumCat?c",templateUrl:"components/forums/forumCat.html"}).state("app.forumThr",{url:"/forumThr?c&t",templateUrl:"components/forums/forumThr.html"}).state("app.tools",{url:"/tools",templateUrl:"components/tools.html"}).state("appSimp",{abstract:!0,templateUrl:"components/layout/simp.html"}).state("appSimp.login",{url:"/login",templateUrl:"components/login.html"}).state("appSimp.register",{url:"/register",templateUrl:"components/register.html"}).state("appSimp.unconfirmed",{url:"/unconf",templateUrl:"components/alt/unconfirmed.html"}).state("appSimp.notfound",{url:"/404",templateUrl:"components/alt/404.html"}).state("appSimp.err",{url:"/500",templateUrl:"components/alt/500.html"})}]).directive("fileread",[function(){return{scope:{fileread:"="},link:function(o,e,t){e.bind("change",function(e){var t=new FileReader,n=e.target.files[0],a=n.name;return console.log("UPLOADING FILE",n),t.onload=function(e){var t=e.target.result;console.log("URI before optional resize",t,t.length),o.$parent.needsResize?r(o,t,o.$parent.needsResize,o.$parent.needsResize,a):(console.log("APPLYING file to $parent"),o.$apply(function(){o.$parent&&o.$parent.$parent&&o.$parent.$parent.avas?(o.$parent.$parent.loadingFile=!1,o.$parent.$parent.fileName="Loaded:"+a,o.$parent.$parent.fileread=t):(o.$parent.loadingFile=!1,o.$parent.fileName="Loaded:"+a,o.$parent.fileread=t),o.$parent.saveDataURI&&"function"==typeof o.$parent.saveDataURI&&o.$parent.saveDataURI(dataURI)}))},n?25e5<n.size?(bulmabox.alert("File too Large","Your file "+n.name+" is larger than 2.5MB. Please upload a smaller file!"),!1):void t.readAsDataURL(n):(o.$apply(function(){o.fileread="",o.$parent.fileName=!1,o.$parent.loadingFile=!1}),!1)})}}}]),Array.prototype.rotate=function(e){for(var t=angular.copy(this),n=0;n<e;n++)t.push(t.shift());return t},Date.prototype.dyMo=function(){return this.getMonth()+1+"/"+this.getDate()},String.prototype.titleCase=function(){return this.split(/\s/).map(function(e){return e.slice(0,1).toUpperCase()+e.slice(1).toLowerCase()}).join(" ")};var r=function(a,e,o,r,i){var t=document.createElement("img");t.onload=function(){var e=document.createElement("canvas"),t=e.getContext("2d");e.width=o,e.height=r,t.drawImage(this,0,0,o,r);var n=e.toDataURL();a.$apply(function(){a.$parent.loadingFile=!1,a.$parent.fileName="Loaded:"+i,a.fileread=n,a.$parent.saveDataURI&&"function"==typeof a.$parent.saveDataURI&&a.$parent.saveDataURI(n)})},t.src=e};e.controller("blog-cont",["$scope","$http","$state","$filter","$sce",function(n,a,e,t,o){a.get("/user/getUsr").then(function(e){n.doUser(e.data),console.log("user",n.user)}),n.msgs=[],n.doUser=function(e){if(!e)return!1;n.user=e,n.msgs.push({time:Date.now(),user:"System",msg:"Welcome to Hidden Tyria Geographic Society [GEO] Chat! You're logged in as "+e.user+". Try /wiki or /google to search for stuff!",isSys:!0})},n.newBlog={title:null,contents:null,youtube:null,pic:null,picCand:null,youtubeCand:null},n.blogEntries=[{author:"Healy",pic:"https://static.wixstatic.com/media/4c8c05_d15c19168bda4a3c9a3bef232a00310f~mv2.jpg/v1/fit/w_1175,h_661,al_c,q_80/file.png",height:400,title:"A Test Post",contents:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc et mi ut mauris rutrum malesuada. Ut tincidunt in ex ac ultrices. Integer nec aliquam massa. Fusce aliquam fermentum augue. Suspendisse sollicitudin lectus libero. Praesent varius nisl eu neque cursus lobortis. Nullam convallis turpis sit amet tortor cursus fermentum. In facilisis pharetra urna, sed feugiat est lobortis a. Vestibulum vehicula malesuada purus, id convallis massa suscipit nec. Nunc a ante nunc. Nullam faucibus porttitor erat, vitae convallis augue tincidunt a.\n\n        Nunc egestas hendrerit orci, ut rutrum ex porta ac. Pellentesque porttitor erat neque, eu pulvinar ex sodales quis. Morbi gravida suscipit nulla nec laoreet. Vivamus eleifend magna leo. Morbi tincidunt iaculis euismod. Aliquam malesuada nunc lacinia, convallis augue quis, consectetur elit. Maecenas mattis purus sollicitudin semper feugiat. Ut at gravida augue, sit amet venenatis arcu. Maecenas et justo ut elit ultrices maximus et ac enim. Sed nec rutrum nibh. Etiam malesuada lacus nisl, eget pretium odio consectetur ut.",youtube:"https://www.youtube.com/watch?v=cGZ4X7cER8k",likeNum:0,usrLiked:!1,when:"A long time ago",id:null}],n.refBlogs=function(){a.get("/blog/allEntries").then(function(e){if(!e.data)throw new Error("no blogs");n.blogEntries=n.parseBlogs(e.data)}).catch(function(e){n.blogEntries=[{author:"System",pic:"https://static.wixstatic.com/media/4c8c05_d15c19168bda4a3c9a3bef232a00310f~mv2.jpg/v1/fit/w_1175,h_661,al_c,q_80/file.png",height:400,title:"Couldn't Load Blog",contents:"Your site is probably broken, or your internet connection sucks. We couldn't load any blog info!",youtube:null,likeNum:0,usrLiked:!1,when:"A long time ago",_id:null}]})},n.refBlogs(),n.parseBlogs=function(e){return e.map(function(e){return e.height=e.height||400,e.likeNum=e.likes.length,e.usrLiked=!!e.likes.includes(n.user._id),e.when=new Date(e.date).toLocaleString(),e})},n.toggleLike=function(e){a.get("/blog/toggleLike?v="+e).then(function(t){var e=n.blogEntries.find(function(e){return e._id==t.data._id});e.likes=t.data.likes,e.usrLiked=t.data.likes.includes(n.user._id),e.likeNum=t.data.likes.length})},n.timers={pic:null,vid:null},n.picTimer=function(){n.timers.pic&&clearTimeout(n.timers.pic),n.timers.pic=setTimeout(function(){n.newBlog.picCand&&n.newBlog.picCand.length?n.newBlog.pic=n.newBlog.picCand:n.newBlog.pic=null},500)},n.vidTimer=function(){n.timers.vid&&clearTimeout(n.timers.vid),n.timers.vid=setTimeout(function(){n.newBlog.youtubeCand&&n.newBlog.youtubeCand.length?n.newBlog.youtube=n.newBlog.youtubeCand:n.newBlog.youtube=null},500)},n.newPost=function(e){if(!n.newBlog.title||!n.newBlog.contents)return bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Missing Information',"Your blog post needs a title and at least some text content!");var t=angular.copy(n.newBlog);delete t.picCand,delete t.youtubeCand,a.post("/blog/newPost",t).then(function(e){n.newBlog={title:null,contents:null,youtube:null,pic:null,picCand:null,youtubeCand:null,active:!1},n.refBlogs()})}}]),e.filter("trusted",["$sce",function(n){return function(e){var t=e.split("v=")[1].split("&")[0];return n.trustAsResourceUrl("https://www.youtube.com/embed/"+t)}}]),Date.prototype.stdTimezoneOffset=function(){var e=new Date(this.getFullYear(),0,1),t=new Date(this.getFullYear(),6,1);return Math.max(e.getTimezoneOffset(),t.getTimezoneOffset())},Date.prototype.isDstObserved=function(){return this.getTimezoneOffset()<this.stdTimezoneOffset()},e.controller("cal-cont",["$scope","$http","$state",function(i,r,e){i.cal=[],i.days=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],i.calLoaded=!1,i.wkOpts=[{lbl:"Every week",n:1},{lbl:"Every two weeks",n:2},{lbl:"Every three weeks",n:3},{lbl:"Every four weeks",n:4},{lbl:"Every five weeks",n:5}],r.get("/user/usrData").then(function(e){i.user=e.data}),i.refCal=function(){r.get("/cal/all").then(function(e){console.log("calendar events response:",e),i.makeCalendar(e.data)})},s.on("refCal",function(e){i.refCal()}),i.refCal(),i.makeCalendar=function(e){i.offsetDays=i.days.rotate((new Date).getDay());var t=0,a=0,o=new Date;for(o.setHours(0,0,0,0),o=o.getTime(),i.cal=[];t<6;t++){var r={wk:t,wkSt:new Date(o+7*t*1e3*3600*24),wkEn:new Date(o+1e3*(7*(t+1)-1)*3600*24),days:[]},n=function(){var n=new Date(o+1e3*(7*t+a)*3600*24);r.days.push({d:a,evts:e.filter(function(e){var t=new Date(e.eventDate).getTime();return console.log("THIS DATE DTNUM",t,n.getTime()),t>n.getTime()&&t<n.getTime()+864e5}),date:n})};for(a=0;a<7;a++)n();i.cal.push(r)}console.log("CAL STUFF",i.cal,i.offsetDays)},i.viewEvent=function(t){console.log("View event",t);var e=null;t.paid&&t.paid.length&&(e="<ul class='ul'>\n                "+t.paid.map(function(e){return"<li> - "+e+"</li>"}).join("")+"\n            </ul>"),bulmabox.alert("Event: "+t.title,"Time:"+new Date(t.eventDate).toLocaleString()+"<br>Type:"+i.kindOpts.find(function(e){return e.kind==t.kind}).kindLong+"<br>"+(e?"Paid Users<br>"+e:"")+"<hr> Description: "+t.text)},i.editEventObj={title:"",desc:"",day:0,time:2*((new Date).getHours()+((new Date).getMinutes()<30?.5:0)),kind:"lotto",id:null},i.clearEdit=function(){i.editEventAct=!1},i.editEventAct=!1,i.editEvent=function(t){i.editEventAct=!0,console.log("Edit event",t,"hour options",i.hourOpts);var e=new Date(t.eventDate).setHours(0,0,0,0),n=Date.now();i.editEventObj={title:t.title,desc:t.text,kind:i.kindOpts.find(function(e){return e.kind==t.kind}),time:Math.floor((t.eventDate-e)/18e5),day:Math.round((t.eventDate-n)/864e5),id:t._id,user:t.user}},i.doEdit=function(){console.log("Input edit event",i.editEventObj);var e=new Date,t=i.editEventObj.day,n=i.editEventObj.time;(new Date).isDstObserved()||47<(n+=2)&&(n%=47,t++),e.setHours(0,0,0,0);var a=e.getTime()+1800*n*1e3+3600*t*1e3*24;if(console.log("Sending event",i.editEventObj,a),a<Date.now()+3e5)return bulmabox.alert("Time Expiring","Your selected time, "+new Date(a).toLocaleString()+", occurs too soon! Please select a later time."),!1;r.post("/cal/edit",{title:i.editEventObj.title,text:i.editEventObj.desc,eventDate:a,kind:i.editEventObj.kind.kind,id:i.editEventObj.id,user:i.editEventObj.user}).then(function(e){console.log("edit event response",e),"wrongUser"==e.data&&bulmabox.alert('<i class="fa fa-exclamation-triangle"></i> Wrong User',"You cannot edit this event, as you are not its creator and are not a moderator."),i.refCal(),i.clearEdit()})},i.delEvent=function(t){console.log("Delete event",t),bulmabox.confirm("Delete Event","Are you sure you wish to delete the following event?<br> Title: "+t.title+"<br>Description: "+t.text,function(e){if(!e||null==e)return!1;r.get("/cal/del?id="+t._id).then(function(e){console.log("delete response",e),i.refCal()})})},i.addEvent=!1,i.newEventObj={title:"",desc:"",day:0,time:2*((new Date).getHours()+((new Date).getMinutes()<30?.5:0)),kind:"lotto",repeatNum:1,repeatOn:!1,repeatFreq:1},r.get("/user/allUsrs").then(function(e){i.allUsrs=e.data.map(function(e){return e.user})}),i.addPaid=function(t){var e=i.allUsrs.filter(function(e){return!t.paid||!t.paid.length||t.paid.indexOf(e)<0}).map(function(e){return"<option value='"+e+"'>"+e+"</option>"}).join("");bulmabox.custom("Add Paid User","Select a user from the list below to add them to this lotto's candidates:<br><p class='select'><select id='payusr'>"+e+"</select></p>",function(){var e=document.querySelector("#payusr").value;console.log("User wishes to add",e),r.post("/cal/lottoPay",{lottoId:t._id,pusr:e})})},i.hourOpts=new Array(48).fill(100).map(function(e,t){var n=t<24?"AM":"PM",a=Math.floor(t/2)<13?Math.floor(t/2):Math.floor(t/2)-12;return a<1&&(a=12),{num:t,hr:a+(t%2?":30":":00")+n}}),i.dayOpts=new Array(42).fill(100).map(function(e,t){var n=new Date(Date.now()+3600*t*1e3*24);return{num:t,day:n.getMonth()+1+"/"+n.getDate()}}),i.kindOpts=[{kind:"lotto",desc:"An item or items will be given away by a [PAIN] member to one lucky guild member!",kindLong:"Lottery/Giveaway"},{kind:"payLotto",desc:"Try your luck! One lucky winner will win the pool of donations!",kindLong:"Paid Lottery/Giveaway"},{kind:"announce",desc:"Someone needs to make an important announcement!",kindLong:"Announcement"},{kind:"contest",desc:"Some sort of contest! See who's the best!",kindLong:"Contest"},{kind:"other",desc:"Any other event type",kindLong:"Other"}],i.doAdd=function(){var e=new Date,t=i.newEventObj.time,n=i.newEventObj.day;e.setHours(0,0,0,0),(new Date).isDstObserved()||47<(t+=2)&&(t%=47,n++);var a=e.getTime()+1800*t*1e3+3600*n*1e3*24,o=i.newEventObj.repeatOn?"/cal/newRep":"/cal/new";if(a<Date.now()+3e5)return bulmabox.alert("Time Expiring","Your selected time, "+new Date(a).toLocaleString()+", occurs too soon! Please select a later time."),!1;console.log("Sending event",i.newEventObj,a),r.post(o,{title:i.newEventObj.title,text:i.newEventObj.desc,eventDate:a,kind:i.newEventObj.kind.kind,repeatNum:i.newEventObj.repeatNum,repeatFreq:i.newEventObj.repeatFreq,repeatOn:i.newEventObj.repeatOn}).then(function(e){console.log("new event response",e),i.refCal(),i.clearAdd()})},i.clearAdd=function(){i.addEvent=!1,i.newEventObj={title:"",desc:"",day:0,time:2*((new Date).getHours()+((new Date).getMinutes()<30?.5:0)),kind:"lotto",repeatNum:1,repeatFreq:1,repeatOn:!1}}}]),e.controller("chat-cont",["$scope","$http","$state","$filter","$sce",function(t,e,n,a,o){e.get("/user/getUsr").then(function(e){t.doUser(e.data),console.log("user",t.user)}),t.msgs=[],t.doUser=function(e){if(!e)return!1;t.user=e,t.msgs.push({time:Date.now(),user:"System",msg:"Welcome to Hidden Tyria Geographic Society [GEO] Chat! You're logged in as "+e.user+". Try /wiki or /google to search for stuff!",isSys:!0})},t.parseMsg=function(e){return 0===e.indexOf("/wiki ")?'Wiki: <a href="https://wiki.guildwars2.com/wiki/'+e.slice(6)+'" target="_blank">'+e.slice(6)+"</a>":0===e.indexOf("/google ")?'Google: <a href="https://www.google.com/search?q='+e.slice(8)+'" target="_blank">'+e.slice(8)+"</a>":e},e.get("/user/allUsrs").then(function(e){console.log("all users is",e),t.allUsers=e.data}),s.on("msgOut",function(e){console.log(t.parseMsg(e.msg),"IS THE MESSAGE"),e.msg=o.trustAsHtml(t.parseMsg(e.msg)),t.msgs.push(e),100<t.msgs.length&&t.msgs.shift(),t.$apply(),document.querySelector("#chat-container").scrollTop=document.querySelector("#chat-container").scrollHeight}),s.on("disconnect",function(){t.msgs.push({time:Date.now(),user:"System",msg:"Warning: The connection to the server was lost. Until you refresh, chat's probably gonna be pretty quiet!",isSys:!0}),100<t.msgs.length&&t.msgs.shift(),t.$apply(),document.querySelector("#chat-container").scrollTop=document.querySelector("#chat-container").scrollHeight}),t.sendChat=function(){if(!t.newMsg)return!1;s.emit("chatMsg",{user:t.user.user,msg:t.newMsg}),t.newMsg=""}}]),e.controller("dash-cont",["$scope","$http","$state","$filter",function(r,i,e,t){r.showDups=localStorage.brethDups,i.get("/user/usrData").then(function(e){r.doUser(e.data),console.log("user",r.user)}),i.get("/cal/latestFive").then(function(e){r.latestEvents=e.data}),r.doUser=function(n){if(!n)return!1;r.user=n,console.log(n),r.possibleInterests.forEach(function(e,t){n.ints&&n.ints[t]&&1==n.ints[t]&&(e.active=!0)}),r.numUnreadMsgs=n.msgs.filter(function(e){return!e.read}).length},s.on("sentMsg",function(e){console.log("SOCKET USER",e,"this user",r.user),e.user!=r.user.user&&e.from!=r.user.user||(console.log("re-getting user"),i.get("/user/usrData").then(function(e){r.doUser(e.data)}))}),r.tabs=[{name:"Profile/Characters",icon:"user"},{name:"Members",icon:"users"},{name:"Mail",icon:"envelope"},{name:"Upcoming Events",icon:"calendar"}],r.defaultPic=l,r.loadingFile=!1,r.fileName=null,r.needsResize=65,r.loadFile=function(){r.loadingFile=!0;new FileReader},r.saveDataURI=function(e){i.post("/user/changeAva",{img:e}).then(function(e){r.doUser(e.data)})},r.possibleInterests=[{name:"General PvE",warn:!1,active:!1,icon:"pve.png"},{name:"sPvP",warn:!1,active:!1,icon:"pvp.png"},{name:"WvW",warn:!1,active:!1,icon:"wvw.png"},{name:"Fractals",warn:!1,active:!1,icon:"fracs.png"},{name:"Raids",warn:!0,active:!1,icon:"raids.png"},{name:"Role-Playing",warn:!0,active:!1,icon:"rp.png"}],r.tzs=angular.copy(n),r.changeInterest=function(e,t){console.log(e),e.warn&&e.active&&bulmabox.alert("Game Mode Warning","Hey! Just so you know, [GEO] generally doesn't do "+e.name+".<br>However, that doesn't mean we don't have people that might be interested!"),i.get("/user/changeInterest?int="+t+"&act="+e.active).then(function(e){r.doUser(e.data)})},r.changeTz=function(){i.get("/user/changeTz?tz="+r.user.tz).then(function(e){r.doUser(e.data)})},r.otherInfTimer=null,r.setOtherInfTimer=function(){r.otherInfTimer&&clearTimeout(r.otherInfTimer),r.otherInfTimer=setTimeout(function(){i.post("/user/changeOther",{other:r.user.otherInfo}).then(function(e){r.doUser(e.data)})},500)},r.memNameSort=!1,r.charSearch="",r.pickedInts=[!1,!1,!1,!1,!1,!1],r.intSearchToggle=!1,r.charSearchToggle=!1,r.memFilter=function(n){var e=!!n.chars.filter(function(e){return-1<e.name.toLowerCase().indexOf(r.charSearch.toLowerCase())}).length;if(r.charSearch&&!e)return!1;if(r.pickedInts.filter(function(e){return!!e}).length){var a=!0;return r.pickedInts.forEach(function(e,t){e&&!n.ints[t]&&(a=!1)}),a}return!0},i.get("/user/allUsrs").then(function(e){console.log("all users is",e),r.allUsers=e.data,setTimeout(function(){s.emit("getOnline",{})},100)}),s.on("allNames",function(t){t=t.map(function(e){return e.name}),r.allUser&&r.allUsers.forEach(function(e){e.online=-1<t.indexOf(e.user)||e.user==r.user.user}),r.$digest()}),r.showTab=function(e){r.currTab=e},r.currTab="Profile/Characters",r.makeMod=function(t){console.log("wanna mod",t),bulmabox.confirm("Assign Moderator Rights","Warning: This will give user "+t.user+" full moderator rights, and prevents them from being banned. This process is <i>not</i> reversable!",function(e){if(!e||null==e)return!1;i.get("/user/makeMod?user="+t.user).then(function(e){r.allUsers=e.data})})},r.toggleBan=function(e){i.get("/user/toggleBan?user="+e.user).then(function(e){r.allUsers=e.data})},r.confirmUsr=function(t){bulmabox.confirm("Confirm User","Are you sure you wish to confirm user "+t.user+"?",function(e){e&&null!=e&&i.get("/user/confirm?u="+t.user).then(function(e){r.allUsers=e.data})})},r.races=["Asura","Charr","Human","Norn","Sylvari"],r.profs=["Guardian","Warrior","Revenant","Thief","Ranger","Engineer","Elementalist","Mesmer","Necromancer"],r.addChar=function(){var e=r.races.map(function(e){return"<label class='char-opt opt-"+e+"'><input type='radio' name='char-race' value="+e+" title="+e+"><div></div></label>"}).join(""),t=r.profs.map(function(e){return"<label class='char-opt opt-"+e+"'><input type='radio' name='char-prof' value="+e+" title="+e+"><div></div></label>"}).join("");bulmabox.custom("Add a character",'<div class="field">\n    <label class="label">\n        Name\n    </label>\n    <p class="control has-icons-left">\n        <input class="input" type="text" placeholder="Your character\'s name" id=\'char-name\'>\n        <span class="icon is-small is-left">\n            <i class="fa fa-user"></i>\n        </span>\n    </p>\n</div>\n<div class="field">\n    <label class=\'label\'>\n        Race\n    </label>\n    '+e+"\n</div>\n<div class=\"field\">\n    <label class='label'>\n        Profession\n    </label>\n    "+t+"\n</div>\n<div class=\"field\">\n    <label class='label'>\n        Level\n    </label>\n    <p class=\"control\">\n        <input class='input' type='number' id='char-lvl' min='1' max='80' value='80'>\n    </p>\n</div>\n<div class=\"field\">\n    <label class='label'>\n        Other Info\n    </label>\n    <p class=\"control\">\n        <textarea class='textarea' id='char-other' placeholder='Any other information you wanna include (optional)'></textarea>\n    </p>\n</div>",function(){var e=document.querySelector("input[name=char-prof]:checked"),t=document.querySelector("input[name=char-race]:checked"),n=document.querySelector("#char-name");if(!e||!t||!n)return bulmabox.alert("Needs More Info","You need to specify a profession, race, and name! Otherwise we won't know who/what you are!"),!1;var a={name:document.querySelector("#char-name").value,prof:document.querySelector("input[name=char-prof]:checked").value,race:document.querySelector("input[name=char-race]:checked").value,lvl:document.querySelector("#char-lvl").value,other:document.querySelector("#char-other").value};console.log("User wants to add char",a),i.post("/user/addChar",a).then(function(e){r.doUser(e.data)})},"<button class='button is-info' onclick='bulmabox.runCb(bulmabox.params.cb)'>Save</button><button class='button is-danger' onclick='bulmabox.kill(\"bulmabox-diag\")'>Cancel</button>")},r.autoChars=function(){bulmabox.prompt("Auto-Fill Characters from API","Auto-filling characters from the Guild Wars 2 Official API will replace any existing characters you've entered with API-found characters. <br><br> - You'll need an API key to do this (click <a href='https://account.arena.net/' target='_blank'>here</a> if you dont have one). <br><br>Are you sure you wish to do this?",function(e){e&&null!=e&&i.get("/user/charsFromAPI?api="+e).then(function(e){console.log("Auto-char response is",e),e&&e.data&&"err"!=e.data?r.doUser(e.data):bulmabox.alert("Error Auto-Filling","There was an error auto-filling your characters.<br>While it <i>may</i> be Dave's fault, you may also wanna check that your API key is valid. You can also always just manually add your characters!")})})},r.delChr=function(t){console.log("user wishes to remove character",t),bulmabox.confirm("Remove Character","Are you sure you wish to remove the character "+t.name+"?",function(e){e&&null!=e&&i.get("/user/remChar?id="+t._id).then(function(e){r.doUser(e.data)}).catch(function(e){bulmabox.alert("Error","There was a problem removing this character!")})})},r.editChar=function(t){console.log("usr wants to",t,Date.now());var e=r.races.map(function(e){return"<label class='char-opt opt-"+e+"'><input type='radio' name='char-race' value="+e+" title="+e+" "+(e==t.race?"checked":"")+"><div></div></label>"}).join(""),n=r.profs.map(function(e){return"<label class='char-opt opt-"+e+"'><input type='radio' name='char-prof' value="+e+" title="+e+" "+(e==t.prof?"checked":"")+"><div></div></label>"}).join("");bulmabox.custom("Edit character",'<div class="field">\n    <label class="label">\n        Name\n    </label>\n    <p class="control has-icons-left">\n        <input class="input" type="text" placeholder="Your character\'s name" id=\'char-name\' value=\''+t.name+'\'>\n        <span class="icon is-small is-left">\n            <i class="fa fa-user"></i>\n        </span>\n    </p>\n</div>\n<div class="field">\n    <label class=\'label\'>\n        Race\n    </label>\n    '+e+"\n</div>\n<div class=\"field\">\n    <label class='label'>\n        Profession\n    </label>\n    "+n+"\n</div>\n<div class=\"field\">\n    <label class='label'>\n        Level\n    </label>\n    <p class=\"control has-icons-left\">\n        <input class='input' type='number' id='char-lvl' min='1' max='"+t.lvl+"' value='80'>\n        <span class=\"icon is-small is-left\">\n            <i class=\"fa fa-signal\"></i>\n        </span>\n    </p>\n</div>\n<div class=\"field\">\n    <label class='label'>\n        Other Info\n    </label>\n    <p class=\"control\">\n        <textarea class='textarea' id='char-other' placeholder='Any other information you wanna include (optional)'>"+t.other+"</textarea>\n    </p>\n</div>",function(e){var t=document.querySelector("input[name=char-prof]:checked"),n=document.querySelector("input[name=char-race]:checked"),a=document.querySelector("#char-name");if(!t||!n||!a)return bulmabox.alert("Needs More Info","You need to specify a profession, race, and name! Otherwise we won't know who/what you are!"),!1;var o={name:document.querySelector("#char-name").value,prof:document.querySelector("input[name=char-prof]:checked").value,race:document.querySelector("input[name=char-race]:checked").value,lvl:document.querySelector("#char-lvl").value,other:document.querySelector("#char-other").value};console.log("User wants to add char",o,e),i.post("/user/editChar",o).then(function(e){r.doUser(e.data)})},"<button class='button is-info' onclick='bulmabox.runCb(bulmabox.params.cb)'>Save</button><button class='button is-danger' onclick='bulmabox.kill(\"bulmabox-diag\")'>Cancel</button>")},r.mail=function(n){bulmabox.custom("Send Message","<div class=\"field\">\n    <label class='label'>\n        Message\n    </label>\n    <p class=\"control\">\n        <textarea class='textarea' id='newMsg' placeholder='What do you wanna say?'></textarea>\n    </p>\n</div>",function(e){var t=document.querySelector("#newMsg").value;if(!t)return bulmabox.alert("Huh?","Sorry, but we don't support uncomfortable silences currently."),!1;i.post("/user/sendMsg",{msg:t,to:n.user}).then(function(e){})},"<button class='button is-info' onclick='bulmabox.runCb(bulmabox.params.cb)'>Send</button><button class='button is-danger' onclick='bulmabox.kill(\"bulmabox-diag\")'>Cancel</button>")},r.viewMsg=function(e,t){if(bulmabox.alert("Message from "+e.from,e.msg||"(No message)"),t)return!1;i.get("/user/setOneRead?id="+e._id).then(function(e){r.doUser(e.data)})},r.delMsg=function(t){bulmabox.confirm("Delete Message","Are you sure you wish to delete this message?",function(e){console.log("resp",e),e&&null!=e&&i.get("/user/delMsg?id="+t._id).then(function(e){r.doUser(e.data)})})},r.delMyMsg=function(t){bulmabox.confirm("Delete Message","Are you sure you wish to delete this message?",function(e){console.log("resp",e),e&&null!=e&&i.get("/user/delMyMsg?id="+t._id).then(function(e){r.doUser(e.data)})})},r.repMsg=function(t){console.log("user wishes to report msg",t),bulmabox.confirm("Report Message","Reporting a message sends a notification to the moderators, including the details of the message.<br>It will then be up to the moderators to determine if you're being uncool to each other.<br>Are you sure you wish to report this message?",function(e){i.post("/user/repMsg",t).then(function(e){"dupRep"==e.data&&bootbox.alert("Already Reported","You've already reported this message. Please wait while the moderator team reviews your report.")})})},r.newPwd={pwd:null,pwdDup:null,old:null,changin:!1},r.clearPwd=function(){r.newPwd={pwd:null,pwdDup:null,old:null,changin:!1}},r.editPwd=function(){r.newPwd.pwd&&r.newPwd.pwdDup&&r.newPwd.pwd==r.newPwd.pwdDup?i.post("/user/editPwd",r.newPwd).then(function(e){e.data&&"err"!=e.data?(r.clearPwd(),bulmbox.alert("Password Changed!","Your password was successfully changed!"),r.doUser(e.data)):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Error Changing Password',"There was a problem changing your password. Your old one probably still works, but if you're still having an issue, contact a moderator!")}):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Password Mismatch',"Your passwords don't match, or are missing!")},r.viewEvent=function(e){bulmabox.alert("Event: "+e.title,"Date:"+t("numToDate")(e.eventDate)+"<br>Description:"+e.text)},r.emailTimer=function(){r.updEmail&&clearTimeout(r.updEmail),r.updEmail=setTimeout(function(){console.log(r.user.email),i.get("/user/setEmail?email="+r.user.email).then(function(e){console.log(e),e.data&&"err"!=e.data&&r.doUser(e.data)})},500)}}]).filter("numToDate",function(){return function(e){if(isNaN(e))return"Invalid date!";var t=new Date(e);return console.log(t.getMinutes()),t.toLocaleDateString()+" "+t.getHours()%12+":"+(t.getMinutes().toString().length<2?"0"+t.getMinutes():t.getMinutes())+" "+(t.getHours()<13?"AM":"PM")}}),e.controller("forum-cat-cont",["$scope","$http","$state","$location",function(n,a,o,e){localStorage.brethUsr||o.go("app.login"),a.get("/user/getUsr").then(function(e){n.user=e.data,console.log("user",n.user)}),n.newThr={},n.fileName=null,n.currCat=e.search().c,n.refCat=function(){a.get("/forum/byCat?grp="+n.currCat).then(function(e){console.log("thrds in this cat",e),n.threads=e.data.sort(function(e,t){return e.stickied===t.stickied?e.lastUpd-t.lastUpd:e.stickied?-1:1}).map(function(e){return e.time=new Date(e.lastUpd),e})})},n.refCat(),n.newThrDial=function(){n.makingThread=!0},n.clearThread=function(){n.newThr={},n.makingThread=!1,n.loadingFile=!1},n.loadFile=function(){n.loadingFile=!0;new FileReader},n.deleteThread=function(e,t){e.stopPropagation(),e.preventDefault(),bulmabox.confirm("Delete Thread","Are you absolutely sure you wish to delete the thread '"+t.title+"'? <br>Please note that this process is <em>not</em> reversable!",function(e){if(!e||null==e)return!1;console.log("Deleting thread",t),a.delete("/forum/deleteThread?id="+t._id).then(function(e){o.go(o.current,{},{reload:!0})})})},n.makeThread=function(){n.newThr.md=n.newThr.txt,n.newThr.text=(new showdown.Converter).makeHtml(n.newThr.txt),n.newThr.grp=n.currCat,a.post("/forum/newThread",n.newThr).then(function(e){console.log("new thred response",e),o.go(o.current,{},{reload:!0})})},n.toggleSticky=function(e,t){e.stopPropagation(),e.preventDefault(),a.get("/forum/toggleSticky?id="+t).then(function(e){console.log("response from thread sticky toggle is",e),n.refCat()})},n.toggleLock=function(e,t){e.stopPropagation(),e.preventDefault(),a.get("/forum/toggleLock?id="+t).then(function(e){console.log("response from thread lock toggle is",e),n.refCat()})}}]),e.controller("forum-cont",["$scope","$http","$state","$sce",function(n,e,t,a){n.currMsg=0,n.forObj={},localStorage.brethUsr||t.go("app.login"),e.get("/forum/cats").then(function(t){var e=Object.keys(t.data);console.log("CATS",t),n.forObj=e.map(function(e){return{name:e,count:t.data[e].n,time:0<t.data[e].t?new Date(t.data[e].t):null}})}),n.searchin=!1,n.search="",n.searchTimer=null,n.doSearch=function(){n.searchTimer&&clearTimeout(n.searchTimer),n.searchTimer=setTimeout(function(){n.search&&n.search.length&&e.post("/forum/searchThr",{term:n.search}).then(function(e){console.log("search response",e),n.searchResults=e.data})},500)},n.goCat=function(e){t.go("app.forumCat",{c:e})}}]),e.controller("forum-thr-cont",["$scope","$http","$state","$location","$sce",function(a,n,e,t,o){a.currMsg=0,a.defaultPic=l,a.forObj={},a.fileName=null,localStorage.brethUsr||e.go("app.login"),a.loadingFile=!1,a.loadFile=function(){a.loadingFile=!0;new FileReader},a.currCat=t.search().c,a.id=t.search().t,a.refThred=function(){console.log("info to back:",a.id),n.get("/forum/thread?id="+a.id).then(function(n){console.log("response",n),a.thr=n.data.thrd,n.data.psts.map(function(e){return e.rawText=e.text,e.text=o.trustAsHtml(e.text),e.date=new Date(e.lastUpd).toLocaleString(),e.wasEdited=e.lastUpd!=e.createDate,e}),a.avas=n.data.ava,a.thr.posts=a.thr.posts.map(function(t){console.log("PSTH",t,n.data.psts.filter(function(e){return e._id==t.id})[0]);var e=n.data.psts.filter(function(e){return e._id==t.id})[0];return e.votesUp=t.votesUp,e.votesDown=t.votesDown,e.byMod=-1<n.data.mods.indexOf(e.user),e.order=t.order,n.data.psts.filter(function(e){return e._id==t.id})[0]}).sort(function(e,t){return e.order-t.order}),console.log("thred response",a.thr,n)})},a.refThred(),n.get("/user/getUsr").then(function(e){a.user=e.data,console.log("user",a.user)}),a.newPost=function(){var e=document.querySelector("#postTxt").value;if(console.log("new POST",e,a.fileread),!e&&!a.fileread)return bulmabox.alert("Say Something","You can't just post nothing!"),!1;n.post("/forum/newPost",{thread:a.thr._id,text:(new showdown.Converter).makeHtml(e),md:e,file:a.fileread||null}).then(function(e){window.location.reload()})},a.vote=function(e,t){console.log("voting for",e,"direction",t,"which is",void 0===t?"undefined":_typeof(t)),n.post("/forum/vote",{thread:e.thread,post:e._id,voteUp:!!t}).then(function(e){console.log("vote response is:",e),a.refThred()})},a.quoteMe=function(e){document.querySelector("#postTxt").value=">"+e.md}}]),e.controller("inbox-cont",["$scope","$http","userFact",function(t,n,e){t.currMsg=0,console.log("PARENT USER IS:",t.$parent.user),t.chMsg=function(e){e&&t.currMsg<t.$parent.user.msgs.length-1?(console.log("goin up 1 msg"),t.currMsg++):!e&&0<t.currMsg&&t.currMsg--,t.$digest()},t.interpDate=function(e){return new Date(e).toUTCString()},t.reply=function(){e.writeMsg(t.$parent.user.msgs[t.currMsg].from,t.$parent.user.name,!0)},t.deleteMsg=function(){bootbox.confirm("Are you sure you wish to delete this message? Deleted messages are <i>not</i> recoverable!",function(e){e&&null!=e&&n.post("/user/delMsg",{user:t.$parent.user.name,id:t.$parent.user.msgs[t.currMsg].id}).then(function(e){e.data&&e.data.name?(t.$parent.user=e.data,console.log("affected user",t.$parent.user),angular.element("body").scope().$digest(),t.currMsgs=Math.min(t.$parent.user.msgs.length-1,t.currMsgs)):"err"==e.data&&bootbox.alert("Error deleting message!")})})}}]),e.controller("log-cont",["$scope","$http","$state","$q","userFact",function(t,n,a,e,o){t.noWarn=!1,t.nameOkay=!0,delete localStorage.brethUsr,t.checkTimer=!1,t.goReg=function(){a.go("appSimp.register")},t.goLog=function(){a.go("appSimp.login")},t.googLog=function(){window.location.href="./user/google"},t.forgot=function(){t.user?n.post("/user/forgot",{user:t.user}).then(function(e){console.log("forgot route response",e),"err"==e.data?bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Forgot Password Error',"It looks like that account either doesn't exist, or doesn't have an email registered with it! Contact a mod for further help."):bulmabox.alert("Forgot Password","Check your email! If your username is registered, you should recieve an email from us with a password reset link.")}):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Forgot Password',"To recieve a password reset email, please enter your username!")},t.signin=function(){n.post("/user/login",{user:t.user,pass:t.pwd}).then(function(e){console.log(e),"authErr"==e.data?bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Incorrect Login','Either your username or password (or both!) are incorrect.<hr><span style="font-weight:bold;">Note to Previous Users:</span><br> Your account MAY have been reset due to an issue with the authentication software we were using. For security reasons, I had to wipe the database (including accounts). Really sorry! <br> - Dave (HealyUnit)'):"banned"==e.data?bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Banned',"You've been banned! We're a pretty laid-back guild, so you must have <i>really</i> done something to piss us off!"):(console.log("LOGIN RESPONSE",e.data),s.emit("chatMsg",{msg:t.user+" logged in!"}),e.data.news&&bulmabox.alert("Updates/News","Since you last logged in, the following updates have been implemented:<br><ul style='list-style:disc;'><li>"+e.data.news.join("</li><li>")+"</li></ul>"),localStorage.brethUsr=JSON.stringify(e.data.usr),a.go("app.dash"))}).catch(function(e){"unconfirmed"==e.data?bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Unconfirmed',"Your account is currently unconfirmed. For anti-spam purposes, we need a [GEO] person to confirm your account. Thanks!"):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Error',"There's been some sort of error logging in. This is <i>probably</i> not an issue necessarily with your credentials. Blame Dave!")})},t.checkUser=function(){t.checkTimer&&clearTimeout(t.checkTimer),t.checkTimer=setTimeout(function(){n.get("/user/nameOkay?name="+t.user).then(function(e){t.nameOkay=e.data})},500)},t.emailBad=!1,t.checkEmail=function(){t.emailBad=t.email.length&&!t.email.match(/(\w+\.*)+@(\w+\.)+\w+/g)},t.register=function(){t.pwd&&t.pwdDup&&t.user?t.pwd!=t.pwdDup?(console.log("derp"),bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Password Mismatch',"Your passwords don't match, or are missing!")):!t.email||t.emailBad?bulmabox.confirm('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Send Without Email?',"You've either not included an email, or the format you're using doesn't seem to match any we know. <br>While you can register without a valid email, it'll be much more difficult to recover your account.<br>Register anyway?",function(e){if(!e||null==e)return!1;n.post("/user/new",{user:t.user,pass:t.pwd,email:t.email}).then(function(e){n.post("/user/login",{user:t.user,pass:t.pwd}).then(function(){a.go("app.dash")})}).catch(function(e){"duplicate"==e.data&&bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;User Already Exists',"That account already exists. Are you sure you didn't mean to log in?")})}):(console.log("running register with user",t.user,"and pwd",t.pwd),n.post("/user/new",{user:t.user,pass:t.pwd,email:t.email}).then(function(e){n.post("/user/login",{user:t.user,pass:t.pwd}).then(function(){a.go("app.dash")})}).catch(function(e){"duplicate"==e.data&&bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;User Already Exists',"That account already exists. Are you sure you didn't mean to log in?")})):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Missing Information',"Please enter a username, and a password (twice).")}}]),String.prototype.capMe=function(){return this.slice(0,1).toUpperCase()+this.slice(1)},e.controller("main-cont",["$scope","$http","$state","userFact",function(t,e,n,a){console.log("main controller registered!"),t.user=null,a.getUser().then(function(e){t.user=e.data,s.emit("hiIm",{name:t.user.user})}),s.on("reqHeartBeat",function(e){s.emit("hbResp",{name:t.user.user})})}]),e.controller("nav-cont",["$scope","$http","$state",function(e,t,n){e.logout=function(){bulmabox.confirm("Logout","Are you sure you wish to logout?",function(e){if(!e||null==e)return!0;t.get("/user/logout").then(function(e){n.go("appSimp.login")})})},e.mobActive=!1}]),t.controller("reset-contr",["$scope","$http","$location",function(t,e,n){t.key=window.location.search.slice(5),e.get("/user/resetUsr?key="+t.key).then(function(e){console.log("getting reset user status?",e),t.user=e.data}),t.doReset=function(){t.user&&t.pwd&&t.pwdDup&&t.pwdDup==t.pwd&&t.key?e.post("/user/resetPwd",{acct:t.user.user,pwd:t.pwd,pwdDup:t.pwdDup,key:t.key}).then(function(e){console.log(""),"err"==e.data?bulmabox.alert("Error resetting password","There was an error resetting your password. Please contact a mod"):bulmabox.alert("Password Reset","Your password was successfully reset! We're redirecting you to login now.",function(){t.goLogin()})}):bulmabox.alert("Error: Missing data","Make sure you&rsquo;ve reached this page from a password reset link, and that you have entered the same password in both fields!")},t.goLogin=function(){window.location.href="../../login"}}]);var n=[{value:-12,text:"(GMT -12:00) Eniwetok, Kwajalein"},{value:-11,text:"(GMT -11:00) Midway Island, Samoa"},{value:-10,text:"(GMT -10:00) Hawaii"},{value:-9,text:"(GMT -9:00) Alaska"},{value:-8,text:"(GMT -8:00) Pacific Time (US & Canada)"},{value:-7,text:"(GMT -7:00) Mountain Time (US & Canada)"},{value:-6,text:"(GMT -6:00) Central Time (US & Canada), Mexico City"},{value:-5,text:"(GMT -5:00) Eastern Time (US & Canada), Bogota, Lima"},{value:-4,text:"(GMT -4:00) Atlantic Time (Canada), Caracas, La Paz"},{value:-3.5,text:"(GMT -3:30) Newfoundland"},{value:-3,text:"(GMT -3:00) Brazil, Buenos Aires, Georgetown"},{value:-2,text:"(GMT -2:00) Mid-Atlantic"},{value:-1,text:"(GMT -1:00) Azores, Cape Verde Islands"},{value:0,text:"(GMT) Western Europe Time, London, Lisbon, Casablanca"},{value:1,text:"(GMT +1:00) Brussels, Copenhagen, Madrid, Paris"},{value:2,text:"(GMT +2:00) Kaliningrad, South Africa"},{value:3,text:"(GMT +3:00) Baghdad, Riyadh, Moscow, St. Petersburg"},{value:3.5,text:"(GMT +3:30) Tehran"},{value:4,text:"(GMT +4:00) Abu Dhabi, Muscat, Baku, Tbilisi"},{value:4.5,text:"(GMT +4:30) Kabul"},{value:5,text:"(GMT +5:00) Ekaterinburg, Islamabad, Karachi, Tashkent"},{value:5.5,text:"(GMT +5:30) Bombay, Calcutta, Madras, New Delhi"},{value:5.75,text:"(GMT +5:45) Kathmandu"},{value:6,text:"(GMT +6:00) Almaty, Dhaka, Colombo"},{value:7,text:"(GMT +7:00) Bangkok, Hanoi, Jakarta"},{value:8,text:"(GMT +8:00) Beijing, Perth, Singapore, Hong Kong"},{value:9,text:"(GMT +9:00) Tokyo, Seoul, Osaka, Sapporo, Yakutsk"},{value:9.5,text:"(GMT +9:30) Adelaide, Darwin"},{value:10,text:"(GMT +10:00) Eastern Australia, Guam, Vladivostok"},{value:11,text:"(GMT +11:00) Magadan, Solomon Islands, New Caledonia"},{value:12,text:"(GMT +12:00) Auckland, Wellington, Fiji, Kamchatka"}],i=[{id:1001,name:"Anvil Rock",population:"High"},{id:1002,name:"Borlis Pass",population:"Medium"},{id:1003,name:"Yak's Bend",population:"High"},{id:1004,name:"Henge of Denravi",population:"Medium"},{id:1005,name:"Maguuma",population:"High"},{id:1006,name:"Sorrow's Furnace",population:"Medium"},{id:1007,name:"Gate of Madness",population:"Medium"},{id:1008,name:"Jade Quarry",population:"Medium"},{id:1009,name:"Fort Aspenwood",population:"Full"},{id:1010,name:"Ehmry Bay",population:"Medium"},{id:1011,name:"Stormbluff Isle",population:"Medium"},{id:1012,name:"Darkhaven",population:"Medium"},{id:1013,name:"Sanctum of Rall",population:"VeryHigh"},{id:1014,name:"Crystal Desert",population:"Medium"},{id:1015,name:"Isle of Janthir",population:"Medium"},{id:1016,name:"Sea of Sorrows",population:"VeryHigh"},{id:1017,name:"Tarnished Coast",population:"High"},{id:1018,name:"Northern Shiverpeaks",population:"High"},{id:1019,name:"Blackgate",population:"Full"},{id:1020,name:"Ferguson's Crossing",population:"Medium"},{id:1021,name:"Dragonbrand",population:"Medium"},{id:1022,name:"Kaineng",population:"High"},{id:1023,name:"Devona's Rest",population:"Medium"},{id:1024,name:"Eredon Terrace",population:"Medium"},{id:2001,name:"Fissure of Woe",population:"Medium"},{id:2002,name:"Desolation",population:"VeryHigh"},{id:2003,name:"Gandara",population:"High"},{id:2004,name:"Blacktide",population:"Medium"},{id:2005,name:"Ring of Fire",population:"Medium"},{id:2006,name:"Underworld",population:"Medium"},{id:2007,name:"Far Shiverpeaks",population:"Medium"},{id:2008,name:"Whiteside Ridge",population:"High"},{id:2009,name:"Ruins of Surmia",population:"Medium"},{id:2010,name:"Seafarer's Rest",population:"VeryHigh"},{id:2011,name:"Vabbi",population:"High"},{id:2012,name:"Piken Square",population:"VeryHigh"},{id:2013,name:"Aurora Glade",population:"High"},{id:2014,name:"Gunnar's Hold",population:"Medium"},{id:2101,name:"Jade Sea",population:"High"},{id:2102,name:"Fort Ranik",population:"Medium"},{id:2103,name:"Augury Rock",population:"High"},{id:2104,name:"Vizunah Square",population:"Medium"},{id:2105,name:"Arborstone",population:"Medium"},{id:2201,name:"Kodash",population:"High"},{id:2202,name:"Riverside",population:"Full"},{id:2203,name:"Elona Reach",population:"VeryHigh"},{id:2204,name:"Abaddon's Mouth",population:"Medium"},{id:2205,name:"Drakkar Lake",population:"High"},{id:2206,name:"Miller's Sound",population:"Medium"},{id:2207,name:"Dzagonur",population:"Medium"},{id:2301,name:"Baruch Bay",population:"VeryHigh"}];e.controller("tool-cont",["$scope","$http","$state","$filter","$sce","$window",function(r,t,e,n,a,o){r.showTab=function(e){r.currTab=e,"WvW Current Match History"==r.currTab&&r.refWvw()},r.currTab="Dailies",r.tabs=[{name:"Dailies",icon:"calendar-check-o"},{name:"WvW Current Match History",icon:"fort-awesome"},{name:"Core/Lodestone Upgrade",icon:"diamond"},{name:"Tier Six Material Conversion",icon:"money"}],r.dailyRestrict={},r.tmrw=!1,r.regetDaily=function(){var e=Object.keys(r.dailyRestrict).filter(function(e){return r.dailyRestrict[e]});t.get("/tool/daily"+(r.tmrw?"/tomorrow":"")+(e.length?"?modes="+e.join(","):"")).then(function(e){console.log("dailyObj",e.data),r.dailies=e.data})},o.addEventListener("keyup",function(e){39!=e.which||e.shiftKey?39==e.which&&e.shiftKey?(r.lastSkirm(),r.$digest()):37!=e.which||e.shiftKey?37==e.which&&e.shiftKey&&(r.firstSkirm(),r.$digest()):(r.prevSkirm(),r.$digest()):(r.nextSkirm(),r.$digest())}),r.regetDaily(),r.refPrices=function(){t.get("/tool/allPrices").then(function(e){r.prices=r.calcPrices(e.data.p)})},r.wvwWorld=!1,r.wvwColors=["red","green","blue"],r.wvwPie={cutoutPercentage:0,backgroundColor:["#aa0000","#00aa00","#0000aa"],config:{plugins:{vert:!1}}},r.wvwDisabled=!1,r.makeMarkers=function(){r.mapMarkers=["camp-blue.png","camp-green.png","camp-netural.png","camp-red.png","castle-blue.png","castle-green.png","castle-neutral.png","castle-red.png","keep-blue.png","keep-green.png","keep-netural.png","keep-red.png","ruins-blue.png","ruins-green.png","ruins-neutral.png","ruins-red.png","tower-blue.png","tower-green.png","tower-neutral.png","tower-red.png"].map(function(e){return L.icon({iconUrl:"./img/wvw/"+e,iconName:e.replace(".png",""),iconSize:[32,32],iconAnchor:[15,15],popupAnchor:[-3,-76]})}),console.log("Map Markers",r.mapMarkers)},r.refWvw=function(){t.get("/tool/wvw"+(r.wvwWorld?"?world="+r.wvwWorld:"")).then(function(t){if(console.log("WVW STUFF",t,t.data),"newMatch"==t.data)return r.wvwDisabled=!0,r.wvw=null,!1;r.wvwDisabled=!1,r.wvw=t.data.wvw,r.currentMatch=r.wvw.skirmishes.length-1,r.wvw.labels=r.wvwColors.map(function(e){return t.data.wvw.all_worlds[e].map(function(t){return i.find(function(e){return e.id==t}).name}).join(", ")}),r.wvw.skirmishes.forEach(function(t){t.scoreArr=r.wvwColors.map(function(e){return t.scores[e]})}),r.wvw.history=r.wvwColors.map(function(t){return r.wvw.skirmishes.map(function(e){return e.scores[t]})}),r.wvw.histLabels=new Array(r.wvw.history[0].length).fill(100).map(function(e,t){return t+1}),r.wvw.histColors=[{backgroundColor:"transparent",borderColor:"#f00",pointBackgroundColor:"#f00"},{backgroundColor:"transparent",borderColor:"#0f0",pointBackgroundColor:"#0f0"},{backgroundColor:"transparent",borderColor:"#00f",pointBackgroundColor:"#00f"}],console.log("WVW",r.wvw),r.mapMarkers=[],r.wvwOwned=t.data.owned||null,r.makeMarkers();var e=document.querySelector("#wvw-map");console.log("mapDiv",e,e.offsetWidth),r.doMap(r.wvw.maps)})},r.nextSkirm=function(){if(!r.wvw)return!1;r.wvw.skirmishes.length>r.currentMatch+1?r.currentMatch++:r.currentMatch=0,r.positionVert()},r.prevSkirm=function(){if(!r.wvw)return!1;r.currentMatch&&0<r.currentMatch?r.currentMatch--:r.currentMatch=r.wvw.skirmishes.length-1,r.positionVert()},r.lastSkirm=function(){r.currentMatch=r.wvw.skirmishes.length-1,r.positionVert()},r.firstSkirm=function(){r.currentMatch=0,r.positionVert()},r.mats=["blood","bone","claw","fang","scale","totem","venom"],r.cores=["glacial","onyx","destroyer","molten","corrupted","essence","crystal","charged"],r.calcPrices=function(a){console.log("DATA before prices",a),a.push({hi:2504,lo:2504,lName:"Bottle of Elonian Wine",id:19663,sName:"wine"});var o=a.find(function(e){return"t6dust"==e.sName});return r.mats.forEach(function(t){var e=a.find(function(e){return e.sName=="t5"+t}),n=a.find(function(e){return e.sName=="t6"+t});n.hiProf=12*n.hi-(50*e.lo+1*n.lo+5*o.lo),n.loProf=5*n.lo-(50*e.hi+1*n.hi+5*o.hi),n.t5=e,(n.profGood=0)<n.hiProf&&0<n.loProf?n.profGood=1:n.hiProf<0&&n.loProf<0&&(n.profGood=-1)}),r.cores.forEach(function(t){var e=a.find(function(e){return e.sName=="c"+t}),n=a.find(function(e){return e.sName=="l"+t});n.c=e,n.hiProf=n.hi-(2*e.lo+o.lo+2504),n.loProf=n.lo-(2*e.hi+o.hi+2504),(n.profGood=0)<n.hiProf&&0<n.loProf?n.profGood=1:n.hiProf<0&&n.loProf<0&&(n.profGood=-1)}),console.log("PRICES!",a),a},r.isMat=function(e){return-1<e.sName.indexOf("t6")&&"t6dust"!=e.sName},r.isGem=function(e){return e.sName.indexOf("t6")<0&&"wine"!=e.sName&&e.sName.indexOf("t5")<0&&"l"==e.sName[0]},r.histClick=function(e){if(console.log("CLICKED:",e,Chart),!e||!e[0])return!1;r.currentMatch=e[0]._index,r.positionVert()},r.positionVert=function(){r.lineOpts.title.text="("+(r.currentMatch+1)+")"},Chart.plugins.register({id:"vert",afterDraw:function(e,t){if("doughnut"!=e.config.type){r.lineXWid=e.chartArea.right-e.chartArea.left,r.lineYWid=e.chartArea.left,r.lineHeight=e.chartArea.bottom-e.chartArea.top,r.lineStepWid=r.lineXWid/(r.wvw.skirmishes.length-1);var n=e.canvas.getContext("2d");n.moveTo(r.lineYWid+r.currentMatch*r.lineStepWid,5),n.lineTo(r.lineYWid+r.currentMatch*r.lineStepWid,r.lineHeight+5),n.strokeStyle="#fff",n.stroke()}}}),r.lineOpts={title:{text:"("+(r.currentMatch+1)+")"},scales:{yAxes:[{ticks:{beginAtZero:!0,fontColor:"#fff"}}],xAxes:[{ticks:{fontColor:"#fff"}}]},hover:{animationDuration:0}},r.refPrices(),r.getMapState=function(){console.log("ZOOM",r.map.getZoom(),"BOUNDS",r.map.getBounds())},r.unproject=function(e,t){return e.unproject(t,e.getMaxZoom())},r.doMap=function(e){var t,n;r.map=L.map("wvw-map",{minZoom:0,maxZoom:6}),n=r.unproject(r.map,[15700,8900]),t=r.unproject(r.map,[5100,15900]);var a=new L.LatLngBounds(r.unproject(r.map,[16384,0]),r.unproject(r.map,[0,16384]));L.tileLayer("https://tiles.guildwars2.com/2/3/{z}/{x}/{y}.jpg",{subdomains:["tiles1","tiles2","tiles3","tiles4"],bounds:a,minNativeZoom:4,noWrap:!0}).addTo(r.map),r.map.setMaxBounds(new L.LatLngBounds(t,n)),r.map.setView(new L.LatLng((n.lat-t.lat)/2,(n.lng-t.lng)/2),0),e.forEach(function(e){e.objectives.filter(function(e){return!!e.marker}).forEach(function(t){var e=r.mapMarkers.find(function(e){return e.options.iconName==t.type.toLowerCase()+"-"+t.owner.toLowerCase()});console.log("THIS OBJECTIVE",t,"MARKER (probly)",e,"FROM",t.type.toLowerCase()+"-"+t.owner.toLowerCase()),L.marker(r.unproject(r.map,t.coord),{title:t.name+" (owned by: "+t.owner+")",icon:e}).addTo(r.map)})}),setTimeout(function(){r.map.invalidateSize(),r.map.setZoom(3)},500)}}]),e.controller("unconf-cont",["$scope","$http","$state",function(e,t,n){e.logout=function(){t.get("/user/logout").then(function(e){console.log(e),n.go("appSimp.login")})}}]),e.factory("socketFac",["$rootScope",function(a){var o=io.connect();return{on:function(e,t){o.on(e,function(){var e=arguments;a.$apply(function(){t.apply(o,e)})})},emit:function(e,t,n){o.emit(e,t,function(){var e=arguments;a.$apply(function(){n&&n.apply(o,e)})})}}}]),e.run(["$rootScope","$state","$stateParams","$transitions","$q","userFact",function(e,n,t,a,o,r){a.onBefore({to:"app.**"},function(e){var t=o.defer();return console.log("TRANS",e),e.injector().get("userFact").getUser().then(function(e){console.log("response from login chck",e),e.data&&e.data.confirmed?t.resolve(!0):e.data?t.resolve(n.target("appSimp.unconfirmed",void 0,{location:!0})):t.resolve(n.target("appSimp.login",void 0,{location:!0}))}).catch(function(e){t.resolve(n.target("appSimp.login",void 0,{location:!0}))}),t.promise})}]),e.factory("userFact",["$http",function(e){return{getUser:function(){return e.get("/user/getUsr").then(function(e){return console.log("getUser in fac says:",e),e})}}}])}();