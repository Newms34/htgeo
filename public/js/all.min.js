...
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e};!function(){r.$inject=["$timeout"];var e=io(),t=angular.module("htgeo-app",["ui.router","ngAnimate","ngSanitize","chart.js"]),n=angular.module("reset-app",[]),a="data:image/png;base64,";Array.prototype.findUser=function(e){for(var t=0;t<this.length;t++)if(this[t].user==e)return t;return-1};t.constant("IsDevelopment","localhost"===window.location.hostname).config(["$stateProvider","$urlRouterProvider","$locationProvider","$httpProvider","$compileProvider","$logProvider",function(e,t,n,a,o,r,i){n.html5Mode(!0),t.otherwise("/404"),o.debugInfoEnabled(i),r.debugEnabled(i),e.state("app",{abstract:!0,templateUrl:"layouts/full.html"}).state("app.blog",{url:"/blog",templateUrl:"components/blog.html"}).state("app.dash",{url:"/",templateUrl:"components/dash.html"}).state("app.chat",{url:"/chat",cache:!1,templateUrl:"components/chat.html"}).state("app.calendar",{url:"/calendar",templateUrl:"components/calendar.html"}).state("app.help",{url:"/help",templateUrl:"components/help/help.html"}).state("app.forum",{url:"/forum",templateUrl:"components/forums/forum.html"}).state("app.forumCat",{url:"/forumCat?c",templateUrl:"components/forums/forumCat.html"}).state("app.forumThr",{url:"/forumThr?c&t",templateUrl:"components/forums/forumThr.html"}).state("app.tools",{url:"/tools",templateUrl:"components/tools.html"}).state("appSimp",{abstract:!0,templateUrl:"components/layout/simp.html"}).state("appSimp.login",{url:"/login",templateUrl:"components/login.html"}).state("appSimp.register",{url:"/register",templateUrl:"components/register.html"}).state("appSimp.unconfirmed",{url:"/unconf",templateUrl:"components/alt/unconfirmed.html"}).state("appSimp.notfound",{url:"/404",templateUrl:"components/alt/404.html"}).state("appSimp.err",{url:"/500",templateUrl:"components/alt/500.html"})}]).directive("fileread",[function(){return{scope:{fileread:"="},link:function(e,t,n){t.bind("change",function(t){var n=new FileReader,a=t.target.files[0],r=a.name;return $log.debug("UPLOADING FILE",a),n.onload=function(t){var n=t.target.result;$log.debug("URI before optional resize",n,n.length),e.$parent.needsResize?o(e,n,e.$parent.needsResize,e.$parent.needsResize,r):($log.debug("APPLYING file to $parent"),e.$apply(function(){e.$parent&&e.$parent.$parent&&e.$parent.$parent.avas?(e.$parent.$parent.loadingFile=!1,e.$parent.$parent.fileName="Loaded:"+r,e.$parent.$parent.fileread=n):(e.$parent.loadingFile=!1,e.$parent.fileName="Loaded:"+r,e.$parent.fileread=n),e.$parent.saveDataURI&&"function"==typeof e.$parent.saveDataURI&&e.$parent.saveDataURI(dataURI)}))},a?a.size>25e5?(bulmabox.alert("File too Large","Your file "+a.name+" is larger than 2.5MB. Please upload a smaller file!"),!1):void n.readAsDataURL(a):(e.$apply(function(){e.fileread="",e.$parent.fileName=!1,e.$parent.loadingFile=!1}),!1)})}}}]).filter("markdown",["$sce",function(e){return function(t){var n=new showdown.Converter;return e.trustAsHtml(n.makeHtml(t))}}]),Array.prototype.rotate=function(e){for(var t=angular.copy(this),n=0;n<e;n++)t.push(t.shift());return t},Date.prototype.dyMo=function(){return this.getMonth()+1+"/"+this.getDate()},String.prototype.titleCase=function(){return this.split(/\s/).map(function(e){return e.slice(0,1).toUpperCase()+e.slice(1).toLowerCase()}).join(" ")};var o=function(e,t,n,a,o){var r=document.createElement("img");r.onload=function(){var t=document.createElement("canvas"),r=t.getContext("2d");t.width=n,t.height=a,r.drawImage(this,0,0,n,a);var i=t.toDataURL();e.$apply(function(){e.$parent.loadingFile=!1,e.$parent.fileName="Loaded:"+o,e.fileread=i,e.$parent.saveDataURI&&"function"==typeof e.$parent.saveDataURI&&e.$parent.saveDataURI(i)})},r.src=t};function r(e){return{restrict:"A",priority:101,link:function(t,n,a){e(function(){t.$evalAsync(a.postrenderAction)},0)}}}t.directive("postrenderAction",r),t.factory("socketFac",["$rootScope",function(e){var t=io.connect();return{on:function(n,a){t.on(n,function(){var n=arguments;e.$apply(function(){a.apply(t,n)})})},emit:function(n,a,o){t.emit(n,a,function(){var n=arguments;e.$apply(function(){o&&o.apply(t,n)})})}}}]),t.run(["$rootScope","$state","$stateParams","$transitions","$q","userFact","$log",function(e,t,n,a,o,r,i){a.onBefore({to:"app.**"},function(e){var n=o.defer();return i.debug("TRANS",e),e.injector().get("userFact").getUser().then(function(e){i.debug("response from login chck",e),e.data&&e.data.confirmed?n.resolve(!0):e.data?n.resolve(t.target("appSimp.unconfirmed",void 0,{location:!0})):n.resolve(t.target("appSimp.login",void 0,{location:!0}))}).catch(function(e){n.resolve(t.target("appSimp.login",void 0,{location:!0}))}),n.promise})}]),t.factory("userFact",["$http","$log",function(e,t){return{getUser:function(){return e.get("/user/getUsr").then(function(e){return t.debug("getUser in fac says:",e),e})}}}]),t.controller("blog-cont",["$scope","$http","$state","$filter","$sce","$log",function(e,t,n,a,o,r){t.get("/user/getUsr").then(function(t){e.doUser(t.data),r.debug("user",e.user)}),e.msgs=[],e.doUser=function(t){if(!t)return!1;e.user=t,e.msgs.push({time:Date.now(),user:"System",msg:"Welcome to Hidden Tyria Geographic Society [GEO] Chat! You're logged in as "+t.user+". Try /wiki or /google to search for stuff!",isSys:!0})},e.newBlog={title:null,contents:null,youtube:null,pic:null,youtubeCand:null},e.blogEntries=[{author:"Healy",pic:"https://static.wixstatic.com/media/4c8c05_d15c19168bda4a3c9a3bef232a00310f~mv2.jpg/v1/fit/w_1175,h_661,al_c,q_80/file.png",height:400,title:"A Test Post",contents:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc et mi ut mauris rutrum malesuada. Ut tincidunt in ex ac ultrices. Integer nec aliquam massa. Fusce aliquam fermentum augue. Suspendisse sollicitudin lectus libero. Praesent varius nisl eu neque cursus lobortis. Nullam convallis turpis sit amet tortor cursus fermentum. In facilisis pharetra urna, sed feugiat est lobortis a. Vestibulum vehicula malesuada purus, id convallis massa suscipit nec. Nunc a ante nunc. Nullam faucibus porttitor erat, vitae convallis augue tincidunt a.\n\n        Nunc egestas hendrerit orci, ut rutrum ex porta ac. Pellentesque porttitor erat neque, eu pulvinar ex sodales quis. Morbi gravida suscipit nulla nec laoreet. Vivamus eleifend magna leo. Morbi tincidunt iaculis euismod. Aliquam malesuada nunc lacinia, convallis augue quis, consectetur elit. Maecenas mattis purus sollicitudin semper feugiat. Ut at gravida augue, sit amet venenatis arcu. Maecenas et justo ut elit ultrices maximus et ac enim. Sed nec rutrum nibh. Etiam malesuada lacus nisl, eget pretium odio consectetur ut.",youtube:"https://www.youtube.com/watch?v=cGZ4X7cER8k",likeNum:0,usrLiked:!1,when:"A long time ago",id:null}],e.refBlogs=function(){t.get("/blog/allEntries").then(function(t){if(!t.data)throw new Error("no blogs");e.blogEntries=e.parseBlogs(t.data)}).catch(function(t){e.blogEntries=[{author:"System",pic:"https://static.wixstatic.com/media/4c8c05_d15c19168bda4a3c9a3bef232a00310f~mv2.jpg/v1/fit/w_1175,h_661,al_c,q_80/file.png",height:400,title:"Couldn't Load Blog",contents:"Your site is probably broken, or your internet connection sucks. We couldn't load any blog info!",youtube:null,likeNum:0,usrLiked:!1,when:"A long time ago",_id:null}]})},e.refBlogs(),e.parseBlogs=function(t){return t.map(function(t){return t.height=t.height||400,t.likeNum=t.likes.length,t.usrLiked=!!t.likes.includes(e.user._id),t.when=new Date(t.date).toLocaleString(),t.editContents=t.contents,t})},e.toggleLike=function(n){t.get("/blog/toggleLike?v="+n).then(function(t){var n=e.blogEntries.find(function(e){return e._id==t.data._id});n.likes=t.data.likes,n.usrLiked=t.data.likes.includes(e.user._id),n.likeNum=t.data.likes.length})},e.timers={pic:null,vid:null},e.doPic=function(t){r.debug("EVENT INTO CHANGE",t);var n=new FileReader,a=document.querySelector("#upl-canv"),o=a.getContext("2d");n.onload=function(t){var n=new Image;n.onload=function(){r.debug(n,n.width),a.width=n.width,a.height=n.height,o.drawImage(n,0,0),e.pic=a.toDataURL()},n.src=t.target.result},n.readAsDataURL(t.target.files[0])},e.vidTimer=function(){e.timers.vid&&clearTimeout(e.timers.vid),e.timers.vid=setTimeout(function(){e.newBlog.youtubeCand&&e.newBlog.youtubeCand.length?e.newBlog.youtubeCand.includes("youtu.be")?e.newBlog.youtube=e.newBlog.youtubeCand.replace("https://youtu.be/","https://www.youtube.com/watch?v=").replace("youtu.be/","https://www.youtube.com/watch?v="):e.newBlog.youtube=e.newBlog.youtubeCand:e.newBlog.youtube=null},500)},e.newPost=function(n){if(!e.newBlog.title||!e.newBlog.contents)return bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Missing Information',"Your blog post needs a title and at least some text content!");var a=angular.copy(e.newBlog);delete a.picCand,delete a.youtubeCand,t.post("/blog/post",a).then(function(t){e.newBlog={title:null,contents:null,youtube:null,pic:null,picCand:null,youtubeCand:null},e.refBlogs()})},e.editBlog=function(n){bulmabox.confirm("Update Blog Text","Are you sure you wanna update your blog post?",function(a){a&&t.put("/blog/post",n).then(function(t){e.refBlogs()})})},e.deleteBlog=function(n){r.debug("Attempting to delete blog",n),bulmabox.confirm("Delete Blog Post","Are you sure you wanna delete this blog entry?",function(a){a&&(Object.keys(n)||r.debug("somehow b got emptied!",n),t.delete("/blog/post?id="+n._id).then(function(t){e.refBlogs()}))})}}]).directive("customOnChange",function(){return{restrict:"A",link:function(e,t,n){var a=e.$eval(n.customOnChange);t.on("change",a),t.on("$destroy",function(){t.off()})}}}).filter("trusted",["$sce",function(e){return function(t){var n=t.split("v=")[1].split("&")[0];return e.trustAsResourceUrl("https://www.youtube.com/embed/"+n)}}]),Date.prototype.stdTimezoneOffset=function(){var e=new Date(this.getFullYear(),0,1),t=new Date(this.getFullYear(),6,1);return Math.max(e.getTimezoneOffset(),t.getTimezoneOffset())},Date.prototype.isDstObserved=function(){return this.getTimezoneOffset()<this.stdTimezoneOffset()},t.controller("cal-cont",["$scope","$http","$state","$log",function(t,n,a,o){t.cal=[],t.days=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],t.calLoaded=!1,t.wkOpts=[{lbl:"Every week",n:1},{lbl:"Every two weeks",n:2},{lbl:"Every three weeks",n:3},{lbl:"Every four weeks",n:4},{lbl:"Every five weeks",n:5}],n.get("/user/usrData").then(function(e){t.user=e.data}),t.refCal=function(){n.get("/cal/all").then(function(e){o.debug("calendar events response:",e),t.makeCalendar(e.data)})},e.on("refCal",function(e){t.refCal()}),t.refCal(),t.makeCalendar=function(e){t.offsetDays=t.days.rotate((new Date).getDay());var n=0,a=0,r=new Date;for(r.setHours(0,0,0,0),r=r.getTime(),t.cal=[];n<6;n++){var i={wk:n,wkSt:new Date(r+7*n*1e3*3600*24),wkEn:new Date(r+1e3*(7*(n+1)-1)*3600*24),days:[]},s=function(){var t=new Date(r+1e3*(7*n+a)*3600*24);i.days.push({d:a,evts:e.filter(function(e){var n=new Date(e.eventDate).getTime();return o.debug("THIS DATE DTNUM",n,t.getTime()),n>t.getTime()&&n<t.getTime()+864e5}),date:t})};for(a=0;a<7;a++)s();t.cal.push(i)}o.debug("CAL STUFF",t.cal,t.offsetDays)},t.viewEvent=function(e){o.debug("View event",e);var n=null;e.paid&&e.paid.length&&(n="<ul class='ul'>\n                "+e.paid.map(function(e){return"<li>"+e+"</li>"}).join("")+"\n            </ul>"),bulmabox.alert("Event: "+e.title,"Time:"+new Date(e.eventDate).toLocaleString()+"<br>Type:"+t.kindOpts.find(function(t){return t.kind==e.kind}).kindLong+"<br>"+(n?"Paid Users<br>"+n:"")+"<hr> Description: "+e.text)},t.editEventObj={title:"",desc:"",day:0,time:2*((new Date).getHours()+((new Date).getMinutes()<30?.5:0)),kind:"lotto",id:null},t.clearEdit=function(){t.editEventAct=!1},t.editEventAct=!1,t.editEvent=function(e){t.editEventAct=!0,o.debug("Edit event",e,"hour options",t.hourOpts);var n=new Date(e.eventDate).setHours(0,0,0,0),a=Date.now();t.editEventObj={title:e.title,desc:e.text,kind:t.kindOpts.find(function(t){return t.kind==e.kind}),time:Math.floor((e.eventDate-n)/18e5),day:Math.round((e.eventDate-a)/864e5),id:e._id,user:e.user}},t.doEdit=function(){o.debug("Input edit event",t.editEventObj);var e=new Date,a=t.editEventObj.day,r=t.editEventObj.time;(new Date).isDstObserved()||(r+=2)>47&&(r%=47,a++),e.setHours(0,0,0,0);var i=e.getTime()+1800*r*1e3+3600*a*1e3*24;if(o.debug("Sending event",t.editEventObj,i),i<Date.now()+3e5)return bulmabox.alert("Time Expiring","Your selected time, "+new Date(i).toLocaleString()+", occurs too soon! Please select a later time."),!1;n.post("/cal/edit",{title:t.editEventObj.title,text:t.editEventObj.desc,eventDate:i,kind:t.editEventObj.kind.kind,id:t.editEventObj.id,user:t.editEventObj.user}).then(function(e){o.debug("edit event response",e),"wrongUser"==e.data&&bulmabox.alert('<i class="fa fa-exclamation-triangle"></i> Wrong User',"You cannot edit this event, as you are not its creator and are not a moderator."),t.refCal(),t.clearEdit()})},t.delEvent=function(e){o.debug("Delete event",e),bulmabox.confirm("Delete Event","Are you sure you wish to delete the following event?<br> Title: "+e.title+"<br>Description: "+e.text,function(a){if(!a||null==a)return!1;n.get("/cal/del?id="+e._id).then(function(e){o.debug("delete response",e),t.refCal()})})},t.addEvent=!1,t.newEventObj={title:"",desc:"",day:0,time:2*((new Date).getHours()+((new Date).getMinutes()<30?.5:0)),kind:"lotto",repeatNum:1,repeatOn:!1,repeatFreq:1},n.get("/user/allUsrs").then(function(e){t.allUsrs=e.data.map(function(e){return e.user})}),t.addPaid=function(e){var a=t.allUsrs.filter(function(t){return!e.paid||!e.paid.length||e.paid.indexOf(t)<0}).map(function(e){return"<option value='"+e+"'>"+e+"</option>"}).join("");if(!a.length)return bulmabox.alert("No More Users","Either all users have paid for this event, or no users are registered! <br>You're logged in, so the second option's pretty much impossible.");bulmabox.custom("Add Paid User","Select a user from the list below to add them to this lotto's candidates:<br><p class='select'><select id='payusr'>"+a+"</select></p>",function(){var t=document.querySelector("#payusr").value;o.debug("User wishes to add",t),n.post("/cal/lottoPay",{lottoId:e._id,pusr:t})},"<button class='button is-warning' onclick='bulmabox.runCb(bulmabox.params.cb)'>Add</button><button class='button is-danger' onclick='bulmabox.kill(\"bulmabox-diag\")'>Cancel</button>")},t.hourOpts=new Array(48).fill(100).map(function(e,t){var n=t<24?"AM":"PM",a=Math.floor(t/2)<13?Math.floor(t/2):Math.floor(t/2)-12;return a<1&&(a=12),{num:t,hr:a+(t%2?":30":":00")+n}}),t.dayOpts=new Array(42).fill(100).map(function(e,t){var n=new Date(Date.now()+3600*t*1e3*24);return{num:t,day:n.getMonth()+1+"/"+n.getDate()}}),t.kindOpts=[{kind:"lotto",desc:"An item or items will be given away by a [GEO] member to one lucky guild member!",kindLong:"Lottery/Giveaway"},{kind:"payLotto",desc:"Try your luck! One lucky winner will win the pool of donations!",kindLong:"Paid Lottery/Giveaway"},{kind:"announce",desc:"Someone needs to make an important announcement!",kindLong:"Announcement"},{kind:"contest",desc:"Some sort of contest! See who's the best!",kindLong:"Contest"},{kind:"other",desc:"Any other event type",kindLong:"Other"}],t.doAdd=function(){var e=new Date,a=t.newEventObj.time,r=t.newEventObj.day;e.setHours(0,0,0,0),(new Date).isDstObserved()||(a+=2)>47&&(a%=47,r++);var i=e.getTime()+1800*a*1e3+3600*r*1e3*24,s=t.newEventObj.repeatOn?"/cal/newRep":"/cal/new";if(i<Date.now()+3e5)return bulmabox.alert("Time Expiring","Your selected time, "+new Date(i).toLocaleString()+", occurs too soon! Please select a later time."),!1;o.debug("Sending event",t.newEventObj,i),n.post(s,{title:t.newEventObj.title,text:t.newEventObj.desc,eventDate:i,kind:t.newEventObj.kind.kind,repeatNum:t.newEventObj.repeatNum,repeatFreq:t.newEventObj.repeatFreq,repeatOn:t.newEventObj.repeatOn}).then(function(e){o.debug("new event response",e),t.refCal(),t.clearAdd()})},t.clearAdd=function(){t.addEvent=!1,t.newEventObj={title:"",desc:"",day:0,time:2*((new Date).getHours()+((new Date).getMinutes()<30?.5:0)),kind:"lotto",repeatNum:1,repeatFreq:1,repeatOn:!1}}}]),t.controller("chat-cont",["$scope","$http","$state","$filter","$sce","$log",function(t,n,a,o,r,i){n.get("/user/getUsr").then(function(e){t.doUser(e.data),i.debug("user",t.user)}),t.msgs=[],t.doUser=function(e){if(!e)return!1;t.user=e,t.msgs.push({time:Date.now(),user:"System",msg:"Welcome to Hidden Tyria Geographic Society [GEO] Chat! You're logged in as "+e.user+". Try /wiki or /google to search for stuff!<br>You can also poke anyone online by doing @<user>, where <user> is their username.<br>Finally, type /list to see a list of who's currently online.",isSys:!0})},t.parseMsg=function(e){return i.debug("in parseMsg",e),0===e.indexOf("/wiki ")?'Wiki: <a href="https://wiki.guildwars2.com/wiki/'+e.slice(6)+'" target="_blank">'+e.slice(6)+"</a>":0===e.indexOf("/google ")?'Google: <a href="https://www.google.com/search?q='+e.slice(8)+'" target="_blank">'+e.slice(8)+"</a>":e},n.get("/user/allUsrs").then(function(e){i.debug("all users is",e),t.allUsers=e.data}),e.on("chatMsgOut",function(e){if(i.debug("before dealing with commands, full message object is",e),"string"!=typeof e.msg)return!1;e.msg=r.trustAsHtml(t.parseMsg(e.msg)),t.msgs.push(e),t.msgs.length>100&&t.msgs.shift(),t.$apply(),document.querySelector("#chat-container").scrollTop=document.querySelector("#chat-container").scrollHeight}),e.on("disconnect",function(){t.msgs.push({time:Date.now(),user:"System",msg:"Warning: The connection to the server was lost. Until you refresh, chat's probably gonna be pretty quiet!",isSys:!0}),t.msgs.length>100&&t.msgs.shift(),t.$apply(),document.querySelector("#chat-container").scrollTop=document.querySelector("#chat-container").scrollHeight}),t.sendChat=function(){if(!t.newMsg)return!1;if("/list"==t.newMsg.toLowerCase()){var n={time:Date.now(),user:"System",msg:"No other users currently online!",isSys:!0};return t.$parent.alsoOnline&&t.$parent.alsoOnline.length&&(n.msg="Users currently online:<ul>"+t.$parent.alsoOnline.map(function(e){return"<li> - "+e+"</li>"})+"</ul>"),t.msgs.push(n),t.msgs.length>100&&t.msgs.shift(),t.newMsg="",!1}return"/coloron"==t.newMsg.toLowerCase()?(i.debug("toggling disco mode!",t.$parent),e.emit("discoMode",{on:!0}),t.newMsg="",!1):"/coloroff"==t.newMsg.toLowerCase()?(i.debug("toggling disco mode!",t.$parent),e.emit("discoMode",{on:!1}),t.newMsg="",!1):(i.debug("Sending chat message",{user:t.user.user,msg:t.newMsg}),e.emit("chatMsg",{user:t.user.user,msg:t.newMsg}),void(t.newMsg=""))},window.addEventListener("keypress",function(e){"enter"!=e.key.toLowerCase()||document.activeElement&&"chat-inp"==document.activeElement.id?"enter"==e.key.toLocaleLowerCase()&&document.body.focus():document.getElementById("chat-inp").focus()}),i.debug("CHAT SCOPE",t)}]),t.controller("dash-cont",["$scope","$http","$state","$filter","$log",function(t,n,o,r,s){t.showDups=localStorage.brethDups,n.get("/user/usrData").then(function(e){t.doUser(e.data),s.debug("user",t.user)}),n.get("/cal/latestFive").then(function(e){t.latestEvents=e.data}),t.doUser=function(e){if(!e)return!1;t.user=e,s.debug(e),t.possibleInterests.forEach(function(t,n){e.ints&&e.ints[n]&&1==e.ints[n]&&(t.active=!0)}),t.numUnreadMsgs=e.msgs.filter(function(e){return!e.read}).length},e.on("sentMsg",function(e){s.debug("SOCKET USER",e,"this user",t.user),e.user!=t.user.user&&e.from!=t.user.user||(s.debug("re-getting user"),n.get("/user/usrData").then(function(e){t.doUser(e.data)}))}),t.tabs=[{name:"Profile/Characters",icon:"user"},{name:"Members",icon:"users"},{name:"Mail",icon:"envelope"},{name:"Upcoming Events",icon:"calendar"}],t.defaultPic=a,t.loadingFile=!1,t.fileName=null,t.needsResize=65,t.loadFile=function(){t.loadingFile=!0;new FileReader},t.saveDataURI=function(e){n.post("/user/changeAva",{img:e}).then(function(e){t.doUser(e.data)})},t.possibleInterests=[{name:"General PvE",warn:!1,active:!1,icon:"pve.png"},{name:"sPvP",warn:!1,active:!1,icon:"pvp.png"},{name:"WvW",warn:!1,active:!1,icon:"wvw.png"},{name:"Fractals",warn:!1,active:!1,icon:"fracs.png"},{name:"Raids",warn:!0,active:!1,icon:"raids.png"},{name:"Role-Playing",warn:!0,active:!1,icon:"rp.png"}],t.tzs=angular.copy(i),t.changeInterest=function(e,a){s.debug(e),e.warn&&e.active&&bulmabox.alert("Game Mode Warning","Hey! Just so you know, [GEO] generally doesn't do "+e.name+".<br>However, that doesn't mean we don't have people that might be interested!"),n.get("/user/changeInterest?int="+a+"&act="+e.active).then(function(e){t.doUser(e.data)})},t.changeTz=function(){n.get("/user/changeTz?tz="+t.user.tz).then(function(e){t.doUser(e.data)})},t.otherInfTimer=null,t.setOtherInfTimer=function(){t.otherInfTimer&&clearTimeout(t.otherInfTimer),t.otherInfTimer=setTimeout(function(){n.post("/user/changeOther",{other:t.user.otherInfo}).then(function(e){t.doUser(e.data)})},500)},t.memNameSort=!1,t.charSearch="",t.pickedInts=[!1,!1,!1,!1,!1,!1],t.intSearchToggle=!1,t.charSearchToggle=!1,t.memFilter=function(e){var n=!!e.chars.filter(function(e){return e.name.toLowerCase().indexOf(t.charSearch.toLowerCase())>-1}).length;if(t.charSearch&&!n)return!1;if(t.pickedInts.filter(function(e){return!!e}).length){var a=!0;return t.pickedInts.forEach(function(t,n){t&&!e.ints[n]&&(a=!1)}),a}return!0},t.getAll=function(){console.log("getting all yuzrs"),n.get("/user/allUsrs").then(function(n){s.debug("all users is",n),t.allUsers=n.data,setTimeout(function(){e.emit("getOnline",{})},100)})},e.on("allNames",function(e){e=e.map(function(e){return e.name}),t.allUsers&&t.allUsers.forEach(function(n){n.online=e.indexOf(n.user)>-1||n.user==t.user.user}),t.$digest()}),t.showTab=function(e){t.currTab=e},t.currTab="Profile/Characters",t.makeMod=function(e){s.debug("wanna mod",e),bulmabox.confirm("Assign Moderator Rights","Warning: This will give user "+e.user+" full moderator rights, and prevents them from being banned. This process is <i>not</i> reversable!",function(a){if(!a||null==a)return!1;n.get("/user/makeMod?user="+e.user).then(function(e){t.allUsers=e.data})})},t.toggleBan=function(e){n.get("/user/toggleBan?user="+e.user).then(function(e){t.allUsers=e.data})},t.confirmUsr=function(e){bulmabox.confirm("Confirm User","Are you sure you wish to confirm user "+e.user+"?",function(a){a&&null!=a&&n.get("/user/confirm?u="+e.user).then(function(e){t.allUsers=e.data})})},t.races=["Asura","Charr","Human","Norn","Sylvari"],t.profs=["Guardian","Warrior","Revenant","Thief","Ranger","Engineer","Elementalist","Mesmer","Necromancer"],t.crafts=["Armorsmith","Chef","Artificer","Huntsman","Jeweler","Leatherworker","Tailor","Weaponsmith","Scribe","None"],t.addEditCharModal={active:!1,name:null,race:"Asura",prof:"Guardian",craftOne:{cName:"None",isMax:!1},craftTwo:{cName:"None",isMax:!1},lvl:80,other:null,isEdit:!1},t.clearAddEditChar=function(){t.addEditCharModal={active:!1,name:null,race:"Asura",prof:"Guardian",craftOne:{cName:"None",isMax:!1},craftTwo:{cName:"None",isMax:!1},lvl:80,other:null,isEdit:!1}},t.addChar=function(){return t.addEditCharModal.active=!0,!1},t.autoChars=function(){bulmabox.prompt("Auto-Fill Characters from API","Auto-filling characters from the Guild Wars 2 Official API will replace any existing characters you've entered with API-found characters. <br><br> - You'll need an API key to do this (click <a href='https://account.arena.net/' target='_blank'>here</a> if you dont have one). <br><br>Are you sure you wish to do this?",function(e){e&&null!=e&&n.get("/user/charsFromAPI?api="+e).then(function(e){s.debug("Auto-char response is",e),e&&e.data&&"err"!=e.data?t.doUser(e.data):bulmabox.alert("Error Auto-Filling","There was an error auto-filling your characters.<br>While it <i>may</i> be Dave's fault, you may also wanna check that your API key is valid. You can also always just manually add your characters!")})})},t.delChr=function(e){s.debug("user wishes to remove character",e),bulmabox.confirm("Remove Character","Are you sure you wish to remove the character "+e.name+"?",function(a){a&&null!=a&&n.get("/user/remChar?id="+e._id).then(function(e){t.doUser(e.data)}).catch(function(e){bulmabox.alert("Error","There was a problem removing this character!")})})},t.addOrEditChar=function(){if(s.debug("Sending char",t.addEditCharModal),!t.addEditCharModal.name)return bulmabox.alert("No Character Name","You need to tell us what your character's name is!");t.addEditCharModal.isEdit?n.post("/user/editChar",t.addEditCharModal).then(function(e){t.clearAddEditChar(),t.$digest(),t.doUser(e.data)}):n.post("/user/addChar",t.addEditCharModal).then(function(e){t.clearAddEditChar(),t.doUser(e.data)})},t.editChar=function(e){return t.addEditCharModal={active:!0,name:e.name,race:e.race,prof:e.prof,craftOne:{cName:e.crafts[0]?e.crafts[0].cName:"None",isMax:!!e.crafts[0]&&e.crafts[0].isMax},craftTwo:{cName:e.crafts[1]?e.crafts[1].cName:"None",isMax:!!e.crafts[1]&&e.crafts[1].isMax},lvl:e.lvl,other:e.other,isEdit:!0},!1},t.mail=function(e,t){var a=t?"<div class='notification'>"+t+"</div>":"";bulmabox.custom("Send Message",'<div class="field">\n                '+a+"\n    <label class='label'>\n        Message\n    </label>\n    <p class=\"control\">\n        <textarea class='textarea' id='newMsg' placeholder='What do you wanna say?'></textarea>\n    </p>\n</div>",function(a){var o=document.querySelector("#newMsg").value;if(!o)return bulmabox.alert("Huh?","Sorry, but we don't support uncomfortable silences currently."),!1;t&&(o="<div class='notification'>"+t+"</div><br>"+o),s.debug("old",t,"new",o),n.post("/user/sendMsg",{msg:o,to:e._id}).then(function(e){})},"<button class='button is-warning' onclick='bulmabox.runCb(bulmabox.params.cb)'>Send</button><button class='button is-danger' onclick='bulmabox.kill(\"bulmabox-diag\")'>Cancel</button>")},t.msgView={active:!1,msg:null,mine:!1},t.clearMsg=function(){t.msgView={active:!1,msg:null,mine:!1}},t.viewMsg=function(e){s.debug("msg object",e);(new showdown.Converter).makeHtml(e.msg);if(t.msgView.active=!0,t.msgView.mine=!0,t.msgView.msg=e,e.to)return!1;n.get("/user/setOneRead?id="+e._id).then(function(e){t.doUser(e.data)})},e.on("reqHeartBeat",function(e){t.alsoOnline=e.filter(function(e){return!t.user||!t.user.user||t.user.user!=e.name}).map(function(e){return e.name}),t.allUsers&&t.allUsers.forEach(function(e){e.online=t.alsoOnline.includes(e.user)})}),t.delMsg=function(e,a){"object"!=(void 0===e?"undefined":_typeof(e))&&(e={_id:e}),bulmabox.confirm("Delete Message","Are you sure you wish to delete this message?",function(o){s.debug("resp",o),o&&null!=o&&n.get("/user/delMsg?id="+e._id).then(function(e){t.doUser(e.data),a&&t.clearMsg()})})},t.delMyMsg=function(e,a){"object"!=(void 0===e?"undefined":_typeof(e))&&(e={_id:e}),bulmabox.confirm("Delete Message","Are you sure you wish to delete this message?",function(o){s.debug("resp",o),o&&null!=o&&n.get("/user/delMyMsg?id="+e._id).then(function(e){t.doUser(e.data),a&&t.clearMsg()})})},t.replyMsg=function(e){s.debug("User wants to reply to message",e);var n=(new showdown.Converter).makeHtml(e.msg),a=t.allUsers.find(function(t){return t.user==e.from});t.mail(a,n),t.clearMsg()},t.repMsg=function(e,a){"object"!=(void 0===e?"undefined":_typeof(e))&&(e={_id:e}),s.debug("user wishes to report msg",e),bulmabox.confirm("Report Message","Reporting a message sends a notification to the moderators, including the details of the message.<br>It will then be up to the moderators to determine if you're being uncool to each other.<br>Are you sure you wish to report this message?",function(o){n.post("/user/repMsg",e).then(function(e){"dupRep"==e.data&&bootbox.alert("Already Reported","You've already reported this message. Please wait while the moderator team reviews your report."),a&&t.clearMsg()})})},t.newPwd={pwd:null,pwdDup:null,old:null,changin:!1},t.clearPwd=function(){t.newPwd={pwd:null,pwdDup:null,old:null,changin:!1}},t.editPwd=function(){t.newPwd.pwd&&t.newPwd.pwdDup&&t.newPwd.pwd==t.newPwd.pwdDup?n.post("/user/editPwd",t.newPwd).then(function(e){e.data&&"err"!=e.data?(t.clearPwd(),bulmbox.alert("Password Changed!","Your password was successfully changed!"),t.doUser(e.data)):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Error Changing Password',"There was a problem changing your password. Your old one probably still works, but if you're still having an issue, contact a moderator!")}):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Password Mismatch',"Your passwords don't match, or are missing!")},t.viewEvent=function(e){bulmabox.alert("Event: "+e.title,"Date:"+r("numToDate")(e.eventDate)+"<br>Description:"+e.text)},t.emailTimer=function(){t.updEmail&&clearTimeout(t.updEmail),t.updEmail=setTimeout(function(){s.debug(t.user.email),n.get("/user/setEmail?email="+t.user.email).then(function(e){s.debug(e),e.data&&"err"!=e.data&&t.doUser(e.data)})},500)}}]).filter("numToDate",function(){return function(e){if(isNaN(e))return"Invalid date!";var t=new Date(e);return t.toLocaleDateString()+" "+t.getHours()%12+":"+(t.getMinutes().toString().length<2?"0"+t.getMinutes():t.getMinutes())+" "+(t.getHours()<13?"AM":"PM")}}),t.controller("forum-cat-cont",["$scope","$http","$state","$location","$log",function(e,t,n,a,o){localStorage.geoUsr||n.go("app.login"),t.get("/user/getUsr").then(function(t){e.user=t.data,o.debug("user",e.user)}),e.newThr={},e.fileName=null,e.currCat=a.search().c,e.refCat=function(){t.get("/forum/byCat?grp="+e.currCat).then(function(t){o.debug("thrds in this cat",t),e.threads=t.data.sort(function(e,t){return e.stickied===t.stickied?e.lastUpd-t.lastUpd:e.stickied?-1:1}).map(function(e){return e.time=new Date(e.lastUpd),e})})},e.refCat(),e.newThrDial=function(){e.makingThread=!0},e.clearThread=function(){e.newThr={},e.makingThread=!1,e.loadingFile=!1},e.loadFile=function(){e.loadingFile=!0;new FileReader},e.deleteThread=function(e,a){e.stopPropagation(),e.preventDefault(),bulmabox.confirm("Delete Thread","Are you absolutely sure you wish to delete the thread '"+a.title+"'? <br>Please note that this process is <em>not</em> reversable!",function(e){if(!e||null==e)return!1;o.debug("Deleting thread",a),t.delete("/forum/deleteThread?id="+a._id).then(function(e){n.go(n.current,{},{reload:!0})})})},e.makeThread=function(){e.newThr.md=e.newThr.txt,e.newThr.text=(new showdown.Converter).makeHtml(e.newThr.txt),e.newThr.grp=e.currCat,t.post("/forum/newThread",e.newThr).then(function(e){o.debug("new thred response",e),n.go(n.current,{},{reload:!0})})},e.toggleSticky=function(n,a){n.stopPropagation(),n.preventDefault(),t.get("/forum/toggleSticky?id="+a).then(function(t){o.debug("response from thread sticky toggle is",t),e.refCat()})},e.toggleLock=function(n,a){n.stopPropagation(),n.preventDefault(),t.get("/forum/toggleLock?id="+a).then(function(t){o.debug("response from thread lock toggle is",t),e.refCat()})}}]),t.controller("forum-cont",["$scope","$http","$state","$sce","$log",function(e,t,n,a,o){e.currMsg=0,e.forObj={},localStorage.geoUsr||n.go("app.login"),t.get("/forum/cats").then(function(t){var n=Object.keys(t.data);o.debug("CATS",t),e.forObj=n.map(function(e){return{name:e,count:t.data[e].n,time:t.data[e].t>0?new Date(t.data[e].t):null}})}),e.searchin=!1,e.search="",e.searchTimer=null,e.doSearch=function(){e.searchTimer&&clearTimeout(e.searchTimer),e.searchTimer=setTimeout(function(){e.search&&e.search.length&&t.post("/forum/searchThr",{term:e.search}).then(function(t){o.debug("search response",t),e.searchResults=t.data})},500)},e.goCat=function(e){n.go("app.forumCat",{c:e})}}]),t.controller("forum-thr-cont",["$scope","$http","$state","$location","$sce","$log",function(e,t,n,o,r,i){e.currMsg=0,e.defaultPic=a,e.forObj={},e.fileName=null,localStorage.geoUsr||n.go("app.login"),e.loadingFile=!1,e.loadFile=function(){e.loadingFile=!0;new FileReader},e.currCat=o.search().c,e.id=o.search().t,e.refThred=function(){i.debug("info to back:",e.id),t.get("/forum/thread?id="+e.id).then(function(t){i.debug("response",t),e.thr=t.data.thrd,t.data.psts.map(function(e){return e.rawText=e.text,e.text=r.trustAsHtml(e.text),e.date=new Date(e.lastUpd).toLocaleString(),e.wasEdited=e.lastUpd!=e.createDate,e}),e.avas=t.data.ava,e.thr.posts=e.thr.posts.map(function(e){i.debug("PSTH",e,t.data.psts.filter(function(t){return t._id==e.id})[0]);var n=t.data.psts.filter(function(t){return t._id==e.id})[0];return n.votesUp=e.votesUp,n.votesDown=e.votesDown,n.byMod=t.data.mods.indexOf(n.user)>-1,n.order=e.order,t.data.psts.filter(function(t){return t._id==e.id})[0]}).sort(function(e,t){return e.order-t.order}),i.debug("thred response",e.thr,t)})},e.refThred(),t.get("/user/getUsr").then(function(t){e.user=t.data,i.debug("user",e.user)}),e.newPost=function(){if(!e.newPostTxt&&!e.fileread)return bulmabox.alert("Say Something!","You can't just post nothing!"),!1;t.post("/forum/newPost",{thread:e.thr._id,text:(new showdown.Converter).makeHtml(e.newPostTxt),md:e.newPostTxt,file:e.fileread||null}).then(function(e){window.location.reload()})},e.vote=function(n,a){t.put("/forum/vote",{thread:n.thread,post:n._id,voteUp:!!a}).then(function(t){i.debug("vote response is:",t),e.refThred()})},e.repPost=function(e){bulmabox.confirm("Report Post","Are you sure you wish to report this post to the mod team? <br>Please note that abuse of the report feature will result in the mod team being very angery.",function(n){n&&t.get("/forums/reportPost?id="+e._id).then(function(e){bulmabox.alert("Post Reported!","This post has been reported. Thanks!")}).catch(function(e){bulmabox.alert("Can't Report","There was some issue reporting this post. Sorry!")})})},e.quoteMe=function(e){document.querySelector("#postTxt").value=">"+e.md}}]),t.controller("inbox-cont",["$scope","$http","userFact","$log",function(e,t,n,a){e.currMsg=0,a.debug("PARENT USER IS:",e.$parent.user),e.chMsg=function(t){t&&e.currMsg<e.$parent.user.msgs.length-1?(a.debug("goin up 1 msg"),e.currMsg++):!t&&e.currMsg>0&&e.currMsg--,e.$digest()},e.interpDate=function(e){return new Date(e).toUTCString()},e.reply=function(){n.writeMsg(e.$parent.user.msgs[e.currMsg].from,e.$parent.user.name,!0)},e.deleteMsg=function(){bootbox.confirm("Are you sure you wish to delete this message? Deleted messages are <i>not</i> recoverable!",function(n){n&&null!=n&&t.post("/user/delMsg",{user:e.$parent.user.name,id:e.$parent.user.msgs[e.currMsg].id}).then(function(t){t.data&&t.data.name?(e.$parent.user=t.data,a.debug("affected user",e.$parent.user),angular.element("body").scope().$digest(),e.currMsgs=Math.min(e.$parent.user.msgs.length-1,e.currMsgs)):"err"==t.data&&bootbox.alert("Error deleting message!")})})}}]),t.controller("log-cont",["$scope","$http","$state","$q","userFact","$log",function(t,n,a,o,r,i){t.noWarn=!1,t.nameOkay=!0,delete localStorage.geoUsr,t.checkTimer=!1,t.goReg=function(){a.go("appSimp.register")},t.goLog=function(){a.go("appSimp.login")},t.googLog=function(){window.location.href="./user/google"},t.forgot=function(){t.user?n.post("/user/forgot",{user:t.user}).then(function(e){i.debug("forgot route response",e),"err"==e.data?bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Forgot Password Error',"It looks like that account either doesn't exist, or doesn't have an email registered with it! Contact a mod for further help."):bulmabox.alert("Forgot Password","Check your email! If your username is registered, you should recieve an email from us with a password reset link.")}):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Forgot Password',"To recieve a password reset email, please enter your username!")},t.signin=function(){i.debug("trying to login with",t.user,t.pwd),n.post("/user/login",{user:t.user,pass:t.pwd}).then(function(n){i.debug(n),"authErr"!=n.data&&n.data?"banned"==n.data?bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Banned',"You've been banned! We're a pretty laid-back guild, so you must have <i>really</i> done something to piss us off!"):(i.debug("LOGIN RESPONSE",n.data),e.emit("chatMsg",{msg:t.user+" logged in!"}),localStorage.geoUsr=JSON.stringify(n.data.usr),n.data.news&&bulmabox.alert("Updates/News","Since you last logged in, the following updates have been implemented:<br><ul style='list-style:disc;'><li>"+n.data.news.join("</li><li>")+"</li></ul>"),a.go("app.dash")):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Incorrect Login',"Either your username or password (or both!) are incorrect.")}).catch(function(e){"unconfirmed"==e.data?bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Unconfirmed',"Your account is currently unconfirmed. For anti-spam purposes, we need a [GEO] person to confirm your account. Thanks!"):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Error',"There's been some sort of error logging in. This is <i>probably</i> not an issue necessarily with your credentials. Blame Dave!")})},t.checkUser=function(){t.checkTimer&&clearTimeout(t.checkTimer),t.checkTimer=setTimeout(function(){n.get("/user/nameOkay?name="+t.user).then(function(e){t.nameOkay=e.data})},500)},t.emailBad=!1,t.checkEmail=function(){t.emailBad=t.email.length&&!t.email.match(/(\w+\.*)+@(\w+\.)+\w+/g)},t.register=function(){t.pwd&&t.pwdDup&&t.user?t.pwd!=t.pwdDup?(i.debug("derp"),bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Password Mismatch',"Your passwords don't match, or are missing!")):!t.email||t.emailBad?bulmabox.confirm('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Send Without Email?',"You've either not included an email, or the format you're using doesn't seem to match any we know. <br>While you can register without a valid email, it'll be much more difficult to recover your account.<br>Register anyway?",function(e){if(!e||null==e)return!1;n.post("/user/new",{user:t.user,pass:t.pwd,email:t.email}).then(function(e){n.post("/user/login",{user:t.user,pass:t.pwd}).then(function(){a.go("app.dash")}).catch(function(e){"duplicate"==e.data&&bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;User Already Exists',"That account already exists. Are you sure you didn't mean to log in?"),"unconfirmed"==e.data&&a.go("appSimp.unconfirmed")})}).catch(function(e){"duplicate"==e.data&&bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;User Already Exists',"That account already exists. Are you sure you didn't mean to log in?"),"unconfirmed"==e.data&&a.go("appSimp.unconfirmed")})}):(i.debug("running register with user",t.user,"and pwd",t.pwd),n.post("/user/new",{user:t.user,pass:t.pwd,email:t.email}).then(function(e){n.post("/user/login",{user:t.user,pass:t.pwd}).then(function(){a.go("app.dash")})}).catch(function(e){"duplicate"==e.data&&bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;User Already Exists',"That account already exists. Are you sure you didn't mean to log in?")})):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Missing Information',"Please enter a username, and a password (twice).")}}]),String.prototype.capMe=function(){return this.slice(0,1).toUpperCase()+this.slice(1)},t.controller("main-cont",["$scope","$http","$state","userFact","$log",function(t,n,a,o,r){r.debug("main controller registered!"),t.user=null,o.getUser().then(function(n){t.user=n.data,e.emit("hiIm",{name:t.user.user})}),t.isActive=!0,t.pokeTimer=null,t.faceOpen=!1;var i="Hidden Tyria Geographic Society [GEO] Guild Site";window.addEventListener("focus",function(e){t.isActive=!0,t.pokeTimer&&clearInterval(t.pokeTimer),document.title=i}),window.addEventListener("blur",function(e){t.isActive=!1});var s=["😐","😮"];e.on("chatMsgOut",function(e){e.msg.includes("@"+t.user.user)&&e.user!=t.user.user&&!t.isActive&&(t.pokeTimer=setInterval(function(){t.faceOpen=!t.faceOpen;var e=t.faceOpen?0:1;document.title=s[e]+" "+i},250))}),e.on("reqHeartBeat",function(n){t.alsoOnline=n.filter(function(e){return!t.user||!t.user.user||t.user.user!=e.name}).map(function(e){return e.name}),t.user&&t.user.user&&a.current.name.includes("app.")&&e.emit("hbResp",{name:t.user.user})}),e.on("disco",function(e){e.on?t.col="div:nth-child(even){animation:huehue 4s linear 2s infinite;}div:nth-child(odd){animation:huehue 4s linear 0s infinite;}":t.col="div:nth-child(even){animation:none;}div:nth-child(odd){animation:none}",t.$apply()}),t.explMd=function(){bulmabox.alert("Markdown",'<div class=\'is-size-2\'>Markdown</div>\n        <hr>\n        <div class=\'is-size-5\'>What It Is</div>\n        <p>Markdown is a specialized way of formatting text, used by sites like Reddit, Stack Overflow, and apps like Discord.</p>\n        <hr>\n        <div class=\'is-size-5\'>What It Does</div>\n        <p>It allows you to format text with stuff like <strong>bold</strong> or <em>italics</em> without the use of fancy, complex word processors.</p>\n        <hr>\n        <div class=\'is-size-4\'>Commands:</div>\n        <table class="table table-striped table-bordered">\n        <thead>\n        <tr>\n        <th style="text-align:left"><strong>Markdown</strong></th>\n        <th style="text-align:left"><strong>Result</strong></th>\n        </tr>\n        </thead>\n        <tbody>\n        <tr>\n        <td style="text-align:left">#text, ##text,…</td>\n        <td style="text-align:left">header (big text). More \'#\'s means smaller headers</td>\n        </tr>\n        <tr>\n        <td style="text-align:left">*text*, _text_</td>\n        <td style="text-align:left"><em>italic text</em></td>\n        </tr>\n        <tr>\n        <td style="text-align:left">**text**,__text,__</td>\n        <td style="text-align:left"><strong>bold text</strong></td>\n        </tr>\n        <tr>\n        <td style="text-align:left">~~text~~</td>\n        <td style="text-align:left"><s>strikethrough text</s> woops!</td>\n        </tr>\n        <tr>\n        <td style="text-align:left">[link text](link url)</td>\n        <td style="text-align:left"><a href="https://www.google.com">links</a></td>\n        </tr>\n        <tr>\n        <td style="text-align:left">- item</td>\n        <td style="text-align:left">- item in a bullet list</td>\n        </tr>\n        <tr>\n        <td style="text-align:left">1. item</td>\n        <td style="text-align:left">1. Item in a numbered list</td>\n        </tr>\n        <tr>\n        <td style="text-align:left">![alt text](url “hover text”)</td>\n        <td style="text-align:left"><img src="https://github.com/adam-p/markdown-here/raw/master/src/common/images/icon48.png" alt="alt text" title="hover text"> (The alt text is displayed if the browser can’t load the image)</td>\n        </tr>\n        <tr>\n        <td style="text-align:left">`text`</td>\n        <td style="text-align:left"><code>look ma, ima programmer!</code></td>\n        </tr>\n        </tbody>\n        </table>')},t.sc="",t.seekrit={code:["arrowup","arrowup","arrowdown","arrowdown","arrowleft","arrowright","arrowleft","arrowright","b","a","Space"],on:!1,asking:!1,hist:[],corrNum:0,whichFont:0},t.fontOpts=["aurebesh","tengwar quenya-1","klingon font","hieroglyphic","dovahkiin","Skyrim_Daedra"],document.querySelector("body").addEventListener("keyup",function(e){if(e.preventDefault(),t.seekrit.asking)return!1;var n=t.seekrit.code[t.seekrit.corrNum];if(e.key.toLowerCase()!=n&&e.code!=n)return!1;t.seekrit.corrNum+1===t.seekrit.code.length?(t.seekrit.asking=!0,bulmabox.confirm("Toggle Secret Mode","Are you sure you wanna toggle the Secret Mode?",function(e){if(e&&null!==e){if(t.seekrit.on=!t.seekrit.on,t.seekrit.on){var n=t.fontOpts[t.seekrit.whichFont];t.seekrit.whichFont++,t.seekrit.whichFont>=t.fontOpts.length&&(t.seekrit.whichFont=0),t.sc="*:not(.fa){font-family:"+n+",arial!important;}"}else t.sc="";t.$digest()}else t.sc="",t.$digest();t.seekrit.asking=!1,t.seekrit.corrNum=0})):t.seekrit.corrNum++})}]),t.controller("nav-cont",["$scope","$http","$state","$log",function(e,t,n,a){e.logout=function(){bulmabox.confirm("Logout","Are you sure you wish to logout?",function(o){if(!o||null==o)return!0;t.get("/user/logout").then(function(t){a.debug("b4 logout usr removl, parent scope is",e.$parent.user),e.$parent.user=null,a.debug("and now its",e.$parent.user),n.go("appSimp.login")})})},e.mobActive=!1}]),n.controller("reset-contr",["$scope","$http","$location","$log",function(e,t,n,a){e.key=window.location.search.slice(5),t.get("/user/resetUsr?key="+e.key).then(function(t){a.debug("getting reset user status?",t),e.user=t.data}),e.doReset=function(){e.user&&e.pwd&&e.pwdDup&&e.pwdDup==e.pwd&&e.key?t.post("/user/resetPwd",{acct:e.user.user,pwd:e.pwd,pwdDup:e.pwdDup,key:e.key}).then(function(t){"err"==t.data?bulmabox.alert("Error resetting password","There was an error resetting your password. Please contact a mod"):bulmabox.alert("Password Reset","Your password was successfully reset! We're redirecting you to login now.",function(){e.goLogin()})}):bulmabox.alert("Error: Missing data","Make sure you&rsquo;ve reached this page from a password reset link, and that you have entered the same password in both fields!")},e.goLogin=function(){window.location.href="../../login"}}]);var i=[{value:-12,text:"(GMT -12:00) Eniwetok, Kwajalein"},{value:-11,text:"(GMT -11:00) Midway Island, Samoa"},{value:-10,text:"(GMT -10:00) Hawaii"},{value:-9,text:"(GMT -9:00) Alaska"},{value:-8,text:"(GMT -8:00) Pacific Time (US & Canada)"},{value:-7,text:"(GMT -7:00) Mountain Time (US & Canada)"},{value:-6,text:"(GMT -6:00) Central Time (US & Canada), Mexico City"},{value:-5,text:"(GMT -5:00) Eastern Time (US & Canada), Bogota, Lima"},{value:-4,text:"(GMT -4:00) Atlantic Time (Canada), Caracas, La Paz"},{value:-3.5,text:"(GMT -3:30) Newfoundland"},{value:-3,text:"(GMT -3:00) Brazil, Buenos Aires, Georgetown"},{value:-2,text:"(GMT -2:00) Mid-Atlantic"},{value:-1,text:"(GMT -1:00) Azores, Cape Verde Islands"},{value:0,text:"(GMT) Western Europe Time, London, Lisbon, Casablanca"},{value:1,text:"(GMT +1:00) Brussels, Copenhagen, Madrid, Paris"},{value:2,text:"(GMT +2:00) Kaliningrad, South Africa"},{value:3,text:"(GMT +3:00) Baghdad, Riyadh, Moscow, St. Petersburg"},{value:3.5,text:"(GMT +3:30) Tehran"},{value:4,text:"(GMT +4:00) Abu Dhabi, Muscat, Baku, Tbilisi"},{value:4.5,text:"(GMT +4:30) Kabul"},{value:5,text:"(GMT +5:00) Ekaterinburg, Islamabad, Karachi, Tashkent"},{value:5.5,text:"(GMT +5:30) Bombay, Calcutta, Madras, New Delhi"},{value:5.75,text:"(GMT +5:45) Kathmandu"},{value:6,text:"(GMT +6:00) Almaty, Dhaka, Colombo"},{value:7,text:"(GMT +7:00) Bangkok, Hanoi, Jakarta"},{value:8,text:"(GMT +8:00) Beijing, Perth, Singapore, Hong Kong"},{value:9,text:"(GMT +9:00) Tokyo, Seoul, Osaka, Sapporo, Yakutsk"},{value:9.5,text:"(GMT +9:30) Adelaide, Darwin"},{value:10,text:"(GMT +10:00) Eastern Australia, Guam, Vladivostok"},{value:11,text:"(GMT +11:00) Magadan, Solomon Islands, New Caledonia"},{value:12,text:"(GMT +12:00) Auckland, Wellington, Fiji, Kamchatka"}],s=[{id:1001,name:"Anvil Rock",population:"High"},{id:1002,name:"Borlis Pass",population:"Medium"},{id:1003,name:"Yak's Bend",population:"High"},{id:1004,name:"Henge of Denravi",population:"Medium"},{id:1005,name:"Maguuma",population:"High"},{id:1006,name:"Sorrow's Furnace",population:"Medium"},{id:1007,name:"Gate of Madness",population:"Medium"},{id:1008,name:"Jade Quarry",population:"Medium"},{id:1009,name:"Fort Aspenwood",population:"Full"},{id:1010,name:"Ehmry Bay",population:"Medium"},{id:1011,name:"Stormbluff Isle",population:"Medium"},{id:1012,name:"Darkhaven",population:"Medium"},{id:1013,name:"Sanctum of Rall",population:"VeryHigh"},{id:1014,name:"Crystal Desert",population:"Medium"},{id:1015,name:"Isle of Janthir",population:"Medium"},{id:1016,name:"Sea of Sorrows",population:"VeryHigh"},{id:1017,name:"Tarnished Coast",population:"High"},{id:1018,name:"Northern Shiverpeaks",population:"High"},{id:1019,name:"Blackgate",population:"Full"},{id:1020,name:"Ferguson's Crossing",population:"Medium"},{id:1021,name:"Dragonbrand",population:"Medium"},{id:1022,name:"Kaineng",population:"High"},{id:1023,name:"Devona's Rest",population:"Medium"},{id:1024,name:"Eredon Terrace",population:"Medium"},{id:2001,name:"Fissure of Woe",population:"Medium"},{id:2002,name:"Desolation",population:"VeryHigh"},{id:2003,name:"Gandara",population:"High"},{id:2004,name:"Blacktide",population:"Medium"},{id:2005,name:"Ring of Fire",population:"Medium"},{id:2006,name:"Underworld",population:"Medium"},{id:2007,name:"Far Shiverpeaks",population:"Medium"},{id:2008,name:"Whiteside Ridge",population:"High"},{id:2009,name:"Ruins of Surmia",population:"Medium"},{id:2010,name:"Seafarer's Rest",population:"VeryHigh"},{id:2011,name:"Vabbi",population:"High"},{id:2012,name:"Piken Square",population:"VeryHigh"},{id:2013,name:"Aurora Glade",population:"High"},{id:2014,name:"Gunnar's Hold",population:"Medium"},{id:2101,name:"Jade Sea",population:"High"},{id:2102,name:"Fort Ranik",population:"Medium"},{id:2103,name:"Augury Rock",population:"High"},{id:2104,name:"Vizunah Square",population:"Medium"},{id:2105,name:"Arborstone",population:"Medium"},{id:2201,name:"Kodash",population:"High"},{id:2202,name:"Riverside",population:"Full"},{id:2203,name:"Elona Reach",population:"VeryHigh"},{id:2204,name:"Abaddon's Mouth",population:"Medium"},{id:2205,name:"Drakkar Lake",population:"High"},{id:2206,name:"Miller's Sound",population:"Medium"},{id:2207,name:"Dzagonur",population:"Medium"},{id:2301,name:"Baruch Bay",population:"VeryHigh"}];Object.freeze(s),t.controller("tool-cont",["$scope","$http","$state","$filter","$sce","$window","$log",function(e,t,n,a,o,r,i){e.showTab=function(t){e.currTab=t,"WvW Current Match History"==e.currTab&&e.refWvw()},e.currTab="Dailies",e.tabs=[{name:"Dailies",icon:"calendar-check-o"},{name:"WvW Current Match History",icon:"fort-awesome"},{name:"Core/Lodestone Upgrade",icon:"diamond"},{name:"Tier Six Material Conversion",icon:"money"}],e.dailyRestrict={},e.tmrw=!1,e.regetDaily=function(){var n=Object.keys(e.dailyRestrict).filter(function(t){return e.dailyRestrict[t]});t.get("/tool/daily"+(e.tmrw?"/tomorrow":"")+(n.length?"?modes="+n.join(","):"")).then(function(t){i.debug("dailyObj",t.data),e.dailies=t.data})},r.addEventListener("keyup",function(t){39!=t.which||t.shiftKey?39==t.which&&t.shiftKey?(e.lastSkirm(),e.$digest()):37!=t.which||t.shiftKey?37==t.which&&t.shiftKey&&(e.firstSkirm(),e.$digest()):(e.prevSkirm(),e.$digest()):(e.nextSkirm(),e.$digest())}),e.regetDaily(),e.refPrices=function(){t.get("/tool/allPrices").then(function(t){e.prices=e.calcPrices(t.data.p)})},e.wvwWorld=!1,e.wvwColors=["red","green","blue"],e.wvwPie={cutoutPercentage:0,backgroundColor:["#aa0000","#00aa00","#0000aa"],config:{plugins:{vert:!1}}},e.wvwDisabled=!1,e.makeMarkers=function(){e.mapMarkers=["camp-blue.png","camp-green.png","camp-netural.png","camp-red.png","castle-blue.png","castle-green.png","castle-neutral.png","castle-red.png","keep-blue.png","keep-green.png","keep-netural.png","keep-red.png","ruins-blue.png","ruins-green.png","ruins-neutral.png","ruins-red.png","tower-blue.png","tower-green.png","tower-neutral.png","tower-red.png"].map(function(e){return L.icon({iconUrl:"./img/wvw/"+e,iconName:e.replace(".png",""),iconSize:[32,32],iconAnchor:[15,15],popupAnchor:[-3,-76]})}),i.debug("Map Markers",e.mapMarkers)},e.refWvw=function(){t.get("/tool/wvw"+(e.wvwWorld?"?world="+e.wvwWorld:"")).then(function(t){if(i.debug("WVW STUFF",t,t.data),"newMatch"==t.data)return e.wvwDisabled=!0,e.wvw=null,!1;e.wvwDisabled=!1,e.wvw=t.data.wvw,e.currentMatch=e.wvw.skirmishes.length-1,e.wvw.labels=e.wvwColors.map(function(e){return t.data.wvw.all_worlds[e].map(function(e){return s.find(function(t){return t.id==e}).name}).join(", ")}),e.wvw.skirmishes.forEach(function(t){t.scoreArr=e.wvwColors.map(function(e){return t.scores[e]})}),e.wvw.history=e.wvwColors.map(function(t){return e.wvw.skirmishes.map(function(e){return e.scores[t]})}),e.wvw.histLabels=new Array(e.wvw.history[0].length).fill(100).map(function(e,t){return t+1}),e.wvw.histColors=[{backgroundColor:"transparent",borderColor:"#f00",pointBackgroundColor:"#f00"},{backgroundColor:"transparent",borderColor:"#0f0",pointBackgroundColor:"#0f0"},{backgroundColor:"transparent",borderColor:"#00f",pointBackgroundColor:"#00f"}],i.debug("WVW",e.wvw),e.mapMarkers=[],e.wvwOwned=t.data.owned||null,e.makeMarkers();var n=document.querySelector("#wvw-map");i.debug("mapDiv",n,n.offsetWidth),e.doMap(e.wvw.maps)})},e.nextSkirm=function(){if(!e.wvw)return!1;e.wvw.skirmishes.length>e.currentMatch+1?e.currentMatch++:e.currentMatch=0,e.positionVert()},e.prevSkirm=function(){if(!e.wvw)return!1;e.currentMatch&&e.currentMatch>0?e.currentMatch--:e.currentMatch=e.wvw.skirmishes.length-1,e.positionVert()},e.lastSkirm=function(){e.currentMatch=e.wvw.skirmishes.length-1,e.positionVert()},e.firstSkirm=function(){e.currentMatch=0,e.positionVert()},e.mats=["blood","bone","claw","fang","scale","totem","venom"],e.cores=["glacial","onyx","destroyer","molten","corrupted","essence","crystal","charged"],e.calcPrices=function(t){i.debug("DATA before prices",t),t.push({hi:2504,lo:2504,lName:"Bottle of Elonian Wine",id:19663,sName:"wine"});var n=t.find(function(e){return"t6dust"==e.sName});return e.mats.forEach(function(e){var a=t.find(function(t){return t.sName=="t5"+e}),o=t.find(function(t){return t.sName=="t6"+e});o.hiProf=12*o.hi-(50*a.lo+1*o.lo+5*n.lo),o.loProf=5*o.lo-(50*a.hi+1*o.hi+5*n.hi),o.t5=a,o.profGood=0,o.hiProf>0&&o.loProf>0?o.profGood=1:o.hiProf<0&&o.loProf<0&&(o.profGood=-1)}),e.cores.forEach(function(e){var a=t.find(function(t){return t.sName=="c"+e}),o=t.find(function(t){return t.sName=="l"+e});o.c=a,o.hiProf=o.hi-(2*a.lo+n.lo+2504),o.loProf=o.lo-(2*a.hi+n.hi+2504),o.profGood=0,o.hiProf>0&&o.loProf>0?o.profGood=1:o.hiProf<0&&o.loProf<0&&(o.profGood=-1)}),i.debug("PRICES!",t),t},e.isMat=function(e){return e.sName.indexOf("t6")>-1&&"t6dust"!=e.sName},e.isGem=function(e){return e.sName.indexOf("t6")<0&&"wine"!=e.sName&&e.sName.indexOf("t5")<0&&"l"==e.sName[0]},e.histClick=function(t){if(i.debug("CLICKED:",t,Chart),!t||!t[0])return!1;e.currentMatch=t[0]._index,e.positionVert()},e.positionVert=function(){e.lineOpts.title.text="("+(e.currentMatch+1)+")"},Chart.plugins.register({id:"vert",afterDraw:function(t,n){if("doughnut"!=t.config.type){e.lineXWid=t.chartArea.right-t.chartArea.left,e.lineYWid=t.chartArea.left,e.lineHeight=t.chartArea.bottom-t.chartArea.top,e.lineStepWid=e.lineXWid/(e.wvw.skirmishes.length-1);var a=t.canvas.getContext("2d");a.moveTo(e.lineYWid+e.currentMatch*e.lineStepWid,5),a.lineTo(e.lineYWid+e.currentMatch*e.lineStepWid,e.lineHeight+5),a.strokeStyle="#fff",a.stroke()}}}),e.lineOpts={title:{text:"("+(e.currentMatch+1)+")"},scales:{yAxes:[{ticks:{beginAtZero:!0,fontColor:"#fff"}}],xAxes:[{ticks:{fontColor:"#fff"}}]},hover:{animationDuration:0}},e.refPrices(),e.getMapState=function(){i.debug("ZOOM",e.map.getZoom(),"BOUNDS",e.map.getBounds())},e.unproject=function(e,t){return e.unproject(t,e.getMaxZoom())},e.doMap=function(t){var n,a;e.map=L.map("wvw-map",{minZoom:0,maxZoom:6}),a=e.unproject(e.map,[15700,8900]),n=e.unproject(e.map,[5100,15900]);var o=new L.LatLngBounds(e.unproject(e.map,[16384,0]),e.unproject(e.map,[0,16384]));L.tileLayer("https://tiles.guildwars2.com/2/3/{z}/{x}/{y}.jpg",{subdomains:["tiles1","tiles2","tiles3","tiles4"],bounds:o,minNativeZoom:4,noWrap:!0}).addTo(e.map),e.map.setMaxBounds(new L.LatLngBounds(n,a)),e.map.setView(new L.LatLng((a.lat-n.lat)/2,(a.lng-n.lng)/2),0),t.forEach(function(t){t.objectives.filter(function(e){return!!e.marker}).forEach(function(t){var n=e.mapMarkers.find(function(e){return e.options.iconName==t.type.toLowerCase()+"-"+t.owner.toLowerCase()});i.debug("THIS OBJECTIVE",t,"MARKER (probly)",n,"FROM",t.type.toLowerCase()+"-"+t.owner.toLowerCase()),L.marker(e.unproject(e.map,t.coord),{title:t.name+" (owned by: "+t.owner+")",icon:n}).addTo(e.map)})}),setTimeout(function(){e.map.invalidateSize(),e.map.setZoom(3)},500)}}]),t.controller("unconf-cont",["$scope","$http","$state","$log",function(e,t,n,a){e.logout=function(){t.get("/user/logout").then(function(e){a.debug(e),n.go("appSimp.login")})}}])}();